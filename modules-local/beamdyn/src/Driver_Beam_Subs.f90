...
subroutine CreateMultiPointMeshes(DvrData,BD_InitOutput,BD_Parameter,y, u, ErrStat,ErrMsg)
   ...
   DO i = 1,DvrData%NumPointLoads
       ...
       call Find_IniNode(1, BD_InitOutput%kp_total, BD_InitOutput%kp_coordinate, BD_Parameter%segment_length, BD_Parameter%SP_Coef, DvrData%MultiPointLoad(i,1), temp_POS, temp_CRV, ErrStat2, ErrMsg2 )
       CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
       if (ErrStat >= AbortErrLev) return
