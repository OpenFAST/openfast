...
subroutine test_BD_DisplacementQP()
    ...
    real(BDKi)      :: E10(3, 6, 1)
    real(BDKi)      :: q(6, 6)
    real(BDKi)      :: uuu(6, 6, 1), base_uuu(6, 6, 1)
    real(BDKi)      :: uup(3, 6, 1), base_uup(3, 6, 1)
    real(BDKi)      :: E1(3, 6, 1), base_E1(3, 6, 1)
    ...
    @assertEqual(Base_uuu, uuu, tolerance, testname)
    @assertEqual(Base_uup, uup, tolerance, testname)
