...
subroutine test_BD_GaussPointWeight()
    ...
    baselinelocations = (/ -0.906179845938664, -0.538469310105683,                0.0,&
    ...
    baselinelocations = &
        (/-0.9996958399952467, -0.9983977458605664, -0.9960637894774884, &
          ...
          0.0, 0.032215464310261704, 0.06439748468849585, 0.09651265192192161, &
...
! from: https://www.mathworks.com/matlabcentral/fileexchange/4540-legendre-gauss-quadrature-weights-and-nodes
