...
subroutine test_BD_ComputeIniCoef()
    ...
    ! NOTE: A description of the algorithm for this subroutine is included below.
    ! --------------------------------------------------------------------------
    ! --------------------------------------------------------------------------
    ...
    SP_Coef               = 0.0d0
    base_SP_Coef          = 0.0d0
    base_SP_Coef(1, :, :) = reshape((/ 2.0000000000000000, 0.2000000000000000, 0.0000000000000000,&
    ...
    SP_Coef               = 0.0d0
    base_SP_Coef          = 0.0d0
    base_SP_Coef(1, :, :) = reshape((/ 1.5084746148222619, 0.7740598480986147, 3.7640457741166018,&
                                      -0.9914171793680712, -4.942205900972121, 2.8665039656159514,&
                                       5.0407395052931054, -1.327687292389470, 0.0000000000000000,&
                                       0.9999999999999998, 0.0000000000000000, 0.0000000000000000,&
                                       0.0000000000000000, 0.0000000000000000, 0.0000000000000000,&
                                       0.0000000000000000 /),&
                                    (/ 4, 4 /))
    base_SP_Coef(2, :, :) = reshape((/ -6.7803428269260309,  13.623982366366723, -2.8762463980747857,&
                                        0.1523894614730352, -16.042434760593011,  20.074879199307517,&
                                       -3.8518152317462877,  0.2040771087109725,  0.0000000000000000,&
                                        0.9999999999999992,  0.0000000000000000,  0.0000000000000000,&
                                        0.0000000000000000,  0.0000000000000000,  0.0000000000000000,&
                                        0.0000000000000000 /),&
                                    (/ 4, 4 /))
