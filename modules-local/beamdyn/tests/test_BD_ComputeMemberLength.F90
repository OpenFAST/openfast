...
subroutine test_BD_ComputeMemberLength()
    ...
    ! --------------------------------------------------------------------------
    ! --------------------------------------------------------------------------
    ! FIXME(mjs): As of 7.27.18, Ashesh mentioned that he has changed the 
      ! form of BD_ComputeMemberLength(), so this test has not been updated to
      ! more directly test the theory of the subroutine and thus functions as a
      ! regression test.
    ! --------------------------------------------------------------------------
    ! --------------------------------------------------------------------------
    ...
    base_segment_length(2, :) = (/  5.0d0, 0.5d0, 1.0d0 /)
    base_member_length(1, :)  = (/ 10.0d0, 1.0d0 /)
    ...
    base_segment_length(1, :) = (/ 39.181467043901925, 0.0000000000000000,&
                                   0.5006551420514575 /)
    base_segment_length(2, :) = (/ 39.078923698024852, 0.5006551420514575,&
                                   1.0000000000000000 /)
