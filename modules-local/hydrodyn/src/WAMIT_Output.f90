...
MODULE WAMIT_Output
  ...
  ! WAMIT Body Forces:
   ...
   INTEGER(IntKi), PARAMETER      :: WavesFxi  =  1
   INTEGER(IntKi), PARAMETER      :: WavesFyi  =  2
   INTEGER(IntKi), PARAMETER      :: WavesFzi  =  3
   INTEGER(IntKi), PARAMETER      :: WavesMxi  =  4
   INTEGER(IntKi), PARAMETER      :: WavesMyi  =  5
   INTEGER(IntKi), PARAMETER      :: WavesMzi  =  6
...
! This code was generated by Write_ChckOutLst.m at 21-Mar-2013 08:13:04.
   CHARACTER(OutStrLenM1), PARAMETER  :: ValidParamAry(18) =  (/ &                  ! This lists the names of the allowed parameters, which must be sorted alphabetically
                               "HDRSTCFXI","HDRSTCFYI","HDRSTCFZI","HDRSTCMXI","HDRSTCMYI","HDRSTCMZI","RDTNFXI  ", &
                               "RDTNFYI  ","RDTNFZI  ","RDTNMXI  ","RDTNMYI  ","RDTNMZI  ","WAVESFXI ","WAVESFYI ", &
                               "WAVESFZI ","WAVESMXI ","WAVESMYI ","WAVESMZI "/)
