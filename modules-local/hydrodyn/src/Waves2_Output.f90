...
!   USE                              Waves
  ...
  ! Waves2 Body Forces:
   ...
   INTEGER(IntKi), PARAMETER      :: Wave1El2 =  1
   INTEGER(IntKi), PARAMETER      :: Wave2El2 =  2
   INTEGER(IntKi), PARAMETER      :: Wave3El2 =  3
   INTEGER(IntKi), PARAMETER      :: Wave4El2 =  4
   INTEGER(IntKi), PARAMETER      :: Wave5El2 =  5
   INTEGER(IntKi), PARAMETER      :: Wave6El2 =  6
   INTEGER(IntKi), PARAMETER      :: Wave7El2 =  7
   INTEGER(IntKi), PARAMETER      :: Wave8El2 =  8
   INTEGER(IntKi), PARAMETER      :: Wave9El2 =  9
...
!End of code generated by Matlab script
   ...
   INTEGER, PARAMETER             :: WaveElevi2(9)  = (/Wave1El2,Wave2El2,Wave3El2,Wave4El2,Wave5El2,Wave6El2,Wave7El2,Wave8El2,Wave9El2/)
...
!----------------------------------------------------------------------------------------------------    
   ...
   CHARACTER(10),                 INTENT(   OUT ) :: OutList (:)          ! An array holding the names of the matched Waves2 output channels. 
