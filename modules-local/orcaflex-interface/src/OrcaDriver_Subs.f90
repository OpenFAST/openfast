...
! URL: $HeadURL: https://windsvn.nrel.gov/OrcaFlexInterface/branches/modularization2/Source/Driver/OrcaDriver_Subs.f90 $
!**********************************************************************************************************************************
...
!   !REAL(ReKi),                         INTENT(IN   )  :: PointsXYZ(6)         !< The position grid passed in
!   !REAL(ReKi),                         INTENT(IN   )  :: PointsVel(6)         !< The velocity grid passed in
!   !REAL(ReKi),                         INTENT(IN   )  :: PointsForce(6)       !< The resulting force array
!   TYPE(Mesh),                         INTENT(IN   )  :: Mesh                 !< Input%PtfmMesh
!   !TYPE(Mesh),                         INTENT(IN   )  :: ForceMesh            !< Output%PtfmMesh
!   INTEGER(IntKi),                     INTENT(  OUT)  :: ErrStat              !< returns a non-zero value when an error occurs
!   CHARACTER(*),                       INTENT(  OUT)  :: ErrMsg               !< Error message if ErrStat /= ErrID_None
!
!         ! Temporary local variables
...
!      CALL SetErrStat( ErrStatTmp, ErrMsgTmp, ErrStat, ErrMsg, 'PointsForce_OutputWrite' )
!      IF ( ErrStat >= AbortErrLev ) RETURN
!
!      Initialized =  .TRUE.
!
...
!   !                  PointsXYZ(1),PointsXYZ(2),PointsXYZ(3),PointsXYZ(4)*R2D,PointsXYZ(5)*R2D,PointsXYZ(6)*R2D,   &
!   !                  PointsVel(1),PointsVel(2),PointsVel(3),PointsVel(4)*R2D,PointsVel(5)*R2D,PointsVel(6)*R2D,   &
!   !                  PointsForce(1)/1000_ReKi,PointsForce(2)/1000_ReKi,PointsForce(3)/1000_ReKi,                  &
!   !                  PointsForce(4)/1000_ReKi,PointsForce(5)/1000_ReKi,PointsForce(6)/1000_ReKi
!   !ELSE
!   !   WRITE (OutUnit,PointsOutputFmt, IOSTAT=ErrStatTmp )                           &
!   !                  PointsXYZ(1),PointsXYZ(2),PointsXYZ(3),PointsXYZ(4),PointsXYZ(5),PointsXYZ(6),   &
!   !                  PointsVel(1),PointsVel(2),PointsVel(3),PointsVel(4),PointsVel(5),PointsVel(6),   &
!   !                  PointsForce(1)/1000_ReKi,PointsForce(2)/1000_ReKi,PointsForce(3)/1000_ReKi,      &
!   !                  PointsForce(4)/1000_ReKi,PointsForce(5)/1000_ReKi,PointsForce(6)/1000_ReKi
!   !ENDIF
!
