...
!  step endpionts and midpoint.
      ...
      CALL BD_InputSolve( t_global+ dt_global,     BD_Input(1), BD_InputTimes(1), ErrStat, ErrMsg)
      CALL BD_InputSolve( t_global+ 0.5*dt_global, BD_Input(2), BD_InputTimes(2), ErrStat, ErrMsg)
      CALL BD_InputSolve( t_global,                BD_Input(3), BD_InputTimes(3), ErrStat, ErrMsg)
...
!      WRITE(*,*) t_global, BD_ContinuousState%q(15)
