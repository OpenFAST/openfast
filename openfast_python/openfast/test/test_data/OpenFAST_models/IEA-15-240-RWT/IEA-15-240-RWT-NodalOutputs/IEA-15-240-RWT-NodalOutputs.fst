...
---------------------- INPUT FILES ---------------------------------------------
"IEA-15-240-RWT-NodalOutputs_ElastoDyn.dat"  EDFile      - Name of file containing ElastoDyn input parameters (quoted string)
"IEA-15-240-RWT-NodalOutputs_BeamDyn.dat"    BDBldFile(1) - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"IEA-15-240-RWT-NodalOutputs_BeamDyn.dat"    BDBldFile(2) - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"IEA-15-240-RWT-NodalOutputs_BeamDyn.dat"    BDBldFile(3) - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
...
"IEA-15-240-RWT-NodalOutputs_AeroDyn15.dat"  AeroFile    - Name of file containing aerodynamic input parameters (quoted string)
