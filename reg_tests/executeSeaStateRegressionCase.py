...
"""
    This program executes SeaState and a regression test for a single test case.
    ...
    Get usage with: `executeSeaStateRegressionCase.py -h`
"""
...
parser.add_argument("executable", metavar="SeaState-Driver", type=str, nargs=1, help="The path to the SeaStatedriver executable.")
...
### Run seastate on the test case
if not noExec:
    caseInputFile = os.path.join(testBuildDirectory, "seastate_driver.inp")
