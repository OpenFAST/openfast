...
function(add_test_r testname )
  add_test(
    ${testname} python ${CMAKE_CURRENT_SOURCE_DIR}/executeRegressionTestCase.py ${CMAKE_BINARY_DIR} ${CMAKE_CURRENT_SOURCE_DIR} ${testname} ${TOLERANCE} ${CMAKE_SYSTEM_NAME} ${CMAKE_Fortran_COMPILER_ID}
  )
