...
"""
    ...
    Get usage with: `executeAerodynPyRegressionCase.py -h`
"""
...
parser.add_argument("executable", metavar="AeroDyn-Inflow-Python", type=str, nargs=1, help="The path to the AeroDyn driver executable.")
...
if not noExec:
    caseInputFile = os.path.join(testBuildDirectory, "ad_py_driver.py")
...
localOutFile      = os.path.join(testBuildDirectory, "ad_py_driver.out")
