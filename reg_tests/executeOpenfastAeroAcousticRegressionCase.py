...
"""
    This program executes OpenFAST and a regression test for a single test case with
    the aero-acoustics module in AeroDyn15.
    ...
    Get usage with: `executeOpenfastAeroAcousticRegressionCase.py -h`
"""
