   SUBROUTINE Solution_ACC(uuN0,uuN,vvN,Stif0,Mass0,gravity,u,&
                            damp_flag,beta,&
...
!   INTEGER(IntKi):: indx(dof_total) 
   ...
   CALL GenerateDynamicElement_ACC(uuN0,uuN,vvN,Stif0,Mass0,gravity,u,&
                                   damp_flag,beta,&
...
!   CALL lubksb(MassM,dof_total,indx,RHS,sol)
!   xdot%q(:) = 0.0D0
!   xdot%dqdt(:) = 0.0D0
   DO j=1,dof_total-6
