...
class InputWriter_OpenFAST(object):
    ...
    def write_HydroDyn(self):
        ...
        f.write('{:<22d} {:<11} {:}'.format(', '.join([f'{val}' for val in self.fst_vt['HydroDyn']['NAddDOF']]), 'NAddDOF', '- Number of additional generalized DOF of each WAMIT body (-) [1 to NBody] [>=0; =0 if NBody>1; only used when PotMod=1]\n'))
    ...
    def write_ExtPtfm(self):
        ...
        f.write('{!s:<22} {:<11} {:}'.format(self.fst_vt['ExtPtfm']['Connections'], 'Connections', '- Flag for connection points on the structure (flag)\n'))
        ...
        f.write('{!s:<22} {:<11} {:}'.format(self.fst_vt['ExtPtfm']['UserForcing'], 'UserForcing', '- Flag for user-prescribed modal forcing (flag)\n'))
        ...
        f.write('{!s:<22} {:<11} {:}'.format(self.fst_vt['ExtPtfm']['ConnForcing'], 'ConnForcing', '- Flag for user-prescribed connection forcing (flag)\n'))
