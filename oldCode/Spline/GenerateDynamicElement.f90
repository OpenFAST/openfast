   SUBROUTINE GenerateDynamicElement(uuN0,uuN,vvN,Stif0,Mass0,gravity,u,&
...
!       WRITE(*,*) 'EStif0_GL1'
!       WRITE(*,*) EStif0_GL(:,:,1)
       CALL ElementMatrix(Nuu0,Nuuu,Nrr0,Nrrr,Nvvv,EStif0_GL,EMass0_GL,gravity,DistrLoad_GL,&
