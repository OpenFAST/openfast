...
structure::
      ...
      ---------------------- SPATIAL DISCRETIZATION ---------------------------------------------------
               ...
               False   WvKinBlockMod  - Use on-demand block partitioning of the wave-kinematics volume grid (flag)
           "DEFAULT"   WvKinBlockSize - Target edge length of an on-demand cube block (m) [used only when WvKinBlockMod=True; DEFAULT=100]
           "DEFAULT"   WvKinBlockFreeT - Free a block after this much simulation time without an access (s) [used only when WvKinBlockMod=True; <=0 disables freeing; DEFAULT=600]
      ---------------------- WAVES ---------------------------------------------------
