...
The load applied at the tip about the negative $x_2$ direction is given by 
\begin{equation}
    \label{E1Load}
    M_2 = \lambda \bar{M}_2
\end{equation}
...
The rotation parameter $p_2$ and rotation angle $\phi_2$ at each node along beam axis $x_1$ obtained
...
\begin{figure}[h]
    \centering
    \begin{tabular}{c}
    \subfloat[Rotation parameter $p_2$ and rotation angle $\phi_2$]{\label{E1Rot:Rot}\includegraphics[width=3.0in]{\directory E1Rot_New.eps}} \qquad 
    \subfloat[Relative rotation $r_2$]{\label{E1Rot:Rel}\includegraphics[width=3.0in]{\directory E1RelRot_New.eps}} 
    \end{tabular}
