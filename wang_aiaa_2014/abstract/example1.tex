...
\begin{figure}
    \centering
    \begin{tabular}{c}
    \subfloat[Rotation parameter $p_2$ and rotation angle $\phi_2$]{\label{E1Rot:Rot}\includegraphics[width=3.0in]{\directory E1Rot.eps}} \qquad 
