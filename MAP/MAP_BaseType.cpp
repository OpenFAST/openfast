 ...
 * ====================================================================================================
 */
void MAP_BaseType::pushVar( VarType *T ) { 
  var.push_back( T );
}
 ...
 * ====================================================================================================
 */
boost::python::numeric::array MAP_BaseType::getPyArray(){
  // initialize a list
 ...
 * ====================================================================================================
 */
void MAP_BaseType::setPyArray( const boost::python::numeric::array &T ) {
 ...
 * ====================================================================================================
 */
void MAP_BaseType::setPyArray( unsigned int index , const double T) {
