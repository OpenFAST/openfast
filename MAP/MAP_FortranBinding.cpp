...
};//  ==========   END MAPCALL_MSQS_Init Subroutine Bindings   ===============
...
{                                                                                         
  ...
  try{
    ...
    MAPPackOutput    ( OutData   , y, OtherData );
...
};//  ==========   END MAPCALL_MSQS_CalcOutput Subroutine Bindings   ===============
...
};//  ==========   END MAPCALL_MSQS_End Subroutine Bindings   ===============
...
//  // set the length and population of the PLOT_flag
//  // parameter boolean expression
//  other->PLOT_flag_Len = o->getSizeOfElement( );                                                      
//  other->PLOT_flag = new bool[other->PLOT_flag_Len];
//  for ( int i=0 ; i<other->PLOT_flag_Len ; i++ ) {
//    other->PLOT_flag[i] = o->getPLOTFlag( i );
//    valArrayBool.push_back( other->PLOT_flag[i] );
//  } 
//                                                                                                            
//  // set the length and population of the X_POS_flag
//  // parameter boolean expression
//  other->X_POS_flag_Len = o->getSizeOfElement( );                                                     
//  other->X_POS_flag = new bool[other->X_POS_flag_Len];
//  for ( int i=0 ; i<other->X_POS_flag_Len ; i++ )  {
//    other->X_POS_flag[i] = o->getX_POSFlag( i );                                                     
//    valArrayBool.push_back( other->X_POS_flag[i] );
//  }
//
//  // set the length and population of the Y_POS_flag
//  // parameter boolean expression
//  other->Y_POS_flag_Len = o->getSizeOfElement( );                                                     
//  other->Y_POS_flag = new bool[other->Y_POS_flag_Len];
//  for ( int i=0 ; i<other->Y_POS_flag_Len ; i++ ) {
//    other->Y_POS_flag[i] = o->getY_POSFlag( i );                                                     
//    valArrayBool.push_back( other->Y_POS_flag[i] );
//  }
//
//  // set the length and population of the Z_POS_flag
//  // parameter boolean expression
//  other->Z_POS_flag_Len = o->getSizeOfElement( );                                                     
//  other->Z_POS_flag = new bool[other->Z_POS_flag_Len];
//  for ( int i=0 ; i<other->Z_POS_flag_Len ; i++ ) {
//    other->Z_POS_flag[i] = o->getZ_POSFlag( i );                                                     
//    valArrayBool.push_back( other->Z_POS_flag[i] );
//  }
//
//  // set the length and population of the X_FORCE_flag
//  // parameter boolean expression
//  other->X_FORCE_flag_Len = o->getSizeOfElement( );                                                   
//  other->X_FORCE_flag = new bool[other->X_FORCE_flag_Len];
//  for ( int i=0 ; i<other->X_FORCE_flag_Len ; i++ ) {
//    other->X_FORCE_flag[i] = o->getX_FORCEFlag( i );                                                 
//    valArrayBool.push_back( other->X_FORCE_flag[i] );
//  }
//
//  // set the length and population of the Y_FORCE_flag
//  // parameter boolean expression
//  other->Y_FORCE_flag_Len = o->getSizeOfElement( );                                                   
//  other->Y_FORCE_flag = new bool[other->Y_FORCE_flag_Len];
//  for ( int i=0 ; i<other->Y_FORCE_flag_Len ; i++ ) {
//    other->Y_FORCE_flag[i] = o->getY_FORCEFlag( i );                                                 
//    valArrayBool.push_back( other->Y_FORCE_flag[i] );
//  }
//
//  // set the length and population of the Z_FORCE_flag
//  // parameter boolean expression
//  other->Z_FORCE_flag_Len = o->getSizeOfElement( );                                                   
//  other->Z_FORCE_flag = new bool[other->Z_FORCE_flag_Len];
//  for ( int i=0 ; i<other->Z_FORCE_flag_Len ; i++ ) {
//    other->Z_FORCE_flag[i] = o->getZ_FORCEFlag( i );                                                 
//    valArrayBool.push_back( other->Z_FORCE_flag[i] );
//  }
//
//  // set the length and population of the LINE_TENSION_flag
//  // parameter boolean expression
//  other->LINE_TENSION_flag_Len = o->getSizeOfElement( );                                              
//  other->LINE_TENSION_flag = new bool[other->LINE_TENSION_flag_Len];
//  for ( int i=0 ; i<other->LINE_TENSION_flag_Len ; i++ ) {
//    other->LINE_TENSION_flag[i] = o->getLINE_TENSIONFlag( i );                                       
//    valArrayBool.push_back( other->LINE_TENSION_flag[i] );
//  }
//
//  // set the length and population of the OMIT_CONTACT_flag
//  // parameter boolean expression
//  other->OMIT_CONTACT_flag_Len = o->getSizeOfElement( );                                              
//  other->OMIT_CONTACT_flag = new bool[other->OMIT_CONTACT_flag_Len];
//  for ( int i=0 ; i<other->OMIT_CONTACT_flag_Len ; i++ ) {
//    other->OMIT_CONTACT_flag[i] = o->getOMIT_CONTACTFlag( i );                                       
//    valArrayBool.push_back( other->OMIT_CONTACT_flag[i] );
//  }
//
//  // set the length and population of the LAY_LENGTH_flag
//  // parameter boolean expression
//  other->LAY_LENGTH_flag_Len = o->getSizeOfElement( );                                                
//  other->LAY_LENGTH_flag = new bool[other->LAY_LENGTH_flag_Len];
//  for ( int i=0 ; i<other->LAY_LENGTH_flag_Len ; i++ ) {
//    other->LAY_LENGTH_flag[i] = o->getLAY_LENGTHFlag( i );                                           
//    valArrayBool.push_back( other->LAY_LENGTH_flag[i] );
//  }
...
//  // Do the same, but for the boolean array
//  other->FLAGS_index_Len = valArrayBool.size();
//  other->FLAGS_index = new bool[ other->FLAGS_index_Len ];                              
//  for( int i=0 ; i<other->FLAGS_index_Len ; i++ ) {
//    other->FLAGS_index[i] = valArrayBool[i];
//  };
};
