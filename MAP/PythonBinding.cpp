...
BOOST_PYTHON_MODULE(MAP) {
   ...
   */                                                                               //         | 
                                                                                    //         |
  void (MAP_BaseType::*setPyArray_f1)(const boost::python::numeric::array&)         //         |
    = &MAP_BaseType::setPyArray;                                                    //         |
                                                                                    //         |
  void (MAP_BaseType::*setPyArray_f2)(unsigned int, const double )                  //         |
    = &MAP_BaseType::setPyArray;                                                    //         |
                                                                                    //         |
  void (MAP_InitInputType_class::*setSeaDensity_f1)(const std::string &T)                 //         |
    = &MAP_InitInputType_class::setSeaDensity;                                            //         |
                                                                                    //         |
  void (MAP_InitInputType_class::*setGravity_f1)(const std::string &T)                    //         |
    = &MAP_InitInputType_class::setGravity;                                               //         |
                                                                                    //         |
  void (MAP_InitInputType_class::*setDepth_f1)(const std::string &T)                      //         |
    = &MAP_InitInputType_class::setDepth;                                                 //  -------+
  //============================================================================================
