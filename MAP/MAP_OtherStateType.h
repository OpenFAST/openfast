...
private:
  ...
  //@new 
  MAP_OtherType OtherStateDataTypes;
...
MAP_OtherStateType_class() : num_equations ( 0      ) , 
  ...
  void addDepth       ( const double &T ){ depth = T; };
  void addGravity     ( const double &T ){ gravity = T; };
  void addSeaDensity  ( const double &T ){ rho_sea = T; };
  ...
  bool getPLOTFlag( const int i ) const { return this->element[i]->getPLOT_flag(); }
  bool getX_POSFlag( const int i ) const { return this->element[i]->getX_POS_flag(); }
  bool getY_POSFlag( const int i ) const { return this->element[i]->getY_POS_flag(); }
  bool getZ_POSFlag( const int i ) const { return this->element[i]->getZ_POS_flag(); }
  bool getX_FORCEFlag( const int i ) const { return this->element[i]->getX_FORCE_flag(); }
  bool getY_FORCEFlag( const int i ) const { return this->element[i]->getY_FORCE_flag(); }
  bool getZ_FORCEFlag( const int i ) const { return this->element[i]->getZ_FORCE_flag(); }
  bool getLINE_TENSIONFlag( const int i ) const { return this->element[i]->getLINE_TENSION_flag(); }
  bool getOMIT_CONTACTFlag( const int i ) const { return this->element[i]->getOMIT_CONTACT_flag(); }
  bool getLAY_LENGTHFlag( const int i ) const { return this->element[i]->getLAY_LENGTH_flag(); }
  void setPLOTFlag( const int i , const bool f ) { this->element[i]->setPLOT_flag( f ); }
  void setXPOSFlag( const int i , const bool f ) { this->element[i]->setX_POS_flag( f ); }
  void setYPOSFlag( const int i , const bool f ) { this->element[i]->setY_POS_flag( f ); }
  void setZPOSFlag( const int i , const bool f ) { this->element[i]->setZ_POS_flag( f ); }
  void setXFORCEFlag( const int i , const bool f ) { this->element[i]->setX_FORCE_flag( f ); }
  void setYFORCEFlag( const int i , const bool f ) { this->element[i]->setY_FORCE_flag( f ); }
  void setZFORCEFlag( const int i , const bool f ) { this->element[i]->setZ_FORCE_flag( f ); }
  void setLINETENSIONFlag( const int i , const bool f ) { this->element[i]->setLINE_TENSION_flag( f ); }
  void setOMITCONTANCTFlag( const int i , const bool f ) { this->element[i]->setOMIT_CONTACT_flag( f ); }
  void setLAYLENGTHFlag( const int i , const bool f ) { this->element[i]->setLAY_LENGTH_flag( f ); }
  ...
  std::string &getName( const int index ) { return this->OtherStateDataTypes.getName( index ); }
  ...
  void Solve( MAP_ErrStat &Error, MAP_Message &Msg );           //             |
  int CheckResidualConvergence( MAP_ErrStat        &Error ,     //             |
                                MAP_Message        &Msg );      //             |
                                                                //             |
...
//END if
    ...
    return false;
  }//END notMAPOutputType


  // this is used to count the number of node equations that must be
  // written
