...
void map_f2c_otherstate_fx_ ( double * src, MAP_OtherStateType_t * dst , int *n1) {
  int i1,i2,i3,i4,i5 ;
  double *p ;
...
void map_f2c_otherstate_fy_ ( double * src, MAP_OtherStateType_t * dst , int *n1) {
  int i1,i2,i3,i4,i5 ;
  double *p ;
...
void map_f2c_otherstate_fz_ ( double * src, MAP_OtherStateType_t * dst , int *n1) {
  int i1,i2,i3,i4,i5 ;
  double *p ;
