...
! =========  MAP_OtherStateType  =======
  TYPE, BIND(C) :: MAP_OtherStateType_C
    ...
    TYPE(C_ptr) :: FLAGS_index = C_NULL_PTR 
    INTEGER(C_int) :: FLAGS_index_Len = 0 
    TYPE(C_ptr) :: PLOT_flag = C_NULL_PTR 
    INTEGER(C_int) :: PLOT_flag_Len = 0 
    TYPE(C_ptr) :: X_POS_flag = C_NULL_PTR 
    INTEGER(C_int) :: X_POS_flag_Len = 0 
    TYPE(C_ptr) :: Y_POS_flag = C_NULL_PTR 
    INTEGER(C_int) :: Y_POS_flag_Len = 0 
    TYPE(C_ptr) :: Z_POS_flag = C_NULL_PTR 
    INTEGER(C_int) :: Z_POS_flag_Len = 0 
    TYPE(C_ptr) :: X_FORCE_flag = C_NULL_PTR 
    INTEGER(C_int) :: X_FORCE_flag_Len = 0 
    TYPE(C_ptr) :: Y_FORCE_flag = C_NULL_PTR 
    INTEGER(C_int) :: Y_FORCE_flag_Len = 0 
    TYPE(C_ptr) :: Z_FORCE_flag = C_NULL_PTR 
    INTEGER(C_int) :: Z_FORCE_flag_Len = 0 
    TYPE(C_ptr) :: LINE_TENSION_flag = C_NULL_PTR 
    INTEGER(C_int) :: LINE_TENSION_flag_Len = 0 
    TYPE(C_ptr) :: OMIT_CONTACT_flag = C_NULL_PTR 
    INTEGER(C_int) :: OMIT_CONTACT_flag_Len = 0 
    TYPE(C_ptr) :: LAY_LENGTH_flag = C_NULL_PTR 
    INTEGER(C_int) :: LAY_LENGTH_flag_Len = 0 
  ...
  TYPE, PUBLIC :: MAP_OtherStateType
    ...
    LOGICAL , DIMENSION(:), ALLOCATABLE  :: FLAGS_index 
    LOGICAL , DIMENSION(:), ALLOCATABLE  :: PLOT_flag 
    LOGICAL , DIMENSION(:), ALLOCATABLE  :: X_POS_flag 
    LOGICAL , DIMENSION(:), ALLOCATABLE  :: Y_POS_flag 
    LOGICAL , DIMENSION(:), ALLOCATABLE  :: Z_POS_flag 
    LOGICAL , DIMENSION(:), ALLOCATABLE  :: X_FORCE_flag 
    LOGICAL , DIMENSION(:), ALLOCATABLE  :: Y_FORCE_flag 
    LOGICAL , DIMENSION(:), ALLOCATABLE  :: Z_FORCE_flag 
    LOGICAL , DIMENSION(:), ALLOCATABLE  :: LINE_TENSION_flag 
    LOGICAL , DIMENSION(:), ALLOCATABLE  :: OMIT_CONTACT_flag 
    LOGICAL , DIMENSION(:), ALLOCATABLE  :: LAY_LENGTH_flag 
...
IF ( ALLOCATED( OtherStateData%FX ) ) THEN
  i1 = SIZE(OtherStateData%FX,1)
  CALL MAP_F2C_OtherState_FX(OtherStateData%FX,OtherStateData%C_obj ,i1)
  OtherStateData%C_obj%FX_Len = i1
ENDIF
IF ( ALLOCATED( OtherStateData%FY ) ) THEN
  i1 = SIZE(OtherStateData%FY,1)
  CALL MAP_F2C_OtherState_FY(OtherStateData%FY,OtherStateData%C_obj ,i1)
  OtherStateData%C_obj%FY_Len = i1
ENDIF
IF ( ALLOCATED( OtherStateData%FZ ) ) THEN
  i1 = SIZE(OtherStateData%FZ,1)
  CALL MAP_F2C_OtherState_FZ(OtherStateData%FZ,OtherStateData%C_obj ,i1)
  OtherStateData%C_obj%FZ_Len = i1
ENDIF
IF ( ALLOCATED( OtherStateData%FLAGS_index ) ) THEN
  i1 = SIZE(OtherStateData%FLAGS_index,1)
  CALL MAP_F2C_OtherState_FLAGS_index(OtherStateData%FLAGS_index,OtherStateData%C_obj ,i1)
  OtherStateData%C_obj%FLAGS_index_Len = i1
ENDIF
IF ( ALLOCATED( OtherStateData%PLOT_flag ) ) THEN
  i1 = SIZE(OtherStateData%PLOT_flag,1)
  CALL MAP_F2C_OtherState_PLOT_flag(OtherStateData%PLOT_flag,OtherStateData%C_obj ,i1)
  OtherStateData%C_obj%PLOT_flag_Len = i1
ENDIF
IF ( ALLOCATED( OtherStateData%X_POS_flag ) ) THEN
  i1 = SIZE(OtherStateData%X_POS_flag,1)
  CALL MAP_F2C_OtherState_X_POS_flag(OtherStateData%X_POS_flag,OtherStateData%C_obj ,i1)
  OtherStateData%C_obj%X_POS_flag_Len = i1
ENDIF
IF ( ALLOCATED( OtherStateData%Y_POS_flag ) ) THEN
  i1 = SIZE(OtherStateData%Y_POS_flag,1)
  CALL MAP_F2C_OtherState_Y_POS_flag(OtherStateData%Y_POS_flag,OtherStateData%C_obj ,i1)
  OtherStateData%C_obj%Y_POS_flag_Len = i1
ENDIF
IF ( ALLOCATED( OtherStateData%Z_POS_flag ) ) THEN
  i1 = SIZE(OtherStateData%Z_POS_flag,1)
  CALL MAP_F2C_OtherState_Z_POS_flag(OtherStateData%Z_POS_flag,OtherStateData%C_obj ,i1)
  OtherStateData%C_obj%Z_POS_flag_Len = i1
ENDIF
IF ( ALLOCATED( OtherStateData%X_FORCE_flag ) ) THEN
  i1 = SIZE(OtherStateData%X_FORCE_flag,1)
  CALL MAP_F2C_OtherState_X_FORCE_flag(OtherStateData%X_FORCE_flag,OtherStateData%C_obj ,i1)
  OtherStateData%C_obj%X_FORCE_flag_Len = i1
ENDIF
IF ( ALLOCATED( OtherStateData%Y_FORCE_flag ) ) THEN
  i1 = SIZE(OtherStateData%Y_FORCE_flag,1)
  CALL MAP_F2C_OtherState_Y_FORCE_flag(OtherStateData%Y_FORCE_flag,OtherStateData%C_obj ,i1)
  OtherStateData%C_obj%Y_FORCE_flag_Len = i1
ENDIF
IF ( ALLOCATED( OtherStateData%Z_FORCE_flag ) ) THEN
  i1 = SIZE(OtherStateData%Z_FORCE_flag,1)
  CALL MAP_F2C_OtherState_Z_FORCE_flag(OtherStateData%Z_FORCE_flag,OtherStateData%C_obj ,i1)
  OtherStateData%C_obj%Z_FORCE_flag_Len = i1
ENDIF
IF ( ALLOCATED( OtherStateData%LINE_TENSION_flag ) ) THEN
  i1 = SIZE(OtherStateData%LINE_TENSION_flag,1)
  CALL MAP_F2C_OtherState_LINE_TENSION_flag(OtherStateData%LINE_TENSION_flag,OtherStateData%C_obj ,i1)
  OtherStateData%C_obj%LINE_TENSION_flag_Len = i1
ENDIF
IF ( ALLOCATED( OtherStateData%OMIT_CONTACT_flag ) ) THEN
  i1 = SIZE(OtherStateData%OMIT_CONTACT_flag,1)
  CALL MAP_F2C_OtherState_OMIT_CONTACT_flag(OtherStateData%OMIT_CONTACT_flag,OtherStateData%C_obj ,i1)
  OtherStateData%C_obj%OMIT_CONTACT_flag_Len = i1
ENDIF
IF ( ALLOCATED( OtherStateData%LAY_LENGTH_flag ) ) THEN
  i1 = SIZE(OtherStateData%LAY_LENGTH_flag,1)
  CALL MAP_F2C_OtherState_LAY_LENGTH_flag(OtherStateData%LAY_LENGTH_flag,OtherStateData%C_obj ,i1)
  OtherStateData%C_obj%LAY_LENGTH_flag_Len = i1
ENDIF
IF ( ALLOCATED( OtherStateData%u_index ) ) THEN
  i1 = SIZE(OtherStateData%u_index,1)
  CALL MAP_F2C_OtherState_u_index(OtherStateData%u_index,OtherStateData%C_obj ,i1)
  OtherStateData%C_obj%u_index_Len = i1
ENDIF
IF ( ALLOCATED( OtherStateData%p_index ) ) THEN
  i1 = SIZE(OtherStateData%p_index,1)
  CALL MAP_F2C_OtherState_p_index(OtherStateData%p_index,OtherStateData%C_obj ,i1)
  OtherStateData%C_obj%p_index_Len = i1
ENDIF
IF ( ALLOCATED( OtherStateData%x_index ) ) THEN
  i1 = SIZE(OtherStateData%x_index,1)
  CALL MAP_F2C_OtherState_x_index(OtherStateData%x_index,OtherStateData%C_obj ,i1)
  OtherStateData%C_obj%x_index_Len = i1
ENDIF
IF ( ALLOCATED( OtherStateData%xd_index ) ) THEN
  i1 = SIZE(OtherStateData%xd_index,1)
  CALL MAP_F2C_OtherState_xd_index(OtherStateData%xd_index,OtherStateData%C_obj ,i1)
  OtherStateData%C_obj%xd_index_Len = i1
ENDIF
IF ( ALLOCATED( OtherStateData%z_index ) ) THEN
  i1 = SIZE(OtherStateData%z_index,1)
  CALL MAP_F2C_OtherState_z_index(OtherStateData%z_index,OtherStateData%C_obj ,i1)
  OtherStateData%C_obj%z_index_Len = i1
ENDIF
IF ( ALLOCATED( OtherStateData%y_index ) ) THEN
  i1 = SIZE(OtherStateData%y_index,1)
  CALL MAP_F2C_OtherState_y_index(OtherStateData%y_index,OtherStateData%C_obj ,i1)
  OtherStateData%C_obj%y_index_Len = i1
ENDIF
IF ( ALLOCATED( OtherStateData%o_index ) ) THEN
  i1 = SIZE(OtherStateData%o_index,1)
  CALL MAP_F2C_OtherState_o_index(OtherStateData%o_index,OtherStateData%C_obj ,i1)
  OtherStateData%C_obj%o_index_Len = i1
ENDIF
...
IF ( ALLOCATED( OtherStateData%FX ) ) THEN
  i1 = SIZE(OtherStateData%FX,1)
  CALL MAP_C2F_OtherState_FX(OtherStateData%C_obj,OtherStateData%FX ,i1)
ENDIF
IF ( ALLOCATED( OtherStateData%FY ) ) THEN
  i1 = SIZE(OtherStateData%FY,1)
  CALL MAP_C2F_OtherState_FY(OtherStateData%C_obj,OtherStateData%FY ,i1)
ENDIF
IF ( ALLOCATED( OtherStateData%FZ ) ) THEN
  i1 = SIZE(OtherStateData%FZ,1)
  CALL MAP_C2F_OtherState_FZ(OtherStateData%C_obj,OtherStateData%FZ ,i1)
ENDIF
IF ( ALLOCATED( OtherStateData%FLAGS_index ) ) THEN
  i1 = SIZE(OtherStateData%FLAGS_index,1)
  CALL MAP_C2F_OtherState_FLAGS_index(OtherStateData%C_obj,OtherStateData%FLAGS_index ,i1)
ENDIF
IF ( ALLOCATED( OtherStateData%PLOT_flag ) ) THEN
  i1 = SIZE(OtherStateData%PLOT_flag,1)
  CALL MAP_C2F_OtherState_PLOT_flag(OtherStateData%C_obj,OtherStateData%PLOT_flag ,i1)
ENDIF
IF ( ALLOCATED( OtherStateData%X_POS_flag ) ) THEN
  i1 = SIZE(OtherStateData%X_POS_flag,1)
  CALL MAP_C2F_OtherState_X_POS_flag(OtherStateData%C_obj,OtherStateData%X_POS_flag ,i1)
ENDIF
IF ( ALLOCATED( OtherStateData%Y_POS_flag ) ) THEN
  i1 = SIZE(OtherStateData%Y_POS_flag,1)
  CALL MAP_C2F_OtherState_Y_POS_flag(OtherStateData%C_obj,OtherStateData%Y_POS_flag ,i1)
ENDIF
IF ( ALLOCATED( OtherStateData%Z_POS_flag ) ) THEN
  i1 = SIZE(OtherStateData%Z_POS_flag,1)
  CALL MAP_C2F_OtherState_Z_POS_flag(OtherStateData%C_obj,OtherStateData%Z_POS_flag ,i1)
ENDIF
IF ( ALLOCATED( OtherStateData%X_FORCE_flag ) ) THEN
  i1 = SIZE(OtherStateData%X_FORCE_flag,1)
  CALL MAP_C2F_OtherState_X_FORCE_flag(OtherStateData%C_obj,OtherStateData%X_FORCE_flag ,i1)
ENDIF
IF ( ALLOCATED( OtherStateData%Y_FORCE_flag ) ) THEN
  i1 = SIZE(OtherStateData%Y_FORCE_flag,1)
  CALL MAP_C2F_OtherState_Y_FORCE_flag(OtherStateData%C_obj,OtherStateData%Y_FORCE_flag ,i1)
ENDIF
IF ( ALLOCATED( OtherStateData%Z_FORCE_flag ) ) THEN
  i1 = SIZE(OtherStateData%Z_FORCE_flag,1)
  CALL MAP_C2F_OtherState_Z_FORCE_flag(OtherStateData%C_obj,OtherStateData%Z_FORCE_flag ,i1)
ENDIF
IF ( ALLOCATED( OtherStateData%LINE_TENSION_flag ) ) THEN
  i1 = SIZE(OtherStateData%LINE_TENSION_flag,1)
  CALL MAP_C2F_OtherState_LINE_TENSION_flag(OtherStateData%C_obj,OtherStateData%LINE_TENSION_flag ,i1)
ENDIF
IF ( ALLOCATED( OtherStateData%OMIT_CONTACT_flag ) ) THEN
  i1 = SIZE(OtherStateData%OMIT_CONTACT_flag,1)
  CALL MAP_C2F_OtherState_OMIT_CONTACT_flag(OtherStateData%C_obj,OtherStateData%OMIT_CONTACT_flag ,i1)
ENDIF
IF ( ALLOCATED( OtherStateData%LAY_LENGTH_flag ) ) THEN
  i1 = SIZE(OtherStateData%LAY_LENGTH_flag,1)
  CALL MAP_C2F_OtherState_LAY_LENGTH_flag(OtherStateData%C_obj,OtherStateData%LAY_LENGTH_flag ,i1)
ENDIF
IF ( ALLOCATED( OtherStateData%u_index ) ) THEN
  i1 = SIZE(OtherStateData%u_index,1)
  CALL MAP_C2F_OtherState_u_index(OtherStateData%C_obj,OtherStateData%u_index ,i1)
ENDIF
IF ( ALLOCATED( OtherStateData%p_index ) ) THEN
  i1 = SIZE(OtherStateData%p_index,1)
  CALL MAP_C2F_OtherState_p_index(OtherStateData%C_obj,OtherStateData%p_index ,i1)
ENDIF
IF ( ALLOCATED( OtherStateData%x_index ) ) THEN
  i1 = SIZE(OtherStateData%x_index,1)
  CALL MAP_C2F_OtherState_x_index(OtherStateData%C_obj,OtherStateData%x_index ,i1)
ENDIF
IF ( ALLOCATED( OtherStateData%xd_index ) ) THEN
  i1 = SIZE(OtherStateData%xd_index,1)
  CALL MAP_C2F_OtherState_xd_index(OtherStateData%C_obj,OtherStateData%xd_index ,i1)
ENDIF
IF ( ALLOCATED( OtherStateData%z_index ) ) THEN
  i1 = SIZE(OtherStateData%z_index,1)
  CALL MAP_C2F_OtherState_z_index(OtherStateData%C_obj,OtherStateData%z_index ,i1)
ENDIF
IF ( ALLOCATED( OtherStateData%y_index ) ) THEN
  i1 = SIZE(OtherStateData%y_index,1)
  CALL MAP_C2F_OtherState_y_index(OtherStateData%C_obj,OtherStateData%y_index ,i1)
ENDIF
IF ( ALLOCATED( OtherStateData%o_index ) ) THEN
  i1 = SIZE(OtherStateData%o_index,1)
  CALL MAP_C2F_OtherState_o_index(OtherStateData%C_obj,OtherStateData%o_index ,i1)
ENDIF
...
ENDIF
IF ( ALLOCATED( SrcOtherStateData%FLAGS_index ) ) THEN
  i1 = SIZE(SrcOtherStateData%FLAGS_index,1)
  IF (.NOT.ALLOCATED(DstOtherStateData%FLAGS_index)) ALLOCATE(DstOtherStateData%FLAGS_index(i1))
  DstOtherStateData%FLAGS_index = SrcOtherStateData%FLAGS_index
ENDIF
IF ( ALLOCATED( SrcOtherStateData%PLOT_flag ) ) THEN
  i1 = SIZE(SrcOtherStateData%PLOT_flag,1)
  IF (.NOT.ALLOCATED(DstOtherStateData%PLOT_flag)) ALLOCATE(DstOtherStateData%PLOT_flag(i1))
  DstOtherStateData%PLOT_flag = SrcOtherStateData%PLOT_flag
ENDIF
IF ( ALLOCATED( SrcOtherStateData%X_POS_flag ) ) THEN
  i1 = SIZE(SrcOtherStateData%X_POS_flag,1)
  IF (.NOT.ALLOCATED(DstOtherStateData%X_POS_flag)) ALLOCATE(DstOtherStateData%X_POS_flag(i1))
  DstOtherStateData%X_POS_flag = SrcOtherStateData%X_POS_flag
ENDIF
IF ( ALLOCATED( SrcOtherStateData%Y_POS_flag ) ) THEN
  i1 = SIZE(SrcOtherStateData%Y_POS_flag,1)
  IF (.NOT.ALLOCATED(DstOtherStateData%Y_POS_flag)) ALLOCATE(DstOtherStateData%Y_POS_flag(i1))
  DstOtherStateData%Y_POS_flag = SrcOtherStateData%Y_POS_flag
ENDIF
IF ( ALLOCATED( SrcOtherStateData%Z_POS_flag ) ) THEN
  i1 = SIZE(SrcOtherStateData%Z_POS_flag,1)
  IF (.NOT.ALLOCATED(DstOtherStateData%Z_POS_flag)) ALLOCATE(DstOtherStateData%Z_POS_flag(i1))
  DstOtherStateData%Z_POS_flag = SrcOtherStateData%Z_POS_flag
ENDIF
IF ( ALLOCATED( SrcOtherStateData%X_FORCE_flag ) ) THEN
  i1 = SIZE(SrcOtherStateData%X_FORCE_flag,1)
  IF (.NOT.ALLOCATED(DstOtherStateData%X_FORCE_flag)) ALLOCATE(DstOtherStateData%X_FORCE_flag(i1))
  DstOtherStateData%X_FORCE_flag = SrcOtherStateData%X_FORCE_flag
ENDIF
IF ( ALLOCATED( SrcOtherStateData%Y_FORCE_flag ) ) THEN
  i1 = SIZE(SrcOtherStateData%Y_FORCE_flag,1)
  IF (.NOT.ALLOCATED(DstOtherStateData%Y_FORCE_flag)) ALLOCATE(DstOtherStateData%Y_FORCE_flag(i1))
  DstOtherStateData%Y_FORCE_flag = SrcOtherStateData%Y_FORCE_flag
ENDIF
IF ( ALLOCATED( SrcOtherStateData%Z_FORCE_flag ) ) THEN
  i1 = SIZE(SrcOtherStateData%Z_FORCE_flag,1)
  IF (.NOT.ALLOCATED(DstOtherStateData%Z_FORCE_flag)) ALLOCATE(DstOtherStateData%Z_FORCE_flag(i1))
  DstOtherStateData%Z_FORCE_flag = SrcOtherStateData%Z_FORCE_flag
ENDIF
IF ( ALLOCATED( SrcOtherStateData%LINE_TENSION_flag ) ) THEN
  i1 = SIZE(SrcOtherStateData%LINE_TENSION_flag,1)
  IF (.NOT.ALLOCATED(DstOtherStateData%LINE_TENSION_flag)) ALLOCATE(DstOtherStateData%LINE_TENSION_flag(i1))
  DstOtherStateData%LINE_TENSION_flag = SrcOtherStateData%LINE_TENSION_flag
ENDIF
IF ( ALLOCATED( SrcOtherStateData%OMIT_CONTACT_flag ) ) THEN
  i1 = SIZE(SrcOtherStateData%OMIT_CONTACT_flag,1)
  IF (.NOT.ALLOCATED(DstOtherStateData%OMIT_CONTACT_flag)) ALLOCATE(DstOtherStateData%OMIT_CONTACT_flag(i1))
  DstOtherStateData%OMIT_CONTACT_flag = SrcOtherStateData%OMIT_CONTACT_flag
ENDIF
IF ( ALLOCATED( SrcOtherStateData%LAY_LENGTH_flag ) ) THEN
  i1 = SIZE(SrcOtherStateData%LAY_LENGTH_flag,1)
  IF (.NOT.ALLOCATED(DstOtherStateData%LAY_LENGTH_flag)) ALLOCATE(DstOtherStateData%LAY_LENGTH_flag(i1))
  DstOtherStateData%LAY_LENGTH_flag = SrcOtherStateData%LAY_LENGTH_flag
ENDIF
...
! 
  ...
  IF ( ALLOCATED(OtherStateData%FLAGS_index) ) DEALLOCATE(OtherStateData%FLAGS_index)
  IF ( ALLOCATED(OtherStateData%PLOT_flag) ) DEALLOCATE(OtherStateData%PLOT_flag)
  IF ( ALLOCATED(OtherStateData%X_POS_flag) ) DEALLOCATE(OtherStateData%X_POS_flag)
  IF ( ALLOCATED(OtherStateData%Y_POS_flag) ) DEALLOCATE(OtherStateData%Y_POS_flag)
  IF ( ALLOCATED(OtherStateData%Z_POS_flag) ) DEALLOCATE(OtherStateData%Z_POS_flag)
  IF ( ALLOCATED(OtherStateData%X_FORCE_flag) ) DEALLOCATE(OtherStateData%X_FORCE_flag)
  IF ( ALLOCATED(OtherStateData%Y_FORCE_flag) ) DEALLOCATE(OtherStateData%Y_FORCE_flag)
  IF ( ALLOCATED(OtherStateData%Z_FORCE_flag) ) DEALLOCATE(OtherStateData%Z_FORCE_flag)
  IF ( ALLOCATED(OtherStateData%LINE_TENSION_flag) ) DEALLOCATE(OtherStateData%LINE_TENSION_flag)
  IF ( ALLOCATED(OtherStateData%OMIT_CONTACT_flag) ) DEALLOCATE(OtherStateData%OMIT_CONTACT_flag)
  IF ( ALLOCATED(OtherStateData%LAY_LENGTH_flag) ) DEALLOCATE(OtherStateData%LAY_LENGTH_flag)
...
IF ( ALLOCATED( ConstrStateData%X ) ) THEN
  i1 = SIZE(ConstrStateData%X,1)
  CALL MAP_F2C_ConstrState_X(ConstrStateData%X,ConstrStateData%C_obj ,i1)
  ConstrStateData%C_obj%X_Len = i1
ENDIF
IF ( ALLOCATED( ConstrStateData%Y ) ) THEN
  i1 = SIZE(ConstrStateData%Y,1)
  CALL MAP_F2C_ConstrState_Y(ConstrStateData%Y,ConstrStateData%C_obj ,i1)
  ConstrStateData%C_obj%Y_Len = i1
ENDIF
IF ( ALLOCATED( ConstrStateData%Z ) ) THEN
  i1 = SIZE(ConstrStateData%Z,1)
  CALL MAP_F2C_ConstrState_Z(ConstrStateData%Z,ConstrStateData%C_obj ,i1)
  ConstrStateData%C_obj%Z_Len = i1
ENDIF
IF ( ALLOCATED( ConstrStateData%H ) ) THEN
  i1 = SIZE(ConstrStateData%H,1)
  CALL MAP_F2C_ConstrState_H(ConstrStateData%H,ConstrStateData%C_obj ,i1)
  ConstrStateData%C_obj%H_Len = i1
ENDIF
IF ( ALLOCATED( ConstrStateData%V ) ) THEN
  i1 = SIZE(ConstrStateData%V,1)
  CALL MAP_F2C_ConstrState_V(ConstrStateData%V,ConstrStateData%C_obj ,i1)
  ConstrStateData%C_obj%V_Len = i1
ENDIF
...
IF ( ALLOCATED( ConstrStateData%X ) ) THEN
  i1 = SIZE(ConstrStateData%X,1)
  CALL MAP_C2F_ConstrState_X(ConstrStateData%C_obj,ConstrStateData%X ,i1)
ENDIF
IF ( ALLOCATED( ConstrStateData%Y ) ) THEN
  i1 = SIZE(ConstrStateData%Y,1)
  CALL MAP_C2F_ConstrState_Y(ConstrStateData%C_obj,ConstrStateData%Y ,i1)
ENDIF
IF ( ALLOCATED( ConstrStateData%Z ) ) THEN
  i1 = SIZE(ConstrStateData%Z,1)
  CALL MAP_C2F_ConstrState_Z(ConstrStateData%C_obj,ConstrStateData%Z ,i1)
ENDIF
IF ( ALLOCATED( ConstrStateData%H ) ) THEN
  i1 = SIZE(ConstrStateData%H,1)
  CALL MAP_C2F_ConstrState_H(ConstrStateData%C_obj,ConstrStateData%H ,i1)
ENDIF
IF ( ALLOCATED( ConstrStateData%V ) ) THEN
  i1 = SIZE(ConstrStateData%V,1)
  CALL MAP_C2F_ConstrState_V(ConstrStateData%C_obj,ConstrStateData%V ,i1)
ENDIF
...
IF ( ALLOCATED( ParamData%Diam ) ) THEN
  i1 = SIZE(ParamData%Diam,1)
  CALL MAP_F2C_Param_Diam(ParamData%Diam,ParamData%C_obj ,i1)
  ParamData%C_obj%Diam_Len = i1
ENDIF
IF ( ALLOCATED( ParamData%MassDenInAir ) ) THEN
  i1 = SIZE(ParamData%MassDenInAir,1)
  CALL MAP_F2C_Param_MassDenInAir(ParamData%MassDenInAir,ParamData%C_obj ,i1)
  ParamData%C_obj%MassDenInAir_Len = i1
ENDIF
IF ( ALLOCATED( ParamData%EA ) ) THEN
  i1 = SIZE(ParamData%EA,1)
  CALL MAP_F2C_Param_EA(ParamData%EA,ParamData%C_obj ,i1)
  ParamData%C_obj%EA_Len = i1
ENDIF
IF ( ALLOCATED( ParamData%CB ) ) THEN
  i1 = SIZE(ParamData%CB,1)
  CALL MAP_F2C_Param_CB(ParamData%CB,ParamData%C_obj ,i1)
  ParamData%C_obj%CB_Len = i1
ENDIF
IF ( ALLOCATED( ParamData%Lu ) ) THEN
  i1 = SIZE(ParamData%Lu,1)
  CALL MAP_F2C_Param_Lu(ParamData%Lu,ParamData%C_obj ,i1)
  ParamData%C_obj%Lu_Len = i1
ENDIF
IF ( ALLOCATED( ParamData%X ) ) THEN
  i1 = SIZE(ParamData%X,1)
  CALL MAP_F2C_Param_X(ParamData%X,ParamData%C_obj ,i1)
  ParamData%C_obj%X_Len = i1
ENDIF
IF ( ALLOCATED( ParamData%Y ) ) THEN
  i1 = SIZE(ParamData%Y,1)
  CALL MAP_F2C_Param_Y(ParamData%Y,ParamData%C_obj ,i1)
  ParamData%C_obj%Y_Len = i1
ENDIF
IF ( ALLOCATED( ParamData%Z ) ) THEN
  i1 = SIZE(ParamData%Z,1)
  CALL MAP_F2C_Param_Z(ParamData%Z,ParamData%C_obj ,i1)
  ParamData%C_obj%Z_Len = i1
ENDIF
IF ( ALLOCATED( ParamData%FX ) ) THEN
  i1 = SIZE(ParamData%FX,1)
  CALL MAP_F2C_Param_FX(ParamData%FX,ParamData%C_obj ,i1)
  ParamData%C_obj%FX_Len = i1
ENDIF
IF ( ALLOCATED( ParamData%FY ) ) THEN
  i1 = SIZE(ParamData%FY,1)
  CALL MAP_F2C_Param_FY(ParamData%FY,ParamData%C_obj ,i1)
  ParamData%C_obj%FY_Len = i1
ENDIF
IF ( ALLOCATED( ParamData%FZ ) ) THEN
  i1 = SIZE(ParamData%FZ,1)
  CALL MAP_F2C_Param_FZ(ParamData%FZ,ParamData%C_obj ,i1)
  ParamData%C_obj%FZ_Len = i1
ENDIF
IF ( ALLOCATED( ParamData%M ) ) THEN
  i1 = SIZE(ParamData%M,1)
  CALL MAP_F2C_Param_M(ParamData%M,ParamData%C_obj ,i1)
  ParamData%C_obj%M_Len = i1
ENDIF
IF ( ALLOCATED( ParamData%B ) ) THEN
  i1 = SIZE(ParamData%B,1)
  CALL MAP_F2C_Param_B(ParamData%B,ParamData%C_obj ,i1)
  ParamData%C_obj%B_Len = i1
ENDIF
...
IF ( ALLOCATED( ParamData%Diam ) ) THEN
  i1 = SIZE(ParamData%Diam,1)
  CALL MAP_C2F_Param_Diam(ParamData%C_obj,ParamData%Diam ,i1)
ENDIF
IF ( ALLOCATED( ParamData%MassDenInAir ) ) THEN
  i1 = SIZE(ParamData%MassDenInAir,1)
  CALL MAP_C2F_Param_MassDenInAir(ParamData%C_obj,ParamData%MassDenInAir ,i1)
ENDIF
IF ( ALLOCATED( ParamData%EA ) ) THEN
  i1 = SIZE(ParamData%EA,1)
  CALL MAP_C2F_Param_EA(ParamData%C_obj,ParamData%EA ,i1)
ENDIF
IF ( ALLOCATED( ParamData%CB ) ) THEN
  i1 = SIZE(ParamData%CB,1)
  CALL MAP_C2F_Param_CB(ParamData%C_obj,ParamData%CB ,i1)
ENDIF
IF ( ALLOCATED( ParamData%Lu ) ) THEN
  i1 = SIZE(ParamData%Lu,1)
  CALL MAP_C2F_Param_Lu(ParamData%C_obj,ParamData%Lu ,i1)
ENDIF
IF ( ALLOCATED( ParamData%X ) ) THEN
  i1 = SIZE(ParamData%X,1)
  CALL MAP_C2F_Param_X(ParamData%C_obj,ParamData%X ,i1)
ENDIF
IF ( ALLOCATED( ParamData%Y ) ) THEN
  i1 = SIZE(ParamData%Y,1)
  CALL MAP_C2F_Param_Y(ParamData%C_obj,ParamData%Y ,i1)
ENDIF
IF ( ALLOCATED( ParamData%Z ) ) THEN
  i1 = SIZE(ParamData%Z,1)
  CALL MAP_C2F_Param_Z(ParamData%C_obj,ParamData%Z ,i1)
ENDIF
IF ( ALLOCATED( ParamData%FX ) ) THEN
  i1 = SIZE(ParamData%FX,1)
  CALL MAP_C2F_Param_FX(ParamData%C_obj,ParamData%FX ,i1)
ENDIF
IF ( ALLOCATED( ParamData%FY ) ) THEN
  i1 = SIZE(ParamData%FY,1)
  CALL MAP_C2F_Param_FY(ParamData%C_obj,ParamData%FY ,i1)
ENDIF
IF ( ALLOCATED( ParamData%FZ ) ) THEN
  i1 = SIZE(ParamData%FZ,1)
  CALL MAP_C2F_Param_FZ(ParamData%C_obj,ParamData%FZ ,i1)
ENDIF
IF ( ALLOCATED( ParamData%M ) ) THEN
  i1 = SIZE(ParamData%M,1)
  CALL MAP_C2F_Param_M(ParamData%C_obj,ParamData%M ,i1)
ENDIF
IF ( ALLOCATED( ParamData%B ) ) THEN
  i1 = SIZE(ParamData%B,1)
  CALL MAP_C2F_Param_B(ParamData%C_obj,ParamData%B ,i1)
ENDIF
...
IF ( ALLOCATED( InputData%X ) ) THEN
  ...
  CALL MAP_F2C_Input_X(InputData%X,InputData%C_obj ,i1)
  InputData%C_obj%X_Len = i1
ENDIF
IF ( ALLOCATED( InputData%Y ) ) THEN
  i1 = SIZE(InputData%Y,1)
  CALL MAP_F2C_Input_Y(InputData%Y,InputData%C_obj ,i1)
  InputData%C_obj%Y_Len = i1
ENDIF
IF ( ALLOCATED( InputData%Z ) ) THEN
  i1 = SIZE(InputData%Z,1)
  CALL MAP_F2C_Input_Z(InputData%Z,InputData%C_obj ,i1)
  InputData%C_obj%Z_Len = i1
ENDIF
...
IF ( ALLOCATED( InputData%Y ) ) THEN
  i1 = SIZE(InputData%Y,1)
  CALL MAP_C2F_Input_Y(InputData%C_obj,InputData%Y ,i1)
ENDIF
IF ( ALLOCATED( InputData%Z ) ) THEN
  i1 = SIZE(InputData%Z,1)
  CALL MAP_C2F_Input_Z(InputData%C_obj,InputData%Z ,i1)
ENDIF
...
IF ( ALLOCATED( OutputData%FX ) ) THEN
  i1 = SIZE(OutputData%FX,1)
  CALL MAP_F2C_Output_FX(OutputData%FX,OutputData%C_obj ,i1)
  OutputData%C_obj%FX_Len = i1
ENDIF
IF ( ALLOCATED( OutputData%FY ) ) THEN
  i1 = SIZE(OutputData%FY,1)
  CALL MAP_F2C_Output_FY(OutputData%FY,OutputData%C_obj ,i1)
  OutputData%C_obj%FY_Len = i1
ENDIF
IF ( ALLOCATED( OutputData%FZ ) ) THEN
  i1 = SIZE(OutputData%FZ,1)
  CALL MAP_F2C_Output_FZ(OutputData%FZ,OutputData%C_obj ,i1)
  OutputData%C_obj%FZ_Len = i1
ENDIF
...
IF ( ALLOCATED( OutputData%FX ) ) THEN
  i1 = SIZE(OutputData%FX,1)
  CALL MAP_C2F_Output_FX(OutputData%C_obj,OutputData%FX ,i1)
ENDIF
IF ( ALLOCATED( OutputData%FY ) ) THEN
  i1 = SIZE(OutputData%FY,1)
  CALL MAP_C2F_Output_FY(OutputData%C_obj,OutputData%FY ,i1)
ENDIF
IF ( ALLOCATED( OutputData%FZ ) ) THEN
  i1 = SIZE(OutputData%FZ,1)
  CALL MAP_C2F_Output_FZ(OutputData%C_obj,OutputData%FZ ,i1)
ENDIF
...
!..................................................................................................................................
 ...
 TYPE(MAP_inputtype), INTENT(INOUT)  :: u_out     ! Inputs at t1 > t2 > t3
...
!..................................................................................................................................
 ...
 REAL(DbKi),         INTENT(IN   )  :: tin(:)      ! Times associated with the inputs
 TYPE(MAP_outputtype), INTENT(INOUT)  :: u_out     ! Inputs at t1 > t2 > t3
 REAL(DbKi),         INTENT(IN   )  :: tin_out     ! time to be extrap/interp'd to
 INTEGER(IntKi),     INTENT(  OUT)  :: ErrStat   ! Error status of the operation
 CHARACTER(*),       INTENT(  OUT)  :: ErrMsg    ! Error message if ErrStat /= ErrID_None
   ! local variables
