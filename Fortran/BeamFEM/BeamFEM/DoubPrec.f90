...
INTEGER(IntKi), PARAMETER       :: BytesPerReKi  = 8                            ! Number of bytes per ReKi number       - use SIZEOF()
INTEGER(IntKi), PARAMETER       :: BytesPerDbKi  = 16                           ! Number of bytes per DbKi number       - use SIZEOF()         
