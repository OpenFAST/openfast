...
IMPLICIT NONE
    ...
    INTEGER(IntKi), PUBLIC, PARAMETER  :: VF_WriteOut                      = 64      ! Variable for write output [-]
    INTEGER(IntKi), PUBLIC, PARAMETER  :: VF_Solve                         = 128      ! Variable for solver [-]
    INTEGER(IntKi), PUBLIC, PARAMETER  :: VF_AeroMap                       = 256      ! Variable for aeromap [-]
    INTEGER(IntKi), PUBLIC, PARAMETER  :: VF_DerivOrder1                   = 512      ! Variable is derivative order 1 in linearization file [-]
    INTEGER(IntKi), PUBLIC, PARAMETER  :: VF_DerivOrder2                   = 1024      ! Variable is derivative order 2 in linearization file [-]
