...
!! 
!! This routine was generated by Write_ChckOutLst.m using the parameters listed in OutListParameters.xlsx at 02-Jun-2022 17:11:20.
...
!..................................................................................................................................
   ...
   CHARACTER(OutStrLenM1), PARAMETER  :: ValidParamAry(15) =  (/  &   ! This lists the names of the allowed parameters, which must be sorted alphabetically
                               "AZIMUTH   ","GENACC    ","GENSPEED  ","HSSHFTA   ","HSSHFTV   ","LSSTIPA   ","LSSTIPAXA ", &
                               "LSSTIPAXS ","LSSTIPV   ","LSSTIPVXA ","LSSTIPVXS ","ROTACC    ","ROTSPEED  ","YAW       ", &
                               "YAWRATE   "/)
   INTEGER(IntKi), PARAMETER :: ParamIndxAry(15) =  (/ &                            ! This lists the index into AllOuts(:) of the allowed parameters ValidParamAry(:)
                                   Azimuth ,     GenAcc ,   GenSpeed ,     GenAcc ,   GenSpeed ,     RotAcc ,     RotAcc , &
                                    RotAcc ,   RotSpeed ,   RotSpeed ,   RotSpeed ,     RotAcc ,   RotSpeed ,        Yaw , &
                                   YawRate /)
   CHARACTER(ChanLen), PARAMETER :: ParamUnitsAry(15) =  (/  &  ! This lists the units corresponding to the allowed parameters
                               "(deg)    ","(deg/s^2)","(rpm)    ","(deg/s^2)","(rpm)    ","(deg/s^2)","(deg/s^2)", &
                               "(deg/s^2)","(rpm)    ","(rpm)    ","(rpm)    ","(deg/s^2)","(rpm)    ","(deg)    ", &
                               "(deg/s)  "/)
