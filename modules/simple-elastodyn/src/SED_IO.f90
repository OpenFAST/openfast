...
subroutine Calc_WriteOutput( u, p, x, dxdt, y, m, ErrStat, ErrMsg, CalcWriteOutput )
   ...
   m%AllOuts( RotThrust) = dot_product(u%HubPtLoad%Force(:,1), m%HubPt_X(1:3)) * 0.001_ReKi  ! Force along hub X (kN)
...
!! 
!! This routine was generated by Write_ChckOutLst.m using the parameters listed in OutListParameters.xlsx at 03-Jun-2022 11:58:17.
...
!..................................................................................................................................
   ...
   CHARACTER(OutStrLenM1), PARAMETER  :: ValidParamAry(26) =  (/  &   ! This lists the names of the allowed parameters, which must be sorted alphabetically
                               ...
                               "LSSTIPV  ","LSSTIPVXA","LSSTIPVXS","ROTACC   ","ROTPWR   ","ROTSPEED ","ROTTHRUST","ROTTORQ  ", &
                               "YAW      ","YAWRATE  "/)
   INTEGER(IntKi), PARAMETER :: ParamIndxAry(26) =  (/ &                            ! This lists the index into AllOuts(:) of the allowed parameters ValidParamAry(:)
                                 ...
                                 RotSpeed ,  RotSpeed ,  RotSpeed ,    RotAcc ,    RotPwr ,  RotSpeed , RotThrust ,   RotTorq , &
                                      Yaw ,   YawRate /)
   CHARACTER(ChanLen), PARAMETER :: ParamUnitsAry(26) =  (/  &  ! This lists the units corresponding to the allowed parameters
                               "(deg)    ","(deg)    ","(deg)    ","(deg)    ","(deg)    ","(deg)    ","(deg)    ","(deg/s^2)", &
                               "(rpm)    ","(deg/s^2)","(rpm)    ","(kW)     ","(kN-m)   ","(deg/s^2)","(deg/s^2)","(deg/s^2)", &
                               "(rpm)    ","(rpm)    ","(rpm)    ","(deg/s^2)","(kW)     ","(rpm)    ","(kN)     ","(kN-m)   ", &
                               "(deg)    ","(deg/s)  "/)
