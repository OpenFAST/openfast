...
! =========  RotMiscVarType  =======
  TYPE, PUBLIC :: RotMiscVarType
    ...
    TYPE(MeshMapType) , DIMENSION(:), ALLOCATABLE  :: B_P_2_B_L      !< mapping data structure to map buoyant point loads (m%BladeBuoyLoadPoint) to buoyant line loads (m%BladeBuoyLoad) [-]
