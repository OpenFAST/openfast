...
!.......................................................................
      ...
      if(x.ge.64.0d0) then
        x2 = dsqrt(DBLE(x))
        x4 = dsqrt(DBLE(x2))
        dsi = dsin(DBLE(x2)-2.356194490192345)
        dco = dcos(DBLE(x2)-2.356194490192345)
      endif
...
!        xx=ax-2.356194491
        bessj1=0.7978845608028654/x4*(dco*(p1+y*(p2+y*(p3+y*(p4+y*p5)))) &
               -z*dsi*(q1+y*(q2+y*(q3+y*(q4+y*q5)))))*dsign(1.0d0,DBLE(x2))/x2
      endif
      return
      END FUNCTION
...
!U    USES bessj1
      ...
      if(x.lt.64.)then
        ...
        bessy1=(r1+y*(r2+y*(r3+y*(r4+y*(r5+y*r6)))))/(s1+y*(s2+y*(s3+  &
                y*(s4+y*(s5+y*(s6+y*s7))))))+.636619772*(J1*0.5*dlog(DBLE(y))-1./y)
      else
        z=8./x2
        y=z**2.0
!        xx=x2-2.356194491
