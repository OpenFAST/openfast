...
program AeroDyn_Driver
   ...
   call dvr_Init(dat%dvr, dat%dvr%ADI, dat%errStat, dat%errMsg); call CheckError()

   do iCase= 1,dat%dvr%numCases

      ! Initial case
      call dvr_InitCase(iCase, dat%dvr, dat%dvr%ADI, dat%errStat, dat%errMsg); call CheckError()
      ...
      do nt = 1, dat%dvr%numSteps
         call dvr_TimeStep(nt, dat%dvr, dat%dvr%ADI, dat%errStat, dat%errMsg); call CheckError()
      ...
      call dvr_EndCase(dat%dvr, dat%dvr%ADI, dat%initialized, dat%errStat, dat%errMsg); call CheckError()
...
!................................   
   subroutine dvr_End()
      ...
      call dvr_CleanUp(dat%dvr, dat%dvr%ADI, dat%initialized, errStat2, errMsg2)
