   ...
   subroutine Calc_WriteOutput_BEMT
      ...
      do k=1,p%NumBlades
         ...
         if (k==1) then
            ...
            m%AllOuts( B1AeroFxh ) = tmp(1)
            m%AllOuts( B1AeroFyh ) = tmp(2)
            m%AllOuts( B1AeroFzh ) = tmp(3)
            ...
            m%AllOuts( B2AeroFyh ) = tmp(2)
            m%AllOuts( B2AeroFzh ) = tmp(3)
            tmp = matmul( u%HubMotion%Orientation(:,:,1), m%HubLoad%moment(:,1) )
            ...
            m%AllOuts( B3AeroFyh ) = tmp(2)
            m%AllOuts( B3AeroFzh ) = tmp(3)
            tmp = matmul( u%HubMotion%Orientation(:,:,1), m%HubLoad%moment(:,1) )
            ...
            m%AllOuts( B4AeroFyh ) = tmp(2)
            m%AllOuts( B4AeroFzh ) = tmp(3)
            tmp = matmul( u%HubMotion%Orientation(:,:,1), m%HubLoad%moment(:,1) )
