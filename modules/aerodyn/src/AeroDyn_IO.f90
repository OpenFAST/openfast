...
! ===================================================================================================
! This code was generated by Write_ChckOutLst.m at 19-Jul-2021 15:42:45.
   ...
   INTEGER(IntKi), PARAMETER      :: B1FldFxg  = 1439
   INTEGER(IntKi), PARAMETER      :: B1FldFyg  = 1440
   INTEGER(IntKi), PARAMETER      :: B1FldFzg  = 1441
   INTEGER(IntKi), PARAMETER      :: B1FldMxg  = 1442
   INTEGER(IntKi), PARAMETER      :: B1FldMyg  = 1443
   INTEGER(IntKi), PARAMETER      :: B1FldMzg  = 1444
   INTEGER(IntKi), PARAMETER      :: B2FldFxg  = 1445
   INTEGER(IntKi), PARAMETER      :: B2FldFyg  = 1446
   INTEGER(IntKi), PARAMETER      :: B2FldFzg  = 1447
   INTEGER(IntKi), PARAMETER      :: B2FldMxg  = 1448
   INTEGER(IntKi), PARAMETER      :: B2FldMyg  = 1449
   INTEGER(IntKi), PARAMETER      :: B2FldMzg  = 1450
   INTEGER(IntKi), PARAMETER      :: B3FldFxg  = 1451
   INTEGER(IntKi), PARAMETER      :: B3FldFyg  = 1452
   INTEGER(IntKi), PARAMETER      :: B3FldFzg  = 1453
   INTEGER(IntKi), PARAMETER      :: B3FldMxg  = 1454
   INTEGER(IntKi), PARAMETER      :: B3FldMyg  = 1455
   INTEGER(IntKi), PARAMETER      :: B3FldMzg  = 1456
   INTEGER(IntKi), PARAMETER      :: B4FldFxg  = 1457
   INTEGER(IntKi), PARAMETER      :: B4FldFyg  = 1458
   INTEGER(IntKi), PARAMETER      :: B4FldFzg  = 1459
   INTEGER(IntKi), PARAMETER      :: B4FldMxg  = 1460
   INTEGER(IntKi), PARAMETER      :: B4FldMyg  = 1461
   INTEGER(IntKi), PARAMETER      :: B4FldMzg  = 1462
   ...
   INTEGER(IntKi), PARAMETER      :: RtFldFxg  = 1476
   INTEGER(IntKi), PARAMETER      :: RtFldFyg  = 1477
   INTEGER(IntKi), PARAMETER      :: RtFldFzg  = 1478
   INTEGER(IntKi), PARAMETER      :: RtFldMxg  = 1479
   INTEGER(IntKi), PARAMETER      :: RtFldMyg  = 1480
   INTEGER(IntKi), PARAMETER      :: RtFldMzg  = 1481
   INTEGER(IntKi), PARAMETER      :: RtArea    = 1482
   INTEGER(IntKi), PARAMETER      :: RtFldCp   = 1483
   INTEGER(IntKi), PARAMETER      :: RtFldCq   = 1484
   INTEGER(IntKi), PARAMETER      :: RtFldCt   = 1485
   INTEGER(IntKi), PARAMETER      :: DBEMTau1  = 1486
   ...
   INTEGER(IntKi), PARAMETER      :: MaxOutPts = 1498
...
! ===================================================================================================
  ...
  INTEGER,  PARAMETER           :: BFldFxg(4) = (/B1FldFxg, B2FldFxg, B3FldFxg, B4FldFxg/)                                             ! x-component of total blade root aero/hydro force in global
  INTEGER,  PARAMETER           :: BFldFyg(4) = (/B1FldFyg, B2FldFyg, B3FldFyg, B4FldFyg/)                                             ! y-component of total blade root aero/hydro force in global
  INTEGER,  PARAMETER           :: BFldFzg(4) = (/B1FldFzg, B2FldFzg, B3FldFzg, B4FldFzg/)                                             ! z-component of total blade root aero/hydro force in global
  INTEGER,  PARAMETER           :: BFldMxg(4) = (/B1FldMxg, B2FldMxg, B3FldMxg, B4FldMxg/)                                             ! x-component of total blade root aero/hydro moment wrt hub in global
  INTEGER,  PARAMETER           :: BFldMyg(4) = (/B1FldMyg, B2FldMyg, B3FldMyg, B4FldMyg/)                                             ! y-component of total blade root aero/hydro moment wrt hub in global
  INTEGER,  PARAMETER           :: BFldMzg(4) = (/B1FldMzg, B2FldMzg, B3FldMzg, B4FldMzg/)                                             ! z-component of total blade root aero/hydro moment wrt hub in global
...
!..................................................................................................................................
   ...
   CHARACTER(OutStrLenM1), PARAMETER  :: ValidParamAry(1498) =  (/  &   ! This lists the names of the allowed parameters, which must be sorted alphabetically
                               ...
                               "TWN9VUNDY","TWN9VUNDZ"/)
   INTEGER(IntKi), PARAMETER :: ParamIndxAry(1498) =  (/ &                            ! This lists the index into AllOuts(:) of the allowed parameters ValidParamAry(:)
                                B1Azimuth ,   B1FldFx ,  B1FldFxg ,   B1FldFy ,  B1FldFyg ,   B1FldFz ,  B1FldFzg ,   B1FldMx , &
                                 B1FldMxg ,   B1FldMy ,  B1FldMyg ,   B1FldMz ,  B1FldMzg ,  B1FldPwr , B1N1Alpha , B1N1AxInd , &
                                   B1N1Cd ,    B1N1Cl , B1N1Clrnc ,    B1N1Cm ,    B1N1Cn , B1N1Cpmin ,    B1N1Ct , B1N1Curve , &
                                   B1N1Cx ,    B1N1Cy ,  B1N1DynP ,   B1N1Fbn ,   B1N1Fbs ,   B1N1Fbt ,    B1N1Fd ,    B1N1Fl , &
                                ...
                                TwN5VUndy , TwN5VUndz ,  TwN6DynP ,   TwN6Fbx ,   TwN6Fby ,   TwN6Fbz ,   TwN6Fdx ,   TwN6Fdy , &
                                 ...
                                 TwN9DynP ,   TwN9Fbx ,   TwN9Fby ,   TwN9Fbz ,   TwN9Fdx ,   TwN9Fdy ,     TwN9M ,   TwN9Mbx , &
                                  TwN9Mby ,   TwN9Mbz ,    TwN9Re ,  TwN9STVx ,  TwN9STVy ,  TwN9STVz ,  TwN9Vrel , TwN9VUndx , &
                                TwN9VUndy , TwN9VUndz /)
   CHARACTER(ChanLen), PARAMETER :: ParamUnitsAry(1498) =  (/  &  ! This lists the units corresponding to the allowed parameters
                               "(deg)  ","(N)    ","(N)    ","(N)    ","(N)    ","(N)    ","(N)    ","(N-m)  ", &
