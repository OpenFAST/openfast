...
#ifdef UA_OUTS   
      CALL OpenFOutFile ( UA_OUT_UNIT, 'Debug.UA.out', errStat, errMsg ); IF (ErrStat >= AbortErrLev) RETURN
      WRITE (UA_OUT_UNIT,'(/,A)')  'This output information was generated by FVW'// ' on '//CurDate()//' at '//CurTime()//'.'
