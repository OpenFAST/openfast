...
! This code was generated by "Write_ChckOutLst.m" at 07-Sep-2022 16:16:13.
   ...
   INTEGER(IntKi), PARAMETER      :: BldNd_BEM_Cx_qs  = 126
   INTEGER(IntKi), PARAMETER      :: BldNd_BEM_Cy_qs  = 127
   INTEGER(IntKi), PARAMETER      :: BldNd_BEM_CT_qs  = 128
   INTEGER(IntKi), PARAMETER      :: BldNd_BEM_phi_qs = 129
   INTEGER(IntKi), PARAMETER      :: BldNd_Cl_qs      = 130
   INTEGER(IntKi), PARAMETER      :: BldNd_Cd_qs      = 131
   INTEGER(IntKi), PARAMETER      :: BldNd_Cm_qs      = 132
   INTEGER(IntKi), PARAMETER      :: BldNd_Fbxi       = 133
   INTEGER(IntKi), PARAMETER      :: BldNd_Fbyi       = 134
   INTEGER(IntKi), PARAMETER      :: BldNd_Fbzi       = 135
   INTEGER(IntKi), PARAMETER      :: BldNd_Mbxi       = 136
   INTEGER(IntKi), PARAMETER      :: BldNd_Mbyi       = 137
   INTEGER(IntKi), PARAMETER      :: BldNd_Mbzi       = 138
   INTEGER(IntKi), PARAMETER      :: BldNd_Fbxp       = 139
   INTEGER(IntKi), PARAMETER      :: BldNd_Fbyp       = 140
   INTEGER(IntKi), PARAMETER      :: BldNd_Fbzp       = 141
   INTEGER(IntKi), PARAMETER      :: BldNd_Mbxp       = 142
   INTEGER(IntKi), PARAMETER      :: BldNd_Mbyp       = 143
   INTEGER(IntKi), PARAMETER      :: BldNd_Mbzp       = 144
   INTEGER(IntKi), PARAMETER      :: BldNd_Fbxl       = 145
   INTEGER(IntKi), PARAMETER      :: BldNd_Fbyl       = 146
   INTEGER(IntKi), PARAMETER      :: BldNd_Fbzl       = 147
   INTEGER(IntKi), PARAMETER      :: BldNd_Mbxl       = 148
   INTEGER(IntKi), PARAMETER      :: BldNd_Mbyl       = 149
   INTEGER(IntKi), PARAMETER      :: BldNd_Mbzl       = 150
   INTEGER(IntKi), PARAMETER      :: BldNd_Fbxa       = 151
   INTEGER(IntKi), PARAMETER      :: BldNd_Fbya       = 152
   INTEGER(IntKi), PARAMETER      :: BldNd_Fbza       = 153
   INTEGER(IntKi), PARAMETER      :: BldNd_Mbxa       = 154
   INTEGER(IntKi), PARAMETER      :: BldNd_Mbya       = 155
   INTEGER(IntKi), PARAMETER      :: BldNd_Mbza       = 156


     ! The maximum number of output channels which can be output by the code.
   INTEGER(IntKi), PARAMETER, PUBLIC  :: BldNd_MaxOutPts        = 156
...
!NOT available in BEMT/DBEMT yet
         ...
         CASE(BldNd_BEM_Cx_qs ); do iB=1,nB; do iNdL=1,nNd; iNd=Nd(iNdL); y%WriteOutput(iOut)  = m%BEMT_y%Cx_qs(iNd,iB); iOut = iOut + 1; enddo;enddo
         CASE(BldNd_BEM_Cy_qs ); do iB=1,nB; do iNdL=1,nNd; iNd=Nd(iNdL); y%WriteOutput(iOut)  = m%BEMT_y%Cy_qs(iNd,iB); iOut = iOut + 1; enddo;enddo
         CASE(BldNd_BEM_Phi_qs); do iB=1,nB; do iNdL=1,nNd; iNd=Nd(iNdL); y%WriteOutput(iOut)  = m%BEMT_y%phi_qs(iNd,iB)*R2D; iOut = iOut + 1; enddo;enddo
...
!..................................................................................................................................
   ...
   CHARACTER(OutStrLenM1), PARAMETER  :: ValidParamAry(169) =  (/  &   ! This lists the names of the allowed parameters, which must be sorted alphabetically
                               "ALPHA     ","AXIND     ","AXIND_QS  ","BEM_CT_QS ","BEM_CX_QS ","BEM_CY_QS ","BEM_F_QS  ", &
                               "BEM_KP_QS ","BEM_K_QS  ","BEM_PHI_QS","CD        ","CD_QS     ","CHI       ","CL        ", &
                               "CLRNC     ","CL_QS     ","CM        ","CMA       ","CM_QS     ","CN        ","CPMIN     ", &
                               "CT        ","CURVE     ","CX        ","CXA       ","CY        ","DEBUG1    ","DEBUG2    ", &
                               "DEBUG3    ","DYNP      ","FBN       ","FBS       ","FBT       ","FBXA      ","FBXI      ", &
                               "FBXL      ","FBXP      ","FBYA      ","FBYI      ","FBYL      ","FBYP      ","FBZA      ", &
                               "FBZI      ","FBZL      ","FBZP      ","FD        ","FL        ","FN        ","FT        ", &
                               "FX        ","FXA       ","FXI       ","FXL       ","FXP       ","FY        ","FYI       ", &
                               "FYL       ","FYP       ","FZI       ","FZL       ","FZP       ","GAM       ","GEOMPHI   ", &
                               "M         ","MBN       ","MBS       ","MBT       ","MBXA      ","MBXI      ","MBXL      ", &
                               "MBXP      ","MBYA      ","MBYI      ","MBYL      ","MBYP      ","MBZA      ","MBZI      ", &
                               "MBZL      ","MBZP      ","MM        ","MXI       ","MXL       ","MXP       ","MYI       ", &
                               "MYL       ","MYP       ","MZA       ","MZI       ","MZL       ","MZP       ","PHI       ", &
                               "RE        ","SGCAV     ","SIGCR     ","STVX      ","STVXA     ","STVXI     ","STVXL     ", &
                               "STVXP     ","STVY      ","STVYA     ","STVYI     ","STVYL     ","STVYP     ","STVZ      ", &
                               "STVZA     ","STVZI     ","STVZL     ","STVZP     ","THETA     ","TNIND     ","TNIND_QS  ", &
                               "TOE       ","UA_FLAG   ","UA_X1     ","UA_X2     ","UA_X3     ","UA_X4     ","UA_X5     ", &
                               "UIN       ","UIR       ","UIT       ","VDISX     ","VDISXA    ","VDISXI    ","VDISXL    ", &
                               "VDISXP    ","VDISY     ","VDISYA    ","VDISYI    ","VDISYL    ","VDISYP    ","VDISZ     ", &
                               "VDISZA    ","VDISZI    ","VDISZL    ","VDISZP    ","VINDX     ","VINDXA    ","VINDXI    ", &
                               "VINDXL    ","VINDXP    ","VINDY     ","VINDYA    ","VINDYI    ","VINDYL    ","VINDYP    ", &
                               "VINDZA    ","VINDZI    ","VINDZL    ","VINDZP    ","VREL      ","VUNDX     ","VUNDXA    ", &
                               "VUNDXI    ","VUNDXL    ","VUNDXP    ","VUNDY     ","VUNDYA    ","VUNDYI    ","VUNDYL    ", &
                               "VUNDYP    ","VUNDZ     ","VUNDZA    ","VUNDZI    ","VUNDZL    ","VUNDZP    ","VX        ", &
                               "VY        "/)
   INTEGER(IntKi), PARAMETER :: ParamIndxAry(169) =  (/ &                            ! This lists the index into AllOuts(:) of the allowed parameters ValidParamAry(:)
                                     BldNd_Alpha ,      BldNd_AxInd ,   BldNd_AxInd_qs ,  BldNd_BEM_CT_qs ,  BldNd_BEM_Cx_qs ,  BldNd_BEM_Cy_qs ,   BldNd_BEM_F_qs , &
                                 BldNd_BEM_kp_qs ,   BldNd_BEM_k_qs , BldNd_BEM_phi_qs ,         BldNd_Cd ,      BldNd_Cd_qs ,        BldNd_Chi ,         BldNd_Cl , &
                                     BldNd_Clrnc ,      BldNd_Cl_qs ,         BldNd_Cm ,         BldNd_Cm ,      BldNd_Cm_qs ,         BldNd_Cn ,      BldNd_CpMin , &
                                        BldNd_Ct ,      BldNd_Curve ,         BldNd_Cx ,         BldNd_Cn ,         BldNd_Cy ,     BldNd_Debug1 ,     BldNd_Debug2 , &
                                    BldNd_Debug3 ,       BldNd_DynP ,       BldNd_Fbxa ,       BldNd_Fbza ,       BldNd_Fbya ,       BldNd_Fbxa ,       BldNd_Fbxi , &
                                      BldNd_Fbxl ,       BldNd_Fbxp ,       BldNd_Fbya ,       BldNd_Fbyi ,       BldNd_Fbyl ,       BldNd_Fbyp ,       BldNd_Fbza , &
                                      BldNd_Fbzi ,       BldNd_Fbzl ,       BldNd_Fbzp ,         BldNd_Fd ,         BldNd_Fl ,         BldNd_Fn ,         BldNd_Ft , &
                                        BldNd_Fx ,         BldNd_Fn ,        BldNd_Fxi ,        BldNd_Fxl ,        BldNd_Fxp ,         BldNd_Fy ,        BldNd_Fyi , &
                                       BldNd_Fyl ,        BldNd_Fyp ,        BldNd_Fzi ,        BldNd_Fzl ,        BldNd_Fzp ,        BldNd_Gam ,    BldNd_GeomPhi , &
                                         BldNd_M ,       BldNd_Mbxa ,       BldNd_Mbza ,       BldNd_Mbya ,       BldNd_Mbxa ,       BldNd_Mbxi ,       BldNd_Mbxl , &
                                      BldNd_Mbxp ,       BldNd_Mbya ,       BldNd_Mbyi ,       BldNd_Mbyl ,       BldNd_Mbyp ,       BldNd_Mbza ,       BldNd_Mbzi , &
                                      BldNd_Mbzl ,       BldNd_Mbzp ,         BldNd_Mm ,        BldNd_Mxi ,        BldNd_Mxl ,        BldNd_Mxp ,        BldNd_Myi , &
                                       BldNd_Myl ,        BldNd_Myp ,         BldNd_Mm ,        BldNd_Mzi ,        BldNd_Mzl ,        BldNd_Mzp ,        BldNd_Phi , &
                                        BldNd_Re ,      BldNd_SgCav ,      BldNd_SigCr ,       BldNd_STVx ,      BldNd_STVxa ,      BldNd_STVxi ,      BldNd_STVxl , &
                                     BldNd_STVxp ,       BldNd_STVy ,      BldNd_STVya ,      BldNd_STVyi ,      BldNd_STVyl ,      BldNd_STVyp ,       BldNd_STVz , &
                                     BldNd_STVza ,      BldNd_STVzi ,      BldNd_STVzl ,      BldNd_STVzp ,      BldNd_Theta ,      BldNd_TnInd ,   BldNd_TnInd_qs , &
                                       BldNd_Toe ,    BldNd_UA_Flag ,      BldNd_UA_x1 ,      BldNd_UA_x2 ,      BldNd_UA_x3 ,      BldNd_UA_x4 ,      BldNd_UA_x5 , &
                                    BldNd_Vindxp ,     BldNd_Vindzp ,     BldNd_Vindyp ,      BldNd_VDisx ,     BldNd_VDisxa ,     BldNd_VDisxi ,     BldNd_VDisxl , &
                                    BldNd_VDisxp ,      BldNd_VDisy ,     BldNd_VDisya ,     BldNd_VDisyi ,     BldNd_VDisyl ,     BldNd_VDisyp ,      BldNd_VDisz , &
                                    BldNd_VDisza ,     BldNd_VDiszi ,     BldNd_VDiszl ,     BldNd_VDiszp ,      BldNd_Vindx ,     BldNd_Vindxa ,     BldNd_Vindxi , &
                                    BldNd_Vindxl ,     BldNd_Vindxp ,      BldNd_Vindy ,     BldNd_Vindya ,     BldNd_Vindyi ,     BldNd_Vindyl ,     BldNd_Vindyp , &
                                    BldNd_Vindza ,     BldNd_Vindzi ,     BldNd_Vindzl ,     BldNd_Vindzp ,       BldNd_VRel ,      BldNd_VUndx ,     BldNd_VUndxa , &
                                    BldNd_VUndxi ,     BldNd_VUndxl ,     BldNd_VUndxp ,      BldNd_VUndy ,     BldNd_VUndya ,     BldNd_VUndyi ,     BldNd_VUndyl , &
                                    BldNd_VUndyp ,      BldNd_VUndz ,     BldNd_VUndza ,     BldNd_VUndzi ,     BldNd_VUndzl ,     BldNd_VUndzp ,         BldNd_Vx , &
                                        BldNd_Vy /)
   CHARACTER(ChanLen), PARAMETER :: ParamUnitsAry(169) =  (/ character(ChanLen) :: &  ! This lists the units corresponding to the allowed parameters
                               "(deg)  ","(-)    ","(-)    ","(-)    ","(-)    ","(-)    ","(-)    ", &
                               "(-)    ","(-)    ","(deg)  ","(-)    ","(-)    ","(deg)  ","(-)    ", &
                               "(m)    ","(-)    ","(-)    ","(-)    ","(-)    ","(-)    ","(-)    ", &
                               "(-)    ","(deg)  ","(-)    ","(-)    ","(-)    ","(-)    ","(-)    ", &
                               ...
                               "(N-m/m)","(N-m/m)","(N-m/m)","(N-m/m)","(N-m/m)","(N-m/m)","(N-m/m)", &
                               "(N-m/m)","(N-m/m)","(N-m/m)","(N-m/m)","(N-m/m)","(N-m/m)","(deg)  ", &
                               "(-)    ","(-)    ","(-)    ","(m/s)  ","(m/s)  ","(m/s)  ","(m/s)  ", &
...
!   ..... Developer must add checking for invalid inputs here: .....
   ...
   if (p_AD%Wake_Mod /= WakeMod_BEMT) then
      ...
      InvalidOutput( BldNd_BEM_Cx_qs ) = .true.
      InvalidOutput( BldNd_BEM_Cy_qs ) = .true.
      InvalidOutput( BldNd_BEM_phi_qs) = .true.
   endif
