...
! This code was generated by Write_ChckOutLst.m at 12-Dec-2017 22:02:25.
   ...
   INTEGER(IntKi), PARAMETER, PUBLIC  :: BldNd_MaxOutPts     = 45
...
!! 
!! This routine was generated by Write_ChckOutLst.m using the parameters listed in OutListParameters.xlsx at 30-Jun-2020 16:56:12.
...
!..................................................................................................................................
   ...
   CHARACTER(OutStrLenM1), PARAMETER  :: ValidParamAry(45) =  (/  &   ! This lists the names of the allowed parameters, which must be sorted alphabetically
                               "ALPHA  ","AXIND  ","CD     ","CHI    ","CL     ","CLRNC  ","CM     ","CN     ","CPMIN  ","CT     ", &
                               "CURVE  ","CX     ","CY     ","DYNP   ","FD     ","FL     ","FN     ","FT     ","FX     ","FY     ", &
                               "GAM    ","GEOMPHI","M      ","MM     ","PHI    ","RE     ","SGCAV  ","SIGCR  ","STVX   ","STVY   ", &
                               "STVZ   ","THETA  ","TNIND  ","UA_FLAG","VDISX  ","VDISY  ","VDISZ  ","VINDX  ","VINDY  ","VREL   ", &
                               "VUNDX  ","VUNDY  ","VUNDZ  ","VX     ","VY     "/)
   INTEGER(IntKi), PARAMETER :: ParamIndxAry(45) =  (/ &                            ! This lists the index into AllOuts(:) of the allowed parameters ValidParamAry(:)
                                  BldNd_Alpha ,   BldNd_AxInd ,      BldNd_Cd ,     BldNd_Chi ,      BldNd_Cl ,   BldNd_Clrnc ,      BldNd_Cm ,      BldNd_Cn ,   BldNd_CpMin ,      BldNd_Ct , &
                                  BldNd_Curve ,      BldNd_Cx ,      BldNd_Cy ,    BldNd_DynP ,      BldNd_Fd ,      BldNd_Fl ,      BldNd_Fn ,      BldNd_Ft ,      BldNd_Fx ,      BldNd_Fy , &
                                    BldNd_Gam , BldNd_GeomPhi ,       BldNd_M ,      BldNd_Mm ,     BldNd_Phi ,      BldNd_Re ,   BldNd_SgCav ,   BldNd_SigCr ,    BldNd_STVx ,    BldNd_STVy , &
                                   BldNd_STVz ,   BldNd_Theta ,   BldNd_TnInd , BldNd_UA_Flag ,   BldNd_VDisx ,   BldNd_VDisy ,   BldNd_VDisz ,   BldNd_Vindx ,   BldNd_Vindy ,    BldNd_VRel , &
                                  BldNd_VUndx ,   BldNd_VUndy ,   BldNd_VUndz ,      BldNd_Vx ,      BldNd_Vy /)
   CHARACTER(ChanLen), PARAMETER :: ParamUnitsAry(45) =  (/  &  ! This lists the units corresponding to the allowed parameters
                               "(deg)  ","(-)    ","(-)    ","(deg)  ","(-)    ","(m)    ","(-)    ","(-)    ","(-)    ","(-)    ", &
                               "(deg)  ","(-)    ","(-)    ","(Pa)   ","(N/m)  ","(N/m)  ","(N/m)  ","(N/m)  ","(N/m)  ","(N/m)  ", &
                               "(m^2/s)","(1/0)  ","(-)    ","(N-m/m)","(deg)  ","(-)    ","(-)    ","(-)    ","(m/s)  ","(m/s)  ", &
                               "(m/s)  ","(deg)  ","(-)    ","(-)    ","(m/s)  ","(m/s)  ","(m/s)  ","(m/s)  ","(m/s)  ","(m/s)  ", &
                               "(m/s)  ","(m/s)  ","(m/s)  ","(m/s)  ","(m/s)  "/)
