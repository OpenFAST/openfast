   ...
   newFoundMask    = .FALSE.
    ...
    DO I = 1,NUserOutputs
      IF (.NOT. foundMask(I) ) THEN
         Indx = FindValidChannelIndx(UserOutputs(I))
...
!====================================================================================================
INTEGER FUNCTION FindValidChannelIndx(OutListVal, SignM_out) RESULT( Indx )
...
!   p%OutParam(0)%SignM = 1
   ...
   DO I = 1,p%NumOuts
      ...
      Indx = FindValidChannelIndx(OutList(I), p%OutParam(I)%SignM)
