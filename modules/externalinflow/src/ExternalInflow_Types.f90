...
! =========  ExtInfw_ParameterType_C  =======
  ...
  TYPE, PUBLIC :: ExtInfw_ParameterType
    ...
    INTEGER(IntKi)  :: NnodesVel      !< number of velocity nodes on FAST v8-ExternalInflow interface [-]
    INTEGER(IntKi)  :: NnodesForce      !< number of force nodes on FAST v8-ExternalInflow interface [-]
    INTEGER(IntKi)  :: NnodesForceBlade      !< number of force nodes on FAST v8-ExternalInflow interface [-]
    INTEGER(IntKi)  :: NnodesForceTower      !< number of force nodes on FAST v8-ExternalInflow interface [-]
