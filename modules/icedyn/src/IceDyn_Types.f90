...
! =======================
   ...
   integer(IntKi), public, parameter :: IceD_u_PointMesh                 =   3 ! IceD%PointMesh
   integer(IntKi), public, parameter :: IceD_y_PointMesh                 =   4 ! IceD%PointMesh
   integer(IntKi), public, parameter :: IceD_y_WriteOutput               =   5 ! IceD%WriteOutput
