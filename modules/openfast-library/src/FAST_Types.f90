...
! =======================
! =========  ML_MiscVarType  =======
  TYPE, PUBLIC :: ML_MiscVarType
    TYPE(TC_MappingType) , DIMENSION(:), ALLOCATABLE  :: Mappings      !< Module mesh mapping [-]
  END TYPE ML_MiscVarType
! =======================
! =========  ML_OutputType  =======
  TYPE, PUBLIC :: ML_OutputType
    TYPE(ModLinTCType) , DIMENSION(:), ALLOCATABLE  :: Lin      !< Module linearization type [-]
  END TYPE ML_OutputType
! =======================
! =========  TC_MiscVarType  =======
  TYPE, PUBLIC :: TC_MiscVarType
    ...
    REAL(R8Ki) , DIMENSION(:,:), ALLOCATABLE  :: dUdu      !<  [-]
    REAL(R8Ki) , DIMENSION(:,:), ALLOCATABLE  :: dUdy      !<  [-]
    REAL(R8Ki) , DIMENSION(:,:), ALLOCATABLE  :: GinvdUdu      !<  [-]
...
! =========  FAST_ParameterType  =======
  TYPE, PUBLIC :: FAST_ParameterType
    ...
    TYPE(ML_ParameterType)  :: ModLin      !< Module data based linearization [-]
...
! =========  FAST_OutputFileType  =======
  TYPE, PUBLIC :: FAST_OutputFileType
    ...
    TYPE(ModDataType)  :: ModGlue      !< module variable and value data [-]
...
! =========  AeroDyn14_Data  =======
  TYPE, PUBLIC :: AeroDyn14_Data
    TYPE(AD14_ContinuousStateType) , DIMENSION(1:NumStateTimes)  :: x      !< Continuous states [-]
    TYPE(AD14_DiscreteStateType) , DIMENSION(1:NumStateTimes)  :: xd      !< Discrete states [-]
    TYPE(AD14_ConstraintStateType) , DIMENSION(1:NumStateTimes)  :: z      !< Constraint states [-]
    TYPE(AD14_OtherStateType) , DIMENSION(1:NumStateTimes)  :: OtherSt      !< Other states [-]
...
! =========  FAST_MiscVarType  =======
  TYPE, PUBLIC :: FAST_MiscVarType
    ...
    TYPE(ML_MiscVarType)  :: ModLin      !< Module linearization Miscellaneous variables [-]
...
subroutine FAST_CopyTC_MappingType(SrcTC_MappingTypeData, DstTC_MappingTypeData, CtrlCode, ErrStat, ErrMsg)
   ...
   call SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
   if (ErrStat >= AbortErrLev) return
   call NWTC_Library_CopyMeshLocType(SrcTC_MappingTypeData%DstMeshLoc, DstTC_MappingTypeData%DstMeshLoc, CtrlCode, ErrStat2, ErrMsg2)
   call SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
   if (ErrStat >= AbortErrLev) return
   call NWTC_Library_CopyMeshLocType(SrcTC_MappingTypeData%SrcDispMeshLoc, DstTC_MappingTypeData%SrcDispMeshLoc, CtrlCode, ErrStat2, ErrMsg2)
   call SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
   if (ErrStat >= AbortErrLev) return
   call NWTC_Library_CopyMeshLocType(SrcTC_MappingTypeData%DstDispMeshLoc, DstTC_MappingTypeData%DstDispMeshLoc, CtrlCode, ErrStat2, ErrMsg2)
   call SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
   if (ErrStat >= AbortErrLev) return
...
subroutine FAST_DestroyTC_MappingType(TC_MappingTypeData, ErrStat, ErrMsg)
   ...
   ErrStat = ErrID_None
   ErrMsg  = ''
   call NWTC_Library_DestroyMeshLocType(TC_MappingTypeData%SrcMeshLoc, ErrStat2, ErrMsg2)
   call SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
   call NWTC_Library_DestroyMeshLocType(TC_MappingTypeData%DstMeshLoc, ErrStat2, ErrMsg2)
   call SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
   call NWTC_Library_DestroyMeshLocType(TC_MappingTypeData%SrcDispMeshLoc, ErrStat2, ErrMsg2)
   call SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
...
subroutine FAST_PackTC_MappingType(RF, Indata)
   type(RegFile), intent(inout) :: RF
...
subroutine FAST_UnPackTC_MappingType(RF, OutData)
   type(RegFile), intent(inout)    :: RF
...
subroutine FAST_CopyTC_ParameterType(SrcTC_ParameterTypeData, DstTC_ParameterTypeData, CtrlCode, ErrStat, ErrMsg)
   ...
   DstTC_ParameterTypeData%iX1 = SrcTC_ParameterTypeData%iX1
   DstTC_ParameterTypeData%iX2 = SrcTC_ParameterTypeData%iX2
   DstTC_ParameterTypeData%iUT = SrcTC_ParameterTypeData%iUT
   DstTC_ParameterTypeData%iU1 = SrcTC_ParameterTypeData%iU1
   DstTC_ParameterTypeData%iyT = SrcTC_ParameterTypeData%iyT
   DstTC_ParameterTypeData%iy1 = SrcTC_ParameterTypeData%iy1
   DstTC_ParameterTypeData%iJX = SrcTC_ParameterTypeData%iJX
   DstTC_ParameterTypeData%iJU = SrcTC_ParameterTypeData%iJU
   DstTC_ParameterTypeData%iJUT = SrcTC_ParameterTypeData%iJUT
   if (allocated(SrcTC_ParameterTypeData%iJL)) then
      LB(1:1) = lbound(SrcTC_ParameterTypeData%iJL, kind=B8Ki)
      UB(1:1) = ubound(SrcTC_ParameterTypeData%iJL, kind=B8Ki)
   ...
   if (allocated(SrcTC_ParameterTypeData%ixqd)) then
      LB(1:2) = lbound(SrcTC_ParameterTypeData%ixqd, kind=B8Ki)
      UB(1:2) = ubound(SrcTC_ParameterTypeData%ixqd, kind=B8Ki)
   ...
   if (allocated(SrcTC_ParameterTypeData%iModInit)) then
      LB(1:1) = lbound(SrcTC_ParameterTypeData%iModInit, kind=B8Ki)
      UB(1:1) = ubound(SrcTC_ParameterTypeData%iModInit, kind=B8Ki)
   ...
   if (allocated(SrcTC_ParameterTypeData%iModTC)) then
      LB(1:1) = lbound(SrcTC_ParameterTypeData%iModTC, kind=B8Ki)
      UB(1:1) = ubound(SrcTC_ParameterTypeData%iModTC, kind=B8Ki)
   ...
   if (allocated(SrcTC_ParameterTypeData%iModBD)) then
      LB(1:1) = lbound(SrcTC_ParameterTypeData%iModBD, kind=B8Ki)
      UB(1:1) = ubound(SrcTC_ParameterTypeData%iModBD, kind=B8Ki)
      if (.not. allocated(DstTC_ParameterTypeData%iModBD)) then
         allocate(DstTC_ParameterTypeData%iModBD(LB(1):UB(1)), stat=ErrStat2)
         if (ErrStat2 /= 0) then
            call SetErrStat(ErrID_Fatal, 'Error allocating DstTC_ParameterTypeData%iModBD.', ErrStat, ErrMsg, RoutineName)
            return
         end if
      end if
      DstTC_ParameterTypeData%iModBD = SrcTC_ParameterTypeData%iModBD
   end if
   if (allocated(SrcTC_ParameterTypeData%iModOpt1)) then
      LB(1:1) = lbound(SrcTC_ParameterTypeData%iModOpt1, kind=B8Ki)
      UB(1:1) = ubound(SrcTC_ParameterTypeData%iModOpt1, kind=B8Ki)
   ...
   if (allocated(SrcTC_ParameterTypeData%iModOpt1US)) then
      LB(1:1) = lbound(SrcTC_ParameterTypeData%iModOpt1US, kind=B8Ki)
      UB(1:1) = ubound(SrcTC_ParameterTypeData%iModOpt1US, kind=B8Ki)
   ...
   if (allocated(SrcTC_ParameterTypeData%iModOpt2)) then
      LB(1:1) = lbound(SrcTC_ParameterTypeData%iModOpt2, kind=B8Ki)
      UB(1:1) = ubound(SrcTC_ParameterTypeData%iModOpt2, kind=B8Ki)
   ...
   if (allocated(SrcTC_ParameterTypeData%iModPost)) then
      LB(1:1) = lbound(SrcTC_ParameterTypeData%iModPost, kind=B8Ki)
      UB(1:1) = ubound(SrcTC_ParameterTypeData%iModPost, kind=B8Ki)
...
subroutine FAST_DestroyTC_ParameterType(TC_ParameterTypeData, ErrStat, ErrMsg)
   ...
   if (allocated(TC_ParameterTypeData%iModBD)) then
      deallocate(TC_ParameterTypeData%iModBD)
   end if
...
subroutine FAST_PackTC_ParameterType(RF, Indata)
   type(RegFile), intent(inout) :: RF
...
subroutine FAST_UnPackTC_ParameterType(RF, OutData)
   type(RegFile), intent(inout)    :: RF
...
subroutine FAST_CopyModLinTCType(SrcModLinTCTypeData, DstModLinTCTypeData, CtrlCode, ErrStat, ErrMsg)
   type(ModLinTCType), intent(in) :: SrcModLinTCTypeData
   type(ModLinTCType), intent(inout) :: DstModLinTCTypeData
   integer(IntKi),  intent(in   ) :: CtrlCode
   integer(IntKi),  intent(  out) :: ErrStat
   character(*),    intent(  out) :: ErrMsg
   integer(B8Ki)                  :: LB(2), UB(2)
   integer(IntKi)                 :: ErrStat2
   character(*), parameter        :: RoutineName = 'FAST_CopyModLinTCType'
   ErrStat = ErrID_None
   ErrMsg  = ''
   if (allocated(SrcModLinTCTypeData%x)) then
      LB(1:1) = lbound(SrcModLinTCTypeData%x, kind=B8Ki)
      UB(1:1) = ubound(SrcModLinTCTypeData%x, kind=B8Ki)
      if (.not. allocated(DstModLinTCTypeData%x)) then
         allocate(DstModLinTCTypeData%x(LB(1):UB(1)), stat=ErrStat2)
         if (ErrStat2 /= 0) then
            call SetErrStat(ErrID_Fatal, 'Error allocating DstModLinTCTypeData%x.', ErrStat, ErrMsg, RoutineName)
            return
         end if
      end if
      DstModLinTCTypeData%x = SrcModLinTCTypeData%x
   end if
   if (allocated(SrcModLinTCTypeData%dx)) then
      LB(1:1) = lbound(SrcModLinTCTypeData%dx, kind=B8Ki)
      UB(1:1) = ubound(SrcModLinTCTypeData%dx, kind=B8Ki)
      if (.not. allocated(DstModLinTCTypeData%dx)) then
         allocate(DstModLinTCTypeData%dx(LB(1):UB(1)), stat=ErrStat2)
         if (ErrStat2 /= 0) then
            call SetErrStat(ErrID_Fatal, 'Error allocating DstModLinTCTypeData%dx.', ErrStat, ErrMsg, RoutineName)
            return
         end if
      end if
      DstModLinTCTypeData%dx = SrcModLinTCTypeData%dx
   end if
   if (allocated(SrcModLinTCTypeData%xd)) then
      LB(1:1) = lbound(SrcModLinTCTypeData%xd, kind=B8Ki)
      UB(1:1) = ubound(SrcModLinTCTypeData%xd, kind=B8Ki)
      if (.not. allocated(DstModLinTCTypeData%xd)) then
         allocate(DstModLinTCTypeData%xd(LB(1):UB(1)), stat=ErrStat2)
         if (ErrStat2 /= 0) then
            call SetErrStat(ErrID_Fatal, 'Error allocating DstModLinTCTypeData%xd.', ErrStat, ErrMsg, RoutineName)
            return
         end if
      end if
      DstModLinTCTypeData%xd = SrcModLinTCTypeData%xd
   end if
   if (allocated(SrcModLinTCTypeData%z)) then
      LB(1:1) = lbound(SrcModLinTCTypeData%z, kind=B8Ki)
      UB(1:1) = ubound(SrcModLinTCTypeData%z, kind=B8Ki)
      if (.not. allocated(DstModLinTCTypeData%z)) then
         allocate(DstModLinTCTypeData%z(LB(1):UB(1)), stat=ErrStat2)
         if (ErrStat2 /= 0) then
            call SetErrStat(ErrID_Fatal, 'Error allocating DstModLinTCTypeData%z.', ErrStat, ErrMsg, RoutineName)
            return
         end if
      end if
      DstModLinTCTypeData%z = SrcModLinTCTypeData%z
   end if
   if (allocated(SrcModLinTCTypeData%u)) then
      LB(1:1) = lbound(SrcModLinTCTypeData%u, kind=B8Ki)
      UB(1:1) = ubound(SrcModLinTCTypeData%u, kind=B8Ki)
      if (.not. allocated(DstModLinTCTypeData%u)) then
         allocate(DstModLinTCTypeData%u(LB(1):UB(1)), stat=ErrStat2)
         if (ErrStat2 /= 0) then
            call SetErrStat(ErrID_Fatal, 'Error allocating DstModLinTCTypeData%u.', ErrStat, ErrMsg, RoutineName)
            return
         end if
      end if
      DstModLinTCTypeData%u = SrcModLinTCTypeData%u
   end if
   if (allocated(SrcModLinTCTypeData%y)) then
      LB(1:1) = lbound(SrcModLinTCTypeData%y, kind=B8Ki)
      UB(1:1) = ubound(SrcModLinTCTypeData%y, kind=B8Ki)
      if (.not. allocated(DstModLinTCTypeData%y)) then
         allocate(DstModLinTCTypeData%y(LB(1):UB(1)), stat=ErrStat2)
         if (ErrStat2 /= 0) then
            call SetErrStat(ErrID_Fatal, 'Error allocating DstModLinTCTypeData%y.', ErrStat, ErrMsg, RoutineName)
            return
         end if
      end if
      DstModLinTCTypeData%y = SrcModLinTCTypeData%y
   end if
   if (allocated(SrcModLinTCTypeData%u_perturb)) then
      LB(1:1) = lbound(SrcModLinTCTypeData%u_perturb, kind=B8Ki)
      UB(1:1) = ubound(SrcModLinTCTypeData%u_perturb, kind=B8Ki)
      if (.not. allocated(DstModLinTCTypeData%u_perturb)) then
         allocate(DstModLinTCTypeData%u_perturb(LB(1):UB(1)), stat=ErrStat2)
         if (ErrStat2 /= 0) then
            call SetErrStat(ErrID_Fatal, 'Error allocating DstModLinTCTypeData%u_perturb.', ErrStat, ErrMsg, RoutineName)
            return
         end if
      end if
      DstModLinTCTypeData%u_perturb = SrcModLinTCTypeData%u_perturb
   end if
   if (allocated(SrcModLinTCTypeData%x_perturb)) then
      LB(1:1) = lbound(SrcModLinTCTypeData%x_perturb, kind=B8Ki)
      UB(1:1) = ubound(SrcModLinTCTypeData%x_perturb, kind=B8Ki)
      if (.not. allocated(DstModLinTCTypeData%x_perturb)) then
         allocate(DstModLinTCTypeData%x_perturb(LB(1):UB(1)), stat=ErrStat2)
         if (ErrStat2 /= 0) then
            call SetErrStat(ErrID_Fatal, 'Error allocating DstModLinTCTypeData%x_perturb.', ErrStat, ErrMsg, RoutineName)
            return
         end if
      end if
      DstModLinTCTypeData%x_perturb = SrcModLinTCTypeData%x_perturb
   end if
   if (allocated(SrcModLinTCTypeData%x_pos)) then
      LB(1:1) = lbound(SrcModLinTCTypeData%x_pos, kind=B8Ki)
      UB(1:1) = ubound(SrcModLinTCTypeData%x_pos, kind=B8Ki)
      if (.not. allocated(DstModLinTCTypeData%x_pos)) then
         allocate(DstModLinTCTypeData%x_pos(LB(1):UB(1)), stat=ErrStat2)
         if (ErrStat2 /= 0) then
            call SetErrStat(ErrID_Fatal, 'Error allocating DstModLinTCTypeData%x_pos.', ErrStat, ErrMsg, RoutineName)
            return
         end if
      end if
      DstModLinTCTypeData%x_pos = SrcModLinTCTypeData%x_pos
   end if
   if (allocated(SrcModLinTCTypeData%x_neg)) then
      LB(1:1) = lbound(SrcModLinTCTypeData%x_neg, kind=B8Ki)
      UB(1:1) = ubound(SrcModLinTCTypeData%x_neg, kind=B8Ki)
      if (.not. allocated(DstModLinTCTypeData%x_neg)) then
         allocate(DstModLinTCTypeData%x_neg(LB(1):UB(1)), stat=ErrStat2)
         if (ErrStat2 /= 0) then
            call SetErrStat(ErrID_Fatal, 'Error allocating DstModLinTCTypeData%x_neg.', ErrStat, ErrMsg, RoutineName)
            return
         end if
      end if
      DstModLinTCTypeData%x_neg = SrcModLinTCTypeData%x_neg
   end if
   if (allocated(SrcModLinTCTypeData%y_pos)) then
      LB(1:1) = lbound(SrcModLinTCTypeData%y_pos, kind=B8Ki)
      UB(1:1) = ubound(SrcModLinTCTypeData%y_pos, kind=B8Ki)
      if (.not. allocated(DstModLinTCTypeData%y_pos)) then
         allocate(DstModLinTCTypeData%y_pos(LB(1):UB(1)), stat=ErrStat2)
         if (ErrStat2 /= 0) then
            call SetErrStat(ErrID_Fatal, 'Error allocating DstModLinTCTypeData%y_pos.', ErrStat, ErrMsg, RoutineName)
            return
         end if
      end if
      DstModLinTCTypeData%y_pos = SrcModLinTCTypeData%y_pos
   end if
   if (allocated(SrcModLinTCTypeData%y_neg)) then
      LB(1:1) = lbound(SrcModLinTCTypeData%y_neg, kind=B8Ki)
      UB(1:1) = ubound(SrcModLinTCTypeData%y_neg, kind=B8Ki)
      if (.not. allocated(DstModLinTCTypeData%y_neg)) then
         allocate(DstModLinTCTypeData%y_neg(LB(1):UB(1)), stat=ErrStat2)
         if (ErrStat2 /= 0) then
            call SetErrStat(ErrID_Fatal, 'Error allocating DstModLinTCTypeData%y_neg.', ErrStat, ErrMsg, RoutineName)
            return
         end if
      end if
      DstModLinTCTypeData%y_neg = SrcModLinTCTypeData%y_neg
   end if
   if (allocated(SrcModLinTCTypeData%dYdx)) then
      LB(1:2) = lbound(SrcModLinTCTypeData%dYdx, kind=B8Ki)
      UB(1:2) = ubound(SrcModLinTCTypeData%dYdx, kind=B8Ki)
      if (.not. allocated(DstModLinTCTypeData%dYdx)) then
         allocate(DstModLinTCTypeData%dYdx(LB(1):UB(1),LB(2):UB(2)), stat=ErrStat2)
         if (ErrStat2 /= 0) then
            call SetErrStat(ErrID_Fatal, 'Error allocating DstModLinTCTypeData%dYdx.', ErrStat, ErrMsg, RoutineName)
            return
         end if
      end if
      DstModLinTCTypeData%dYdx = SrcModLinTCTypeData%dYdx
   end if
   if (allocated(SrcModLinTCTypeData%dXdx)) then
      LB(1:2) = lbound(SrcModLinTCTypeData%dXdx, kind=B8Ki)
      UB(1:2) = ubound(SrcModLinTCTypeData%dXdx, kind=B8Ki)
      if (.not. allocated(DstModLinTCTypeData%dXdx)) then
         allocate(DstModLinTCTypeData%dXdx(LB(1):UB(1),LB(2):UB(2)), stat=ErrStat2)
         if (ErrStat2 /= 0) then
            call SetErrStat(ErrID_Fatal, 'Error allocating DstModLinTCTypeData%dXdx.', ErrStat, ErrMsg, RoutineName)
            return
         end if
      end if
      DstModLinTCTypeData%dXdx = SrcModLinTCTypeData%dXdx
   end if
   if (allocated(SrcModLinTCTypeData%dYdu)) then
      LB(1:2) = lbound(SrcModLinTCTypeData%dYdu, kind=B8Ki)
      UB(1:2) = ubound(SrcModLinTCTypeData%dYdu, kind=B8Ki)
      if (.not. allocated(DstModLinTCTypeData%dYdu)) then
         allocate(DstModLinTCTypeData%dYdu(LB(1):UB(1),LB(2):UB(2)), stat=ErrStat2)
         if (ErrStat2 /= 0) then
            call SetErrStat(ErrID_Fatal, 'Error allocating DstModLinTCTypeData%dYdu.', ErrStat, ErrMsg, RoutineName)
            return
         end if
      end if
      DstModLinTCTypeData%dYdu = SrcModLinTCTypeData%dYdu
   end if
   if (allocated(SrcModLinTCTypeData%dXdu)) then
      LB(1:2) = lbound(SrcModLinTCTypeData%dXdu, kind=B8Ki)
      UB(1:2) = ubound(SrcModLinTCTypeData%dXdu, kind=B8Ki)
      if (.not. allocated(DstModLinTCTypeData%dXdu)) then
         allocate(DstModLinTCTypeData%dXdu(LB(1):UB(1),LB(2):UB(2)), stat=ErrStat2)
         if (ErrStat2 /= 0) then
            call SetErrStat(ErrID_Fatal, 'Error allocating DstModLinTCTypeData%dXdu.', ErrStat, ErrMsg, RoutineName)
            return
         end if
      end if
      DstModLinTCTypeData%dXdu = SrcModLinTCTypeData%dXdu
   end if
   if (allocated(SrcModLinTCTypeData%dUdu)) then
      LB(1:2) = lbound(SrcModLinTCTypeData%dUdu, kind=B8Ki)
      UB(1:2) = ubound(SrcModLinTCTypeData%dUdu, kind=B8Ki)
      if (.not. allocated(DstModLinTCTypeData%dUdu)) then
         allocate(DstModLinTCTypeData%dUdu(LB(1):UB(1),LB(2):UB(2)), stat=ErrStat2)
         if (ErrStat2 /= 0) then
            call SetErrStat(ErrID_Fatal, 'Error allocating DstModLinTCTypeData%dUdu.', ErrStat, ErrMsg, RoutineName)
            return
         end if
      end if
      DstModLinTCTypeData%dUdu = SrcModLinTCTypeData%dUdu
   end if
   if (allocated(SrcModLinTCTypeData%dUdy)) then
      LB(1:2) = lbound(SrcModLinTCTypeData%dUdy, kind=B8Ki)
      UB(1:2) = ubound(SrcModLinTCTypeData%dUdy, kind=B8Ki)
      if (.not. allocated(DstModLinTCTypeData%dUdy)) then
         allocate(DstModLinTCTypeData%dUdy(LB(1):UB(1),LB(2):UB(2)), stat=ErrStat2)
         if (ErrStat2 /= 0) then
            call SetErrStat(ErrID_Fatal, 'Error allocating DstModLinTCTypeData%dUdy.', ErrStat, ErrMsg, RoutineName)
            return
         end if
      end if
      DstModLinTCTypeData%dUdy = SrcModLinTCTypeData%dUdy
   end if
   if (allocated(SrcModLinTCTypeData%StateRotation)) then
      LB(1:2) = lbound(SrcModLinTCTypeData%StateRotation, kind=B8Ki)
      UB(1:2) = ubound(SrcModLinTCTypeData%StateRotation, kind=B8Ki)
      if (.not. allocated(DstModLinTCTypeData%StateRotation)) then
         allocate(DstModLinTCTypeData%StateRotation(LB(1):UB(1),LB(2):UB(2)), stat=ErrStat2)
         if (ErrStat2 /= 0) then
            call SetErrStat(ErrID_Fatal, 'Error allocating DstModLinTCTypeData%StateRotation.', ErrStat, ErrMsg, RoutineName)
            return
         end if
      end if
      DstModLinTCTypeData%StateRotation = SrcModLinTCTypeData%StateRotation
   end if
end subroutine

subroutine FAST_DestroyModLinTCType(ModLinTCTypeData, ErrStat, ErrMsg)
   type(ModLinTCType), intent(inout) :: ModLinTCTypeData
   integer(IntKi),  intent(  out) :: ErrStat
   character(*),    intent(  out) :: ErrMsg
   character(*), parameter        :: RoutineName = 'FAST_DestroyModLinTCType'
   ErrStat = ErrID_None
   ErrMsg  = ''
   if (allocated(ModLinTCTypeData%x)) then
      deallocate(ModLinTCTypeData%x)
   end if
   if (allocated(ModLinTCTypeData%dx)) then
      deallocate(ModLinTCTypeData%dx)
   end if
   if (allocated(ModLinTCTypeData%xd)) then
      deallocate(ModLinTCTypeData%xd)
   end if
   if (allocated(ModLinTCTypeData%z)) then
      deallocate(ModLinTCTypeData%z)
   end if
   if (allocated(ModLinTCTypeData%u)) then
      deallocate(ModLinTCTypeData%u)
   end if
   if (allocated(ModLinTCTypeData%y)) then
      deallocate(ModLinTCTypeData%y)
   end if
   if (allocated(ModLinTCTypeData%u_perturb)) then
      deallocate(ModLinTCTypeData%u_perturb)
   end if
   if (allocated(ModLinTCTypeData%x_perturb)) then
      deallocate(ModLinTCTypeData%x_perturb)
   end if
   if (allocated(ModLinTCTypeData%x_pos)) then
      deallocate(ModLinTCTypeData%x_pos)
   end if
   if (allocated(ModLinTCTypeData%x_neg)) then
      deallocate(ModLinTCTypeData%x_neg)
   end if
   if (allocated(ModLinTCTypeData%y_pos)) then
      deallocate(ModLinTCTypeData%y_pos)
   end if
   if (allocated(ModLinTCTypeData%y_neg)) then
      deallocate(ModLinTCTypeData%y_neg)
   end if
   if (allocated(ModLinTCTypeData%dYdx)) then
      deallocate(ModLinTCTypeData%dYdx)
   end if
   if (allocated(ModLinTCTypeData%dXdx)) then
      deallocate(ModLinTCTypeData%dXdx)
   end if
   if (allocated(ModLinTCTypeData%dYdu)) then
      deallocate(ModLinTCTypeData%dYdu)
   end if
   if (allocated(ModLinTCTypeData%dXdu)) then
      deallocate(ModLinTCTypeData%dXdu)
   end if
   if (allocated(ModLinTCTypeData%dUdu)) then
      deallocate(ModLinTCTypeData%dUdu)
   end if
   if (allocated(ModLinTCTypeData%dUdy)) then
      deallocate(ModLinTCTypeData%dUdy)
   end if
   if (allocated(ModLinTCTypeData%StateRotation)) then
      deallocate(ModLinTCTypeData%StateRotation)
   end if
end subroutine

subroutine FAST_PackModLinTCType(RF, Indata)
   type(RegFile), intent(inout) :: RF
   type(ModLinTCType), intent(in) :: InData
   character(*), parameter         :: RoutineName = 'FAST_PackModLinTCType'
   if (RF%ErrStat >= AbortErrLev) return
...
subroutine FAST_UnPackModLinTCType(RF, OutData)
   type(RegFile), intent(inout)    :: RF
   type(ModLinTCType), intent(inout) :: OutData
   character(*), parameter            :: RoutineName = 'FAST_UnPackModLinTCType'
   integer(B8Ki)   :: LB(2), UB(2)
   integer(IntKi)  :: stat
   logical         :: IsAllocAssoc
   if (RF%ErrStat /= ErrID_None) return
...
subroutine FAST_CopyModDataType(SrcModDataTypeData, DstModDataTypeData, CtrlCode, ErrStat, ErrMsg)
   ...
   integer(IntKi)                 :: ErrStat2
   character(ErrMsgLen)           :: ErrMsg2
   character(*), parameter        :: RoutineName = 'FAST_CopyModDataType'
   ErrStat = ErrID_None
   ErrMsg  = ''
...
subroutine FAST_DestroyModDataType(ModDataTypeData, ErrStat, ErrMsg)
   type(ModDataType), intent(inout) :: ModDataTypeData
   integer(IntKi),  intent(  out) :: ErrStat
   character(*),    intent(  out) :: ErrMsg
   integer(IntKi)                 :: ErrStat2
   character(ErrMsgLen)           :: ErrMsg2
   character(*), parameter        :: RoutineName = 'FAST_DestroyModDataType'
   ErrStat = ErrID_None
   ErrMsg  = ''
...
subroutine FAST_PackModDataType(RF, Indata)
   type(RegFile), intent(inout) :: RF
   type(ModDataType), intent(in) :: InData
   character(*), parameter         :: RoutineName = 'FAST_PackModDataType'
   logical         :: PtrInIndex
   if (RF%ErrStat >= AbortErrLev) return
...
subroutine FAST_UnPackModDataType(RF, OutData)
   type(RegFile), intent(inout)    :: RF
   type(ModDataType), intent(inout) :: OutData
   character(*), parameter            :: RoutineName = 'FAST_UnPackModDataType'
   integer(B8Ki)   :: LB(1), UB(1)
   integer(IntKi)  :: stat
   logical         :: IsAllocAssoc
   integer(B8Ki)   :: PtrIdx
...
subroutine FAST_CopyML_ParameterType(SrcML_ParameterTypeData, DstML_ParameterTypeData, CtrlCode, ErrStat, ErrMsg)
   ...
   ErrStat = ErrID_None
   ErrMsg  = ''
   if (allocated(SrcML_ParameterTypeData%iMod)) then
      LB(1:1) = lbound(SrcML_ParameterTypeData%iMod, kind=B8Ki)
      UB(1:1) = ubound(SrcML_ParameterTypeData%iMod, kind=B8Ki)
      if (.not. allocated(DstML_ParameterTypeData%iMod)) then
         allocate(DstML_ParameterTypeData%iMod(LB(1):UB(1)), stat=ErrStat2)
         if (ErrStat2 /= 0) then
            call SetErrStat(ErrID_Fatal, 'Error allocating DstML_ParameterTypeData%iMod.', ErrStat, ErrMsg, RoutineName)
            return
         end if
      end if
...
subroutine FAST_PackML_ParameterType(RF, Indata)
   type(RegFile), intent(inout) :: RF
   type(ML_ParameterType), intent(in) :: InData
...
subroutine FAST_UnPackML_ParameterType(RF, OutData)
   type(RegFile), intent(inout)    :: RF
   type(ML_ParameterType), intent(inout) :: OutData
   character(*), parameter            :: RoutineName = 'FAST_UnPackML_ParameterType'
   integer(B8Ki)   :: LB(1), UB(1)
   integer(IntKi)  :: stat
   logical         :: IsAllocAssoc
   if (RF%ErrStat /= ErrID_None) return
...
subroutine FAST_CopyML_MiscVarType(SrcML_MiscVarTypeData, DstML_MiscVarTypeData, CtrlCode, ErrStat, ErrMsg)
   type(ML_MiscVarType), intent(inout) :: SrcML_MiscVarTypeData
   type(ML_MiscVarType), intent(inout) :: DstML_MiscVarTypeData
   integer(IntKi),  intent(in   ) :: CtrlCode
   integer(IntKi),  intent(  out) :: ErrStat
   character(*),    intent(  out) :: ErrMsg
   integer(B8Ki)   :: i1
   ...
   integer(IntKi)                 :: ErrStat2
   character(ErrMsgLen)           :: ErrMsg2
   character(*), parameter        :: RoutineName = 'FAST_CopyML_MiscVarType'
   ErrStat = ErrID_None
   ErrMsg  = ''
   if (allocated(SrcML_MiscVarTypeData%Mappings)) then
      LB(1:1) = lbound(SrcML_MiscVarTypeData%Mappings, kind=B8Ki)
      UB(1:1) = ubound(SrcML_MiscVarTypeData%Mappings, kind=B8Ki)
      if (.not. allocated(DstML_MiscVarTypeData%Mappings)) then
         allocate(DstML_MiscVarTypeData%Mappings(LB(1):UB(1)), stat=ErrStat2)
         if (ErrStat2 /= 0) then
            call SetErrStat(ErrID_Fatal, 'Error allocating DstML_MiscVarTypeData%Mappings.', ErrStat, ErrMsg, RoutineName)
            return
         end if
      end if
      do i1 = LB(1), UB(1)
         call FAST_CopyTC_MappingType(SrcML_MiscVarTypeData%Mappings(i1), DstML_MiscVarTypeData%Mappings(i1), CtrlCode, ErrStat2, ErrMsg2)
         call SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
         if (ErrStat >= AbortErrLev) return
      end do
   end if
...
subroutine FAST_DestroyML_MiscVarType(ML_MiscVarTypeData, ErrStat, ErrMsg)
   type(ML_MiscVarType), intent(inout) :: ML_MiscVarTypeData
   integer(IntKi),  intent(  out) :: ErrStat
   character(*),    intent(  out) :: ErrMsg
   integer(B8Ki)   :: i1
   integer(B8Ki)   :: LB(1), UB(1)
   integer(IntKi)                 :: ErrStat2
   character(ErrMsgLen)           :: ErrMsg2
   character(*), parameter        :: RoutineName = 'FAST_DestroyML_MiscVarType'
   ErrStat = ErrID_None
   ErrMsg  = ''
   if (allocated(ML_MiscVarTypeData%Mappings)) then
      LB(1:1) = lbound(ML_MiscVarTypeData%Mappings, kind=B8Ki)
      UB(1:1) = ubound(ML_MiscVarTypeData%Mappings, kind=B8Ki)
      do i1 = LB(1), UB(1)
         call FAST_DestroyTC_MappingType(ML_MiscVarTypeData%Mappings(i1), ErrStat2, ErrMsg2)
         call SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
      end do
      deallocate(ML_MiscVarTypeData%Mappings)
   end if
end subroutine

subroutine FAST_PackML_MiscVarType(RF, Indata)
   type(RegFile), intent(inout) :: RF
   type(ML_MiscVarType), intent(in) :: InData
   character(*), parameter         :: RoutineName = 'FAST_PackML_MiscVarType'
   integer(B8Ki)   :: i1
   integer(B8Ki)   :: LB(1), UB(1)
   if (RF%ErrStat >= AbortErrLev) return
   ...
   if (allocated(InData%Mappings)) then
      ...
      do i1 = LB(1), UB(1)
         call FAST_PackTC_MappingType(RF, InData%Mappings(i1)) 
      end do
   end if
   if (RegCheckErr(RF, RoutineName)) return
end subroutine

subroutine FAST_UnPackML_MiscVarType(RF, OutData)
   type(RegFile), intent(inout)    :: RF
   type(ML_MiscVarType), intent(inout) :: OutData
   character(*), parameter            :: RoutineName = 'FAST_UnPackML_MiscVarType'
   integer(B8Ki)   :: i1
   integer(B8Ki)   :: LB(1), UB(1)
   integer(IntKi)  :: stat
   logical         :: IsAllocAssoc
   ...
   if (IsAllocAssoc) then
      ...
      do i1 = LB(1), UB(1)
         call FAST_UnpackTC_MappingType(RF, OutData%Mappings(i1)) ! Mappings 
      end do
   end if
end subroutine

subroutine FAST_CopyML_OutputType(SrcML_OutputTypeData, DstML_OutputTypeData, CtrlCode, ErrStat, ErrMsg)
   type(ML_OutputType), intent(in) :: SrcML_OutputTypeData
   type(ML_OutputType), intent(inout) :: DstML_OutputTypeData
   integer(IntKi),  intent(in   ) :: CtrlCode
   integer(IntKi),  intent(  out) :: ErrStat
   character(*),    intent(  out) :: ErrMsg
   integer(B8Ki)   :: i1
   ...
   integer(IntKi)                 :: ErrStat2
   character(ErrMsgLen)           :: ErrMsg2
   character(*), parameter        :: RoutineName = 'FAST_CopyML_OutputType'
   ErrStat = ErrID_None
   ErrMsg  = ''
   if (allocated(SrcML_OutputTypeData%Lin)) then
      LB(1:1) = lbound(SrcML_OutputTypeData%Lin, kind=B8Ki)
      UB(1:1) = ubound(SrcML_OutputTypeData%Lin, kind=B8Ki)
      if (.not. allocated(DstML_OutputTypeData%Lin)) then
         allocate(DstML_OutputTypeData%Lin(LB(1):UB(1)), stat=ErrStat2)
         if (ErrStat2 /= 0) then
            call SetErrStat(ErrID_Fatal, 'Error allocating DstML_OutputTypeData%Lin.', ErrStat, ErrMsg, RoutineName)
            return
         end if
      end if
      do i1 = LB(1), UB(1)
         call FAST_CopyModLinTCType(SrcML_OutputTypeData%Lin(i1), DstML_OutputTypeData%Lin(i1), CtrlCode, ErrStat2, ErrMsg2)
         call SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
         if (ErrStat >= AbortErrLev) return
      end do
   end if
...
subroutine FAST_DestroyML_OutputType(ML_OutputTypeData, ErrStat, ErrMsg)
   type(ML_OutputType), intent(inout) :: ML_OutputTypeData
   integer(IntKi),  intent(  out) :: ErrStat
   character(*),    intent(  out) :: ErrMsg
   integer(B8Ki)   :: i1
   integer(B8Ki)   :: LB(1), UB(1)
   integer(IntKi)                 :: ErrStat2
   character(ErrMsgLen)           :: ErrMsg2
   character(*), parameter        :: RoutineName = 'FAST_DestroyML_OutputType'
   ErrStat = ErrID_None
   ErrMsg  = ''
   if (allocated(ML_OutputTypeData%Lin)) then
      LB(1:1) = lbound(ML_OutputTypeData%Lin, kind=B8Ki)
      UB(1:1) = ubound(ML_OutputTypeData%Lin, kind=B8Ki)
      do i1 = LB(1), UB(1)
         call FAST_DestroyModLinTCType(ML_OutputTypeData%Lin(i1), ErrStat2, ErrMsg2)
         call SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
      end do
      deallocate(ML_OutputTypeData%Lin)
   end if
end subroutine

subroutine FAST_PackML_OutputType(RF, Indata)
   type(RegFile), intent(inout) :: RF
   type(ML_OutputType), intent(in) :: InData
   character(*), parameter         :: RoutineName = 'FAST_PackML_OutputType'
   integer(B8Ki)   :: i1
   integer(B8Ki)   :: LB(1), UB(1)
   if (RF%ErrStat >= AbortErrLev) return
   call RegPack(RF, allocated(InData%Lin))
   if (allocated(InData%Lin)) then
      call RegPackBounds(RF, 1, lbound(InData%Lin, kind=B8Ki), ubound(InData%Lin, kind=B8Ki))
      LB(1:1) = lbound(InData%Lin, kind=B8Ki)
      UB(1:1) = ubound(InData%Lin, kind=B8Ki)
      do i1 = LB(1), UB(1)
         call FAST_PackModLinTCType(RF, InData%Lin(i1)) 
      end do
   end if
   if (RegCheckErr(RF, RoutineName)) return
end subroutine

subroutine FAST_UnPackML_OutputType(RF, OutData)
   type(RegFile), intent(inout)    :: RF
   type(ML_OutputType), intent(inout) :: OutData
   character(*), parameter            :: RoutineName = 'FAST_UnPackML_OutputType'
   integer(B8Ki)   :: i1
   integer(B8Ki)   :: LB(1), UB(1)
   integer(IntKi)  :: stat
   logical         :: IsAllocAssoc
   if (RF%ErrStat /= ErrID_None) return
   if (allocated(OutData%Lin)) deallocate(OutData%Lin)
   call RegUnpack(RF, IsAllocAssoc); if (RegCheckErr(RF, RoutineName)) return
   if (IsAllocAssoc) then
      call RegUnpackBounds(RF, 1, LB, UB); if (RegCheckErr(RF, RoutineName)) return
      allocate(OutData%Lin(LB(1):UB(1)),stat=stat)
      if (stat /= 0) then 
         call SetErrStat(ErrID_Fatal, 'Error allocating OutData%Lin.', RF%ErrStat, RF%ErrMsg, RoutineName)
         return
      end if
      do i1 = LB(1), UB(1)
         call FAST_UnpackModLinTCType(RF, OutData%Lin(i1)) ! Lin 
      end do
   end if
end subroutine

subroutine FAST_CopyTC_MiscVarType(SrcTC_MiscVarTypeData, DstTC_MiscVarTypeData, CtrlCode, ErrStat, ErrMsg)
   type(TC_MiscVarType), intent(inout) :: SrcTC_MiscVarTypeData
   ...
   if (allocated(SrcTC_MiscVarTypeData%q)) then
      LB(1:2) = lbound(SrcTC_MiscVarTypeData%q, kind=B8Ki)
      UB(1:2) = ubound(SrcTC_MiscVarTypeData%q, kind=B8Ki)
   ...
   if (allocated(SrcTC_MiscVarTypeData%qn)) then
      LB(1:2) = lbound(SrcTC_MiscVarTypeData%qn, kind=B8Ki)
      UB(1:2) = ubound(SrcTC_MiscVarTypeData%qn, kind=B8Ki)
   ...
   if (allocated(SrcTC_MiscVarTypeData%x)) then
      LB(1:1) = lbound(SrcTC_MiscVarTypeData%x, kind=B8Ki)
      UB(1:1) = ubound(SrcTC_MiscVarTypeData%x, kind=B8Ki)
   ...
   if (allocated(SrcTC_MiscVarTypeData%xn)) then
      LB(1:1) = lbound(SrcTC_MiscVarTypeData%xn, kind=B8Ki)
      UB(1:1) = ubound(SrcTC_MiscVarTypeData%xn, kind=B8Ki)
   ...
   if (allocated(SrcTC_MiscVarTypeData%dxdt)) then
      LB(1:1) = lbound(SrcTC_MiscVarTypeData%dxdt, kind=B8Ki)
      UB(1:1) = ubound(SrcTC_MiscVarTypeData%dxdt, kind=B8Ki)
   ...
   if (allocated(SrcTC_MiscVarTypeData%u)) then
      LB(1:1) = lbound(SrcTC_MiscVarTypeData%u, kind=B8Ki)
      UB(1:1) = ubound(SrcTC_MiscVarTypeData%u, kind=B8Ki)
   ...
   if (allocated(SrcTC_MiscVarTypeData%un)) then
      LB(1:1) = lbound(SrcTC_MiscVarTypeData%un, kind=B8Ki)
      UB(1:1) = ubound(SrcTC_MiscVarTypeData%un, kind=B8Ki)
   ...
   if (allocated(SrcTC_MiscVarTypeData%u_tmp)) then
      LB(1:1) = lbound(SrcTC_MiscVarTypeData%u_tmp, kind=B8Ki)
      UB(1:1) = ubound(SrcTC_MiscVarTypeData%u_tmp, kind=B8Ki)
   ...
   if (allocated(SrcTC_MiscVarTypeData%y)) then
      LB(1:1) = lbound(SrcTC_MiscVarTypeData%y, kind=B8Ki)
      UB(1:1) = ubound(SrcTC_MiscVarTypeData%y, kind=B8Ki)
   ...
   if (allocated(SrcTC_MiscVarTypeData%dYdx)) then
      LB(1:2) = lbound(SrcTC_MiscVarTypeData%dYdx, kind=B8Ki)
      UB(1:2) = ubound(SrcTC_MiscVarTypeData%dYdx, kind=B8Ki)
   ...
   if (allocated(SrcTC_MiscVarTypeData%dYdu)) then
      LB(1:2) = lbound(SrcTC_MiscVarTypeData%dYdu, kind=B8Ki)
      UB(1:2) = ubound(SrcTC_MiscVarTypeData%dYdu, kind=B8Ki)
   ...
   if (allocated(SrcTC_MiscVarTypeData%dXdx)) then
      LB(1:2) = lbound(SrcTC_MiscVarTypeData%dXdx, kind=B8Ki)
      UB(1:2) = ubound(SrcTC_MiscVarTypeData%dXdx, kind=B8Ki)
   ...
   if (allocated(SrcTC_MiscVarTypeData%dXdu)) then
      LB(1:2) = lbound(SrcTC_MiscVarTypeData%dXdu, kind=B8Ki)
      UB(1:2) = ubound(SrcTC_MiscVarTypeData%dXdu, kind=B8Ki)
   ...
   if (allocated(SrcTC_MiscVarTypeData%dUdu)) then
      LB(1:2) = lbound(SrcTC_MiscVarTypeData%dUdu, kind=B8Ki)
      UB(1:2) = ubound(SrcTC_MiscVarTypeData%dUdu, kind=B8Ki)
   ...
   if (allocated(SrcTC_MiscVarTypeData%dUdy)) then
      LB(1:2) = lbound(SrcTC_MiscVarTypeData%dUdy, kind=B8Ki)
      UB(1:2) = ubound(SrcTC_MiscVarTypeData%dUdy, kind=B8Ki)
   ...
   if (allocated(SrcTC_MiscVarTypeData%GinvdUdu)) then
      LB(1:2) = lbound(SrcTC_MiscVarTypeData%GinvdUdu, kind=B8Ki)
      UB(1:2) = ubound(SrcTC_MiscVarTypeData%GinvdUdu, kind=B8Ki)
      if (.not. allocated(DstTC_MiscVarTypeData%GinvdUdu)) then
         allocate(DstTC_MiscVarTypeData%GinvdUdu(LB(1):UB(1),LB(2):UB(2)), stat=ErrStat2)
         if (ErrStat2 /= 0) then
            call SetErrStat(ErrID_Fatal, 'Error allocating DstTC_MiscVarTypeData%GinvdUdu.', ErrStat, ErrMsg, RoutineName)
            return
         end if
      end if
      DstTC_MiscVarTypeData%GinvdUdu = SrcTC_MiscVarTypeData%GinvdUdu
   end if
   if (allocated(SrcTC_MiscVarTypeData%dUdyHat)) then
      LB(1:2) = lbound(SrcTC_MiscVarTypeData%dUdyHat, kind=B8Ki)
      UB(1:2) = ubound(SrcTC_MiscVarTypeData%dUdyHat, kind=B8Ki)
      if (.not. allocated(DstTC_MiscVarTypeData%dUdyHat)) then
         allocate(DstTC_MiscVarTypeData%dUdyHat(LB(1):UB(1),LB(2):UB(2)), stat=ErrStat2)
         if (ErrStat2 /= 0) then
            call SetErrStat(ErrID_Fatal, 'Error allocating DstTC_MiscVarTypeData%dUdyHat.', ErrStat, ErrMsg, RoutineName)
            return
         end if
      end if
      DstTC_MiscVarTypeData%dUdyHat = SrcTC_MiscVarTypeData%dUdyHat
   end if
   if (allocated(SrcTC_MiscVarTypeData%XB)) then
      LB(1:2) = lbound(SrcTC_MiscVarTypeData%XB, kind=B8Ki)
      UB(1:2) = ubound(SrcTC_MiscVarTypeData%XB, kind=B8Ki)
   ...
   if (allocated(SrcTC_MiscVarTypeData%G)) then
      LB(1:2) = lbound(SrcTC_MiscVarTypeData%G, kind=B8Ki)
      UB(1:2) = ubound(SrcTC_MiscVarTypeData%G, kind=B8Ki)
      if (.not. allocated(DstTC_MiscVarTypeData%G)) then
         allocate(DstTC_MiscVarTypeData%G(LB(1):UB(1),LB(2):UB(2)), stat=ErrStat2)
         if (ErrStat2 /= 0) then
            call SetErrStat(ErrID_Fatal, 'Error allocating DstTC_MiscVarTypeData%G.', ErrStat, ErrMsg, RoutineName)
            return
         end if
      end if
      DstTC_MiscVarTypeData%G = SrcTC_MiscVarTypeData%G
   end if
   if (allocated(SrcTC_MiscVarTypeData%Jac)) then
      LB(1:2) = lbound(SrcTC_MiscVarTypeData%Jac, kind=B8Ki)
      UB(1:2) = ubound(SrcTC_MiscVarTypeData%Jac, kind=B8Ki)
   ...
   if (allocated(SrcTC_MiscVarTypeData%IPIV)) then
      LB(1:1) = lbound(SrcTC_MiscVarTypeData%IPIV, kind=B8Ki)
      UB(1:1) = ubound(SrcTC_MiscVarTypeData%IPIV, kind=B8Ki)
   ...
   if (allocated(SrcTC_MiscVarTypeData%dq)) then
      LB(1:2) = lbound(SrcTC_MiscVarTypeData%dq, kind=B8Ki)
      UB(1:2) = ubound(SrcTC_MiscVarTypeData%dq, kind=B8Ki)
   ...
   if (allocated(SrcTC_MiscVarTypeData%dx)) then
      LB(1:1) = lbound(SrcTC_MiscVarTypeData%dx, kind=B8Ki)
      UB(1:1) = ubound(SrcTC_MiscVarTypeData%dx, kind=B8Ki)
   ...
   if (allocated(SrcTC_MiscVarTypeData%du)) then
      LB(1:1) = lbound(SrcTC_MiscVarTypeData%du, kind=B8Ki)
      UB(1:1) = ubound(SrcTC_MiscVarTypeData%du, kind=B8Ki)
   ...
   if (allocated(SrcTC_MiscVarTypeData%UDiff)) then
      LB(1:1) = lbound(SrcTC_MiscVarTypeData%UDiff, kind=B8Ki)
      UB(1:1) = ubound(SrcTC_MiscVarTypeData%UDiff, kind=B8Ki)
      if (.not. allocated(DstTC_MiscVarTypeData%UDiff)) then
         allocate(DstTC_MiscVarTypeData%UDiff(LB(1):UB(1)), stat=ErrStat2)
         if (ErrStat2 /= 0) then
            call SetErrStat(ErrID_Fatal, 'Error allocating DstTC_MiscVarTypeData%UDiff.', ErrStat, ErrMsg, RoutineName)
            return
         end if
      end if
   ...
   if (allocated(SrcTC_MiscVarTypeData%Mappings)) then
      LB(1:1) = lbound(SrcTC_MiscVarTypeData%Mappings, kind=B8Ki)
      UB(1:1) = ubound(SrcTC_MiscVarTypeData%Mappings, kind=B8Ki)
      if (.not. allocated(DstTC_MiscVarTypeData%Mappings)) then
         allocate(DstTC_MiscVarTypeData%Mappings(LB(1):UB(1)), stat=ErrStat2)
         if (ErrStat2 /= 0) then
            call SetErrStat(ErrID_Fatal, 'Error allocating DstTC_MiscVarTypeData%Mappings.', ErrStat, ErrMsg, RoutineName)
            return
         end if
      end if
      do i1 = LB(1), UB(1)
...
subroutine FAST_DestroyTC_MiscVarType(TC_MiscVarTypeData, ErrStat, ErrMsg)
   ...
   if (allocated(TC_MiscVarTypeData%GinvdUdu)) then
      deallocate(TC_MiscVarTypeData%GinvdUdu)
   end if
   if (allocated(TC_MiscVarTypeData%dUdyHat)) then
      deallocate(TC_MiscVarTypeData%dUdyHat)
   end if
   if (allocated(TC_MiscVarTypeData%XB)) then
      deallocate(TC_MiscVarTypeData%XB)
   end if
   if (allocated(TC_MiscVarTypeData%G)) then
      deallocate(TC_MiscVarTypeData%G)
   end if
   ...
   if (allocated(TC_MiscVarTypeData%UDiff)) then
      deallocate(TC_MiscVarTypeData%UDiff)
   end if
   if (allocated(TC_MiscVarTypeData%Mappings)) then
      LB(1:1) = lbound(TC_MiscVarTypeData%Mappings, kind=B8Ki)
      UB(1:1) = ubound(TC_MiscVarTypeData%Mappings, kind=B8Ki)
      do i1 = LB(1), UB(1)
...
subroutine FAST_PackTC_MiscVarType(RF, Indata)
   type(RegFile), intent(inout) :: RF
   ...
   call RegPackAlloc(RF, InData%dUdu)
   call RegPackAlloc(RF, InData%dUdy)
   call RegPackAlloc(RF, InData%GinvdUdu)
...
subroutine FAST_UnPackTC_MiscVarType(RF, OutData)
   type(RegFile), intent(inout)    :: RF
   ...
   call RegUnpackAlloc(RF, OutData%dUdu); if (RegCheckErr(RF, RoutineName)) return
   call RegUnpackAlloc(RF, OutData%dUdy); if (RegCheckErr(RF, RoutineName)) return
   call RegUnpackAlloc(RF, OutData%GinvdUdu); if (RegCheckErr(RF, RoutineName)) return
...
subroutine FAST_CopyParam(SrcParamData, DstParamData, CtrlCode, ErrStat, ErrMsg)
   ...
   call FAST_CopyML_ParameterType(SrcParamData%ModLin, DstParamData%ModLin, CtrlCode, ErrStat2, ErrMsg2)
   call SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
   if (ErrStat >= AbortErrLev) return
...
subroutine FAST_DestroyParam(ParamData, ErrStat, ErrMsg)
   ...
   call SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
   call FAST_DestroyML_ParameterType(ParamData%ModLin, ErrStat2, ErrMsg2)
   call SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
...
subroutine FAST_PackParam(RF, Indata)
   ...
   call FAST_PackML_ParameterType(RF, InData%ModLin) 
...
subroutine FAST_UnPackParam(RF, OutData)
   ...
   call FAST_UnpackML_ParameterType(RF, OutData%ModLin) ! ModLin 
...
subroutine FAST_CopyOutputFileType(SrcOutputFileTypeData, DstOutputFileTypeData, CtrlCode, ErrStat, ErrMsg)
   ...
   if (allocated(SrcOutputFileTypeData%Modules)) then
      LB(1:1) = lbound(SrcOutputFileTypeData%Modules, kind=B8Ki)
      UB(1:1) = ubound(SrcOutputFileTypeData%Modules, kind=B8Ki)
      if (.not. allocated(DstOutputFileTypeData%Modules)) then
         allocate(DstOutputFileTypeData%Modules(LB(1):UB(1)), stat=ErrStat2)
         if (ErrStat2 /= 0) then
            call SetErrStat(ErrID_Fatal, 'Error allocating DstOutputFileTypeData%Modules.', ErrStat, ErrMsg, RoutineName)
            return
         end if
      end if
      do i1 = LB(1), UB(1)
         call FAST_CopyModDataType(SrcOutputFileTypeData%Modules(i1), DstOutputFileTypeData%Modules(i1), CtrlCode, ErrStat2, ErrMsg2)
         call SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
         if (ErrStat >= AbortErrLev) return
      end do
   end if
   call FAST_CopyModDataType(SrcOutputFileTypeData%ModGlue, DstOutputFileTypeData%ModGlue, CtrlCode, ErrStat2, ErrMsg2)
   call SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
   if (ErrStat >= AbortErrLev) return
end subroutine
...
subroutine FAST_DestroyOutputFileType(OutputFileTypeData, ErrStat, ErrMsg)
   ...
   call SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
   if (allocated(OutputFileTypeData%Modules)) then
      LB(1:1) = lbound(OutputFileTypeData%Modules, kind=B8Ki)
      UB(1:1) = ubound(OutputFileTypeData%Modules, kind=B8Ki)
      do i1 = LB(1), UB(1)
         call FAST_DestroyModDataType(OutputFileTypeData%Modules(i1), ErrStat2, ErrMsg2)
         call SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
      end do
      deallocate(OutputFileTypeData%Modules)
   end if
   call FAST_DestroyModDataType(OutputFileTypeData%ModGlue, ErrStat2, ErrMsg2)
   call SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
end subroutine
...
subroutine FAST_PackOutputFileType(RF, Indata)
   ...
   if (allocated(InData%Modules)) then
      ...
      UB(1:1) = ubound(InData%Modules, kind=B8Ki)
      do i1 = LB(1), UB(1)
         call FAST_PackModDataType(RF, InData%Modules(i1)) 
      end do
   end if
...
subroutine FAST_UnPackOutputFileType(RF, OutData)
   ...
   if (IsAllocAssoc) then
      ...
      do i1 = LB(1), UB(1)
         call FAST_UnpackModDataType(RF, OutData%Modules(i1)) ! Modules 
      end do
   end if
   call FAST_UnpackModDataType(RF, OutData%ModGlue) ! ModGlue 
end subroutine
...
subroutine FAST_CopyIceDyn_Data(SrcIceDyn_DataData, DstIceDyn_DataData, CtrlCode, ErrStat, ErrMsg)
   ...
   if (allocated(SrcIceDyn_DataData%Input_Saved)) then
      LB(1:2) = lbound(SrcIceDyn_DataData%Input_Saved, kind=B8Ki)
      UB(1:2) = ubound(SrcIceDyn_DataData%Input_Saved, kind=B8Ki)
   ...
   if (allocated(SrcIceDyn_DataData%InputTimes_Saved)) then
      LB(1:2) = lbound(SrcIceDyn_DataData%InputTimes_Saved, kind=B8Ki)
      UB(1:2) = ubound(SrcIceDyn_DataData%InputTimes_Saved, kind=B8Ki)
...
subroutine FAST_DestroyIceDyn_Data(IceDyn_DataData, ErrStat, ErrMsg)
   ...
   if (allocated(IceDyn_DataData%Input_Saved)) then
      LB(1:2) = lbound(IceDyn_DataData%Input_Saved, kind=B8Ki)
      UB(1:2) = ubound(IceDyn_DataData%Input_Saved, kind=B8Ki)
      do i2 = LB(2), UB(2)
         do i1 = LB(1), UB(1)
...
subroutine FAST_PackIceDyn_Data(RF, Indata)
   ...
   if (allocated(InData%Input_Saved)) then
      call RegPackBounds(RF, 2, lbound(InData%Input_Saved, kind=B8Ki), ubound(InData%Input_Saved, kind=B8Ki))
      LB(1:2) = lbound(InData%Input_Saved, kind=B8Ki)
      UB(1:2) = ubound(InData%Input_Saved, kind=B8Ki)
      do i2 = LB(2), UB(2)
         do i1 = LB(1), UB(1)
...
subroutine FAST_CopyBeamDyn_Data(SrcBeamDyn_DataData, DstBeamDyn_DataData, CtrlCode, ErrStat, ErrMsg)
   ...
   if (allocated(SrcBeamDyn_DataData%Input_Saved)) then
      LB(1:2) = lbound(SrcBeamDyn_DataData%Input_Saved, kind=B8Ki)
      UB(1:2) = ubound(SrcBeamDyn_DataData%Input_Saved, kind=B8Ki)
   ...
   if (allocated(SrcBeamDyn_DataData%InputTimes_Saved)) then
      LB(1:2) = lbound(SrcBeamDyn_DataData%InputTimes_Saved, kind=B8Ki)
      UB(1:2) = ubound(SrcBeamDyn_DataData%InputTimes_Saved, kind=B8Ki)
...
subroutine FAST_DestroyBeamDyn_Data(BeamDyn_DataData, ErrStat, ErrMsg)
   ...
   if (allocated(BeamDyn_DataData%Input_Saved)) then
      LB(1:2) = lbound(BeamDyn_DataData%Input_Saved, kind=B8Ki)
      UB(1:2) = ubound(BeamDyn_DataData%Input_Saved, kind=B8Ki)
      do i2 = LB(2), UB(2)
         do i1 = LB(1), UB(1)
...
subroutine FAST_CopyElastoDyn_Data(SrcElastoDyn_DataData, DstElastoDyn_DataData, CtrlCode, ErrStat, ErrMsg)
   ...
   if (allocated(SrcElastoDyn_DataData%Output_bak)) then
      LB(1:1) = lbound(SrcElastoDyn_DataData%Output_bak, kind=B8Ki)
      UB(1:1) = ubound(SrcElastoDyn_DataData%Output_bak, kind=B8Ki)
   ...
   if (allocated(SrcElastoDyn_DataData%Input_Saved)) then
      LB(1:1) = lbound(SrcElastoDyn_DataData%Input_Saved, kind=B8Ki)
      UB(1:1) = ubound(SrcElastoDyn_DataData%Input_Saved, kind=B8Ki)
   ...
   if (allocated(SrcElastoDyn_DataData%InputTimes_Saved)) then
      LB(1:1) = lbound(SrcElastoDyn_DataData%InputTimes_Saved, kind=B8Ki)
      UB(1:1) = ubound(SrcElastoDyn_DataData%InputTimes_Saved, kind=B8Ki)
...
subroutine FAST_DestroyElastoDyn_Data(ElastoDyn_DataData, ErrStat, ErrMsg)
   ...
   if (allocated(ElastoDyn_DataData%Output_bak)) then
      LB(1:1) = lbound(ElastoDyn_DataData%Output_bak, kind=B8Ki)
      UB(1:1) = ubound(ElastoDyn_DataData%Output_bak, kind=B8Ki)
      do i1 = LB(1), UB(1)
   ...
   if (allocated(ElastoDyn_DataData%Input_Saved)) then
      LB(1:1) = lbound(ElastoDyn_DataData%Input_Saved, kind=B8Ki)
      UB(1:1) = ubound(ElastoDyn_DataData%Input_Saved, kind=B8Ki)
      do i1 = LB(1), UB(1)
...
subroutine FAST_PackElastoDyn_Data(RF, Indata)
   ...
   if (allocated(InData%Output_bak)) then
      call RegPackBounds(RF, 1, lbound(InData%Output_bak, kind=B8Ki), ubound(InData%Output_bak, kind=B8Ki))
      LB(1:1) = lbound(InData%Output_bak, kind=B8Ki)
      UB(1:1) = ubound(InData%Output_bak, kind=B8Ki)
      do i1 = LB(1), UB(1)
...
subroutine FAST_CopyServoDyn_Data(SrcServoDyn_DataData, DstServoDyn_DataData, CtrlCode, ErrStat, ErrMsg)
   ...
   if (allocated(SrcServoDyn_DataData%Input_Saved)) then
      LB(1:1) = lbound(SrcServoDyn_DataData%Input_Saved, kind=B8Ki)
      UB(1:1) = ubound(SrcServoDyn_DataData%Input_Saved, kind=B8Ki)
   ...
   if (allocated(SrcServoDyn_DataData%InputTimes_Saved)) then
      LB(1:1) = lbound(SrcServoDyn_DataData%InputTimes_Saved, kind=B8Ki)
      UB(1:1) = ubound(SrcServoDyn_DataData%InputTimes_Saved, kind=B8Ki)
...
subroutine FAST_DestroyServoDyn_Data(ServoDyn_DataData, ErrStat, ErrMsg)
   ...
   if (allocated(ServoDyn_DataData%Input_Saved)) then
      LB(1:1) = lbound(ServoDyn_DataData%Input_Saved, kind=B8Ki)
      UB(1:1) = ubound(ServoDyn_DataData%Input_Saved, kind=B8Ki)
      do i1 = LB(1), UB(1)
...
subroutine FAST_CopyAeroDyn14_Data(SrcAeroDyn14_DataData, DstAeroDyn14_DataData, CtrlCode, ErrStat, ErrMsg)
   ...
   if (allocated(SrcAeroDyn14_DataData%Input_Saved)) then
      LB(1:1) = lbound(SrcAeroDyn14_DataData%Input_Saved, kind=B8Ki)
      UB(1:1) = ubound(SrcAeroDyn14_DataData%Input_Saved, kind=B8Ki)
      if (.not. allocated(DstAeroDyn14_DataData%Input_Saved)) then
         allocate(DstAeroDyn14_DataData%Input_Saved(LB(1):UB(1)), stat=ErrStat2)
         if (ErrStat2 /= 0) then
   ...
   if (allocated(SrcAeroDyn14_DataData%InputTimes_Saved)) then
      LB(1:1) = lbound(SrcAeroDyn14_DataData%InputTimes_Saved, kind=B8Ki)
      UB(1:1) = ubound(SrcAeroDyn14_DataData%InputTimes_Saved, kind=B8Ki)
      if (.not. allocated(DstAeroDyn14_DataData%InputTimes_Saved)) then
         allocate(DstAeroDyn14_DataData%InputTimes_Saved(LB(1):UB(1)), stat=ErrStat2)
         if (ErrStat2 /= 0) then
...
subroutine FAST_DestroyAeroDyn14_Data(AeroDyn14_DataData, ErrStat, ErrMsg)
   ...
   if (allocated(AeroDyn14_DataData%Input_Saved)) then
      LB(1:1) = lbound(AeroDyn14_DataData%Input_Saved, kind=B8Ki)
      UB(1:1) = ubound(AeroDyn14_DataData%Input_Saved, kind=B8Ki)
      do i1 = LB(1), UB(1)
         call AD14_DestroyInput(AeroDyn14_DataData%Input_Saved(i1), ErrStat2, ErrMsg2)
         call SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
      end do
...
subroutine FAST_PackAeroDyn14_Data(RF, Indata)
   ...
   if (allocated(InData%Input_Saved)) then
      ...
      UB(1:1) = ubound(InData%Input_Saved, kind=B8Ki)
      do i1 = LB(1), UB(1)
         call AD14_PackInput(RF, InData%Input_Saved(i1)) 
      end do
   end if
   call RegPackAlloc(RF, InData%InputTimes)
   call RegPackAlloc(RF, InData%InputTimes_Saved)
...
subroutine FAST_UnPackAeroDyn14_Data(RF, OutData)
   ...
   if (IsAllocAssoc) then
      ...
      do i1 = LB(1), UB(1)
         call AD14_UnpackInput(RF, OutData%Input_Saved(i1)) ! Input_Saved 
      end do
   end if
   call RegUnpackAlloc(RF, OutData%InputTimes); if (RegCheckErr(RF, RoutineName)) return
   call RegUnpackAlloc(RF, OutData%InputTimes_Saved); if (RegCheckErr(RF, RoutineName)) return
...
subroutine FAST_CopyAeroDyn_Data(SrcAeroDyn_DataData, DstAeroDyn_DataData, CtrlCode, ErrStat, ErrMsg)
   ...
   if (allocated(SrcAeroDyn_DataData%Input_Saved)) then
      LB(1:1) = lbound(SrcAeroDyn_DataData%Input_Saved, kind=B8Ki)
      UB(1:1) = ubound(SrcAeroDyn_DataData%Input_Saved, kind=B8Ki)
   ...
   if (allocated(SrcAeroDyn_DataData%InputTimes_Saved)) then
      LB(1:1) = lbound(SrcAeroDyn_DataData%InputTimes_Saved, kind=B8Ki)
      UB(1:1) = ubound(SrcAeroDyn_DataData%InputTimes_Saved, kind=B8Ki)
...
subroutine FAST_DestroyAeroDyn_Data(AeroDyn_DataData, ErrStat, ErrMsg)
   ...
   if (allocated(AeroDyn_DataData%Input_Saved)) then
      LB(1:1) = lbound(AeroDyn_DataData%Input_Saved, kind=B8Ki)
      UB(1:1) = ubound(AeroDyn_DataData%Input_Saved, kind=B8Ki)
      do i1 = LB(1), UB(1)
...
subroutine FAST_CopyInflowWind_Data(SrcInflowWind_DataData, DstInflowWind_DataData, CtrlCode, ErrStat, ErrMsg)
   ...
   if (allocated(SrcInflowWind_DataData%Input_Saved)) then
      LB(1:1) = lbound(SrcInflowWind_DataData%Input_Saved, kind=B8Ki)
      UB(1:1) = ubound(SrcInflowWind_DataData%Input_Saved, kind=B8Ki)
   ...
   if (allocated(SrcInflowWind_DataData%InputTimes_Saved)) then
      LB(1:1) = lbound(SrcInflowWind_DataData%InputTimes_Saved, kind=B8Ki)
      UB(1:1) = ubound(SrcInflowWind_DataData%InputTimes_Saved, kind=B8Ki)
...
subroutine FAST_DestroyInflowWind_Data(InflowWind_DataData, ErrStat, ErrMsg)
   ...
   if (allocated(InflowWind_DataData%Input_Saved)) then
      LB(1:1) = lbound(InflowWind_DataData%Input_Saved, kind=B8Ki)
      UB(1:1) = ubound(InflowWind_DataData%Input_Saved, kind=B8Ki)
      do i1 = LB(1), UB(1)
...
subroutine FAST_CopySubDyn_Data(SrcSubDyn_DataData, DstSubDyn_DataData, CtrlCode, ErrStat, ErrMsg)
   ...
   if (allocated(SrcSubDyn_DataData%Input_Saved)) then
      LB(1:1) = lbound(SrcSubDyn_DataData%Input_Saved, kind=B8Ki)
      UB(1:1) = ubound(SrcSubDyn_DataData%Input_Saved, kind=B8Ki)
   ...
   if (allocated(SrcSubDyn_DataData%InputTimes_Saved)) then
      LB(1:1) = lbound(SrcSubDyn_DataData%InputTimes_Saved, kind=B8Ki)
      UB(1:1) = ubound(SrcSubDyn_DataData%InputTimes_Saved, kind=B8Ki)
...
subroutine FAST_DestroySubDyn_Data(SubDyn_DataData, ErrStat, ErrMsg)
   ...
   if (allocated(SubDyn_DataData%Input_Saved)) then
      LB(1:1) = lbound(SubDyn_DataData%Input_Saved, kind=B8Ki)
      UB(1:1) = ubound(SubDyn_DataData%Input_Saved, kind=B8Ki)
      do i1 = LB(1), UB(1)
...
subroutine FAST_CopyExtPtfm_Data(SrcExtPtfm_DataData, DstExtPtfm_DataData, CtrlCode, ErrStat, ErrMsg)
   ...
   if (allocated(SrcExtPtfm_DataData%Input_Saved)) then
      LB(1:1) = lbound(SrcExtPtfm_DataData%Input_Saved, kind=B8Ki)
      UB(1:1) = ubound(SrcExtPtfm_DataData%Input_Saved, kind=B8Ki)
   ...
   if (allocated(SrcExtPtfm_DataData%InputTimes_Saved)) then
      LB(1:1) = lbound(SrcExtPtfm_DataData%InputTimes_Saved, kind=B8Ki)
      UB(1:1) = ubound(SrcExtPtfm_DataData%InputTimes_Saved, kind=B8Ki)
...
subroutine FAST_DestroyExtPtfm_Data(ExtPtfm_DataData, ErrStat, ErrMsg)
   ...
   if (allocated(ExtPtfm_DataData%Input_Saved)) then
      LB(1:1) = lbound(ExtPtfm_DataData%Input_Saved, kind=B8Ki)
      UB(1:1) = ubound(ExtPtfm_DataData%Input_Saved, kind=B8Ki)
      do i1 = LB(1), UB(1)
...
subroutine FAST_CopySeaState_Data(SrcSeaState_DataData, DstSeaState_DataData, CtrlCode, ErrStat, ErrMsg)
   ...
   if (allocated(SrcSeaState_DataData%Input_Saved)) then
      LB(1:1) = lbound(SrcSeaState_DataData%Input_Saved, kind=B8Ki)
      UB(1:1) = ubound(SrcSeaState_DataData%Input_Saved, kind=B8Ki)
   ...
   if (allocated(SrcSeaState_DataData%InputTimes_Saved)) then
      LB(1:1) = lbound(SrcSeaState_DataData%InputTimes_Saved, kind=B8Ki)
      UB(1:1) = ubound(SrcSeaState_DataData%InputTimes_Saved, kind=B8Ki)
...
subroutine FAST_DestroySeaState_Data(SeaState_DataData, ErrStat, ErrMsg)
   ...
   if (allocated(SeaState_DataData%Input_Saved)) then
      LB(1:1) = lbound(SeaState_DataData%Input_Saved, kind=B8Ki)
      UB(1:1) = ubound(SeaState_DataData%Input_Saved, kind=B8Ki)
      do i1 = LB(1), UB(1)
...
subroutine FAST_CopyHydroDyn_Data(SrcHydroDyn_DataData, DstHydroDyn_DataData, CtrlCode, ErrStat, ErrMsg)
   ...
   if (allocated(SrcHydroDyn_DataData%Input_Saved)) then
      LB(1:1) = lbound(SrcHydroDyn_DataData%Input_Saved, kind=B8Ki)
      UB(1:1) = ubound(SrcHydroDyn_DataData%Input_Saved, kind=B8Ki)
   ...
   if (allocated(SrcHydroDyn_DataData%InputTimes_Saved)) then
      LB(1:1) = lbound(SrcHydroDyn_DataData%InputTimes_Saved, kind=B8Ki)
      UB(1:1) = ubound(SrcHydroDyn_DataData%InputTimes_Saved, kind=B8Ki)
...
subroutine FAST_DestroyHydroDyn_Data(HydroDyn_DataData, ErrStat, ErrMsg)
   ...
   if (allocated(HydroDyn_DataData%Input_Saved)) then
      LB(1:1) = lbound(HydroDyn_DataData%Input_Saved, kind=B8Ki)
      UB(1:1) = ubound(HydroDyn_DataData%Input_Saved, kind=B8Ki)
      do i1 = LB(1), UB(1)
...
subroutine FAST_CopyIceFloe_Data(SrcIceFloe_DataData, DstIceFloe_DataData, CtrlCode, ErrStat, ErrMsg)
   ...
   if (allocated(SrcIceFloe_DataData%Input_Saved)) then
      LB(1:1) = lbound(SrcIceFloe_DataData%Input_Saved, kind=B8Ki)
      UB(1:1) = ubound(SrcIceFloe_DataData%Input_Saved, kind=B8Ki)
   ...
   if (allocated(SrcIceFloe_DataData%InputTimes_Saved)) then
      LB(1:1) = lbound(SrcIceFloe_DataData%InputTimes_Saved, kind=B8Ki)
      UB(1:1) = ubound(SrcIceFloe_DataData%InputTimes_Saved, kind=B8Ki)
...
subroutine FAST_DestroyIceFloe_Data(IceFloe_DataData, ErrStat, ErrMsg)
   ...
   if (allocated(IceFloe_DataData%Input_Saved)) then
      LB(1:1) = lbound(IceFloe_DataData%Input_Saved, kind=B8Ki)
      UB(1:1) = ubound(IceFloe_DataData%Input_Saved, kind=B8Ki)
      do i1 = LB(1), UB(1)
...
subroutine FAST_CopyMAP_Data(SrcMAP_DataData, DstMAP_DataData, CtrlCode, ErrStat, ErrMsg)
   ...
   if (allocated(SrcMAP_DataData%Input_Saved)) then
      LB(1:1) = lbound(SrcMAP_DataData%Input_Saved, kind=B8Ki)
      UB(1:1) = ubound(SrcMAP_DataData%Input_Saved, kind=B8Ki)
   ...
   if (allocated(SrcMAP_DataData%InputTimes_Saved)) then
      LB(1:1) = lbound(SrcMAP_DataData%InputTimes_Saved, kind=B8Ki)
      UB(1:1) = ubound(SrcMAP_DataData%InputTimes_Saved, kind=B8Ki)
...
subroutine FAST_DestroyMAP_Data(MAP_DataData, ErrStat, ErrMsg)
   ...
   if (allocated(MAP_DataData%Input_Saved)) then
      LB(1:1) = lbound(MAP_DataData%Input_Saved, kind=B8Ki)
      UB(1:1) = ubound(MAP_DataData%Input_Saved, kind=B8Ki)
      do i1 = LB(1), UB(1)
...
subroutine FAST_CopyFEAMooring_Data(SrcFEAMooring_DataData, DstFEAMooring_DataData, CtrlCode, ErrStat, ErrMsg)
   ...
   if (allocated(SrcFEAMooring_DataData%Input_Saved)) then
      LB(1:1) = lbound(SrcFEAMooring_DataData%Input_Saved, kind=B8Ki)
      UB(1:1) = ubound(SrcFEAMooring_DataData%Input_Saved, kind=B8Ki)
   ...
   if (allocated(SrcFEAMooring_DataData%InputTimes_Saved)) then
      LB(1:1) = lbound(SrcFEAMooring_DataData%InputTimes_Saved, kind=B8Ki)
      UB(1:1) = ubound(SrcFEAMooring_DataData%InputTimes_Saved, kind=B8Ki)
...
subroutine FAST_DestroyFEAMooring_Data(FEAMooring_DataData, ErrStat, ErrMsg)
   ...
   if (allocated(FEAMooring_DataData%Input_Saved)) then
      LB(1:1) = lbound(FEAMooring_DataData%Input_Saved, kind=B8Ki)
      UB(1:1) = ubound(FEAMooring_DataData%Input_Saved, kind=B8Ki)
      do i1 = LB(1), UB(1)
...
subroutine FAST_CopyMoorDyn_Data(SrcMoorDyn_DataData, DstMoorDyn_DataData, CtrlCode, ErrStat, ErrMsg)
   ...
   if (allocated(SrcMoorDyn_DataData%Input_Saved)) then
      LB(1:1) = lbound(SrcMoorDyn_DataData%Input_Saved, kind=B8Ki)
      UB(1:1) = ubound(SrcMoorDyn_DataData%Input_Saved, kind=B8Ki)
   ...
   if (allocated(SrcMoorDyn_DataData%InputTimes_Saved)) then
      LB(1:1) = lbound(SrcMoorDyn_DataData%InputTimes_Saved, kind=B8Ki)
      UB(1:1) = ubound(SrcMoorDyn_DataData%InputTimes_Saved, kind=B8Ki)
...
subroutine FAST_DestroyMoorDyn_Data(MoorDyn_DataData, ErrStat, ErrMsg)
   ...
   if (allocated(MoorDyn_DataData%Input_Saved)) then
      LB(1:1) = lbound(MoorDyn_DataData%Input_Saved, kind=B8Ki)
      UB(1:1) = ubound(MoorDyn_DataData%Input_Saved, kind=B8Ki)
      do i1 = LB(1), UB(1)
...
subroutine FAST_CopyOrcaFlex_Data(SrcOrcaFlex_DataData, DstOrcaFlex_DataData, CtrlCode, ErrStat, ErrMsg)
   ...
   if (allocated(SrcOrcaFlex_DataData%Input_Saved)) then
      LB(1:1) = lbound(SrcOrcaFlex_DataData%Input_Saved, kind=B8Ki)
      UB(1:1) = ubound(SrcOrcaFlex_DataData%Input_Saved, kind=B8Ki)
   ...
   if (allocated(SrcOrcaFlex_DataData%InputTimes_Saved)) then
      LB(1:1) = lbound(SrcOrcaFlex_DataData%InputTimes_Saved, kind=B8Ki)
      UB(1:1) = ubound(SrcOrcaFlex_DataData%InputTimes_Saved, kind=B8Ki)
...
subroutine FAST_DestroyOrcaFlex_Data(OrcaFlex_DataData, ErrStat, ErrMsg)
   ...
   if (allocated(OrcaFlex_DataData%Input_Saved)) then
      LB(1:1) = lbound(OrcaFlex_DataData%Input_Saved, kind=B8Ki)
      UB(1:1) = ubound(OrcaFlex_DataData%Input_Saved, kind=B8Ki)
      do i1 = LB(1), UB(1)
...
subroutine FAST_CopyMisc(SrcMiscData, DstMiscData, CtrlCode, ErrStat, ErrMsg)
   type(FAST_MiscVarType), intent(inout) :: SrcMiscData
   ...
   call SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
   if (ErrStat >= AbortErrLev) return
   call FAST_CopyML_MiscVarType(SrcMiscData%ModLin, DstMiscData%ModLin, CtrlCode, ErrStat2, ErrMsg2)
   call SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
   if (ErrStat >= AbortErrLev) return
end subroutine
...
subroutine FAST_DestroyMisc(MiscData, ErrStat, ErrMsg)
   ...
   call SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
   call FAST_DestroyML_MiscVarType(MiscData%ModLin, ErrStat2, ErrMsg2)
   call SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
end subroutine
...
subroutine FAST_PackMisc(RF, Indata)
   ...
   call FAST_PackML_MiscVarType(RF, InData%ModLin) 
   if (RegCheckErr(RF, RoutineName)) return
end subroutine
...
subroutine FAST_UnPackMisc(RF, OutData)
   ...
   call FAST_UnpackML_MiscVarType(RF, OutData%ModLin) ! ModLin 
end subroutine
