...
! =========  AWAE_InputFileType  =======
  TYPE, PUBLIC :: AWAE_InputFileType
    ...
    REAL(DbKi)  :: WrPlaneDT = 0.0_R8Ki      !< Feature 2 sampling period (s); DEFAULT falls back to DT_Low [s]
...
! =========  AWAE_MiscVarType  =======
  TYPE, PUBLIC :: AWAE_MiscVarType
    ...
    INTEGER(IntKi)  :: LastPlaneSliceN = -1      !< Feature 2: last low-res step index at which planar slices were emitted; -1 initially. Guards the duplicate-emit at t=0 triggered by FARM_InitialCO calling AWAE_CalcOutput twice. [-]
    INTEGER(IntKi)  :: LastTerrainSliceN = -1      !< Feature 3: last low-res step index at which terrain slices were emitted; -1 initially. Same guard purpose as LastPlaneSliceN. [-]
