...
ENDIF
 ...
 SUBROUTINE AWAE_Input_ExtrapInterp(u, t, u_out, t_out, ErrStat, ErrMsg )
!
...
!..................................................................................................................................
 ...
 TYPE(AWAE_InputType), INTENT(IN)  :: u(:) ! Input at t1 > t2 > t3
 REAL(DbKi),                 INTENT(IN   )  :: t(:)           ! Times associated with the Inputs
 TYPE(AWAE_InputType), INTENT(INOUT)  :: u_out ! Input at tin_out
 ...
 CHARACTER(*),    PARAMETER                 :: RoutineName = 'AWAE_Input_ExtrapInterp'
    ! Initialize ErrStat
 ErrStat = ErrID_None
 ErrMsg  = ""
 ...
 order = SIZE(u) - 1
 IF ( order .eq. 0 ) THEN
   CALL AWAE_CopyInput(u(1), u_out, MESH_UPDATECOPY, ErrStat2, ErrMsg2 )
     CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
 ELSE IF ( order .eq. 1 ) THEN
   CALL AWAE_Input_ExtrapInterp1(u(1), u(2), t, u_out, t_out, ErrStat2, ErrMsg2 )
     CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
 ELSE IF ( order .eq. 2 ) THEN
   CALL AWAE_Input_ExtrapInterp2(u(1), u(2), u(3), t, u_out, t_out, ErrStat2, ErrMsg2 )
     CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
 ELSE 
   CALL SetErrStat(ErrID_Fatal,'size(u) must be less than 4 (order must be less than 3).',ErrStat,ErrMsg,RoutineName)
   RETURN
 ENDIF 
 END SUBROUTINE AWAE_Input_ExtrapInterp


 SUBROUTINE AWAE_Input_ExtrapInterp1(u1, u2, tin, u_out, tin_out, ErrStat, ErrMsg )
!
! This subroutine calculates a extrapolated (or interpolated) Input u_out at time t_out, from previous/future time
...
!..................................................................................................................................
 ...
 TYPE(AWAE_InputType), INTENT(IN)  :: u1    ! Input at t1 > t2
 TYPE(AWAE_InputType), INTENT(IN)  :: u2    ! Input at t2 
 ...
 CHARACTER(*),                    PARAMETER :: RoutineName = 'AWAE_Input_ExtrapInterp1'
...
IF (ALLOCATED(u_out%xhat_plane) .AND. ALLOCATED(u1%xhat_plane)) THEN
  DO i3 = LBOUND(u_out%xhat_plane,3),UBOUND(u_out%xhat_plane,3)
    DO i2 = LBOUND(u_out%xhat_plane,2),UBOUND(u_out%xhat_plane,2)
      DO i1 = LBOUND(u_out%xhat_plane,1),UBOUND(u_out%xhat_plane,1)
        b = -(u1%xhat_plane(i1,i2,i3) - u2%xhat_plane(i1,i2,i3))
        u_out%xhat_plane(i1,i2,i3) = u1%xhat_plane(i1,i2,i3) + b * ScaleFactor
      END DO
    END DO
  END DO
END IF ! check if allocated
IF (ALLOCATED(u_out%p_plane) .AND. ALLOCATED(u1%p_plane)) THEN
  DO i3 = LBOUND(u_out%p_plane,3),UBOUND(u_out%p_plane,3)
    DO i2 = LBOUND(u_out%p_plane,2),UBOUND(u_out%p_plane,2)
      DO i1 = LBOUND(u_out%p_plane,1),UBOUND(u_out%p_plane,1)
        b = -(u1%p_plane(i1,i2,i3) - u2%p_plane(i1,i2,i3))
        u_out%p_plane(i1,i2,i3) = u1%p_plane(i1,i2,i3) + b * ScaleFactor
      END DO
    END DO
  END DO
END IF ! check if allocated
IF (ALLOCATED(u_out%Vx_wake) .AND. ALLOCATED(u1%Vx_wake)) THEN
  DO i3 = LBOUND(u_out%Vx_wake,3),UBOUND(u_out%Vx_wake,3)
    DO i2 = LBOUND(u_out%Vx_wake,2),UBOUND(u_out%Vx_wake,2)
      DO i1 = LBOUND(u_out%Vx_wake,1),UBOUND(u_out%Vx_wake,1)
        b = -(u1%Vx_wake(i1,i2,i3) - u2%Vx_wake(i1,i2,i3))
        u_out%Vx_wake(i1,i2,i3) = u1%Vx_wake(i1,i2,i3) + b * ScaleFactor
      END DO
    END DO
  END DO
END IF ! check if allocated
IF (ALLOCATED(u_out%Vr_wake) .AND. ALLOCATED(u1%Vr_wake)) THEN
  DO i3 = LBOUND(u_out%Vr_wake,3),UBOUND(u_out%Vr_wake,3)
    DO i2 = LBOUND(u_out%Vr_wake,2),UBOUND(u_out%Vr_wake,2)
      DO i1 = LBOUND(u_out%Vr_wake,1),UBOUND(u_out%Vr_wake,1)
        b = -(u1%Vr_wake(i1,i2,i3) - u2%Vr_wake(i1,i2,i3))
        u_out%Vr_wake(i1,i2,i3) = u1%Vr_wake(i1,i2,i3) + b * ScaleFactor
      END DO
    END DO
  END DO
END IF ! check if allocated
IF (ALLOCATED(u_out%D_wake) .AND. ALLOCATED(u1%D_wake)) THEN
  DO i2 = LBOUND(u_out%D_wake,2),UBOUND(u_out%D_wake,2)
    DO i1 = LBOUND(u_out%D_wake,1),UBOUND(u_out%D_wake,1)
      b = -(u1%D_wake(i1,i2) - u2%D_wake(i1,i2))
      u_out%D_wake(i1,i2) = u1%D_wake(i1,i2) + b * ScaleFactor
    END DO
  END DO
END IF ! check if allocated
 END SUBROUTINE AWAE_Input_ExtrapInterp1


 SUBROUTINE AWAE_Input_ExtrapInterp2(u1, u2, u3, tin, u_out, tin_out, ErrStat, ErrMsg )
!
! This subroutine calculates a extrapolated (or interpolated) Input u_out at time t_out, from previous/future time
...
!..................................................................................................................................
 ...
 TYPE(AWAE_InputType), INTENT(IN)  :: u1      ! Input at t1 > t2 > t3
 TYPE(AWAE_InputType), INTENT(IN)  :: u2      ! Input at t2 > t3
 TYPE(AWAE_InputType), INTENT(IN)  :: u3      ! Input at t3
 ...
 INTEGER(IntKi)                             :: ErrStat2 ! local errors
 CHARACTER(ErrMsgLen)                       :: ErrMsg2  ! local errors
 CHARACTER(*),            PARAMETER         :: RoutineName = 'AWAE_Input_ExtrapInterp2'
 INTEGER                                    :: i01    ! dim1 level 0 counter variable for arrays of ddts
 INTEGER                                    :: i02    ! dim2 level 0 counter variable for arrays of ddts
 INTEGER                                    :: i03    ! dim3 level 0 counter variable for arrays of ddts
 INTEGER                                    :: i1    ! dim1 counter variable for arrays
...
IF (ALLOCATED(u_out%xhat_plane) .AND. ALLOCATED(u1%xhat_plane)) THEN
  DO i3 = LBOUND(u_out%xhat_plane,3),UBOUND(u_out%xhat_plane,3)
    DO i2 = LBOUND(u_out%xhat_plane,2),UBOUND(u_out%xhat_plane,2)
      DO i1 = LBOUND(u_out%xhat_plane,1),UBOUND(u_out%xhat_plane,1)
        b = (t(3)**2*(u1%xhat_plane(i1,i2,i3) - u2%xhat_plane(i1,i2,i3)) + t(2)**2*(-u1%xhat_plane(i1,i2,i3) + u3%xhat_plane(i1,i2,i3)))* scaleFactor
        c = ( (t(2)-t(3))*u1%xhat_plane(i1,i2,i3) + t(3)*u2%xhat_plane(i1,i2,i3) - t(2)*u3%xhat_plane(i1,i2,i3) ) * scaleFactor
        u_out%xhat_plane(i1,i2,i3) = u1%xhat_plane(i1,i2,i3) + b  + c * t_out
      END DO
    END DO
  END DO
END IF ! check if allocated
IF (ALLOCATED(u_out%p_plane) .AND. ALLOCATED(u1%p_plane)) THEN
  DO i3 = LBOUND(u_out%p_plane,3),UBOUND(u_out%p_plane,3)
    DO i2 = LBOUND(u_out%p_plane,2),UBOUND(u_out%p_plane,2)
      DO i1 = LBOUND(u_out%p_plane,1),UBOUND(u_out%p_plane,1)
        b = (t(3)**2*(u1%p_plane(i1,i2,i3) - u2%p_plane(i1,i2,i3)) + t(2)**2*(-u1%p_plane(i1,i2,i3) + u3%p_plane(i1,i2,i3)))* scaleFactor
        c = ( (t(2)-t(3))*u1%p_plane(i1,i2,i3) + t(3)*u2%p_plane(i1,i2,i3) - t(2)*u3%p_plane(i1,i2,i3) ) * scaleFactor
        u_out%p_plane(i1,i2,i3) = u1%p_plane(i1,i2,i3) + b  + c * t_out
      END DO
    END DO
  END DO
END IF ! check if allocated
IF (ALLOCATED(u_out%Vx_wake) .AND. ALLOCATED(u1%Vx_wake)) THEN
  DO i3 = LBOUND(u_out%Vx_wake,3),UBOUND(u_out%Vx_wake,3)
    DO i2 = LBOUND(u_out%Vx_wake,2),UBOUND(u_out%Vx_wake,2)
      DO i1 = LBOUND(u_out%Vx_wake,1),UBOUND(u_out%Vx_wake,1)
        b = (t(3)**2*(u1%Vx_wake(i1,i2,i3) - u2%Vx_wake(i1,i2,i3)) + t(2)**2*(-u1%Vx_wake(i1,i2,i3) + u3%Vx_wake(i1,i2,i3)))* scaleFactor
        c = ( (t(2)-t(3))*u1%Vx_wake(i1,i2,i3) + t(3)*u2%Vx_wake(i1,i2,i3) - t(2)*u3%Vx_wake(i1,i2,i3) ) * scaleFactor
        u_out%Vx_wake(i1,i2,i3) = u1%Vx_wake(i1,i2,i3) + b  + c * t_out
      END DO
    END DO
  END DO
END IF ! check if allocated
IF (ALLOCATED(u_out%Vr_wake) .AND. ALLOCATED(u1%Vr_wake)) THEN
  DO i3 = LBOUND(u_out%Vr_wake,3),UBOUND(u_out%Vr_wake,3)
    DO i2 = LBOUND(u_out%Vr_wake,2),UBOUND(u_out%Vr_wake,2)
      DO i1 = LBOUND(u_out%Vr_wake,1),UBOUND(u_out%Vr_wake,1)
        b = (t(3)**2*(u1%Vr_wake(i1,i2,i3) - u2%Vr_wake(i1,i2,i3)) + t(2)**2*(-u1%Vr_wake(i1,i2,i3) + u3%Vr_wake(i1,i2,i3)))* scaleFactor
        c = ( (t(2)-t(3))*u1%Vr_wake(i1,i2,i3) + t(3)*u2%Vr_wake(i1,i2,i3) - t(2)*u3%Vr_wake(i1,i2,i3) ) * scaleFactor
        u_out%Vr_wake(i1,i2,i3) = u1%Vr_wake(i1,i2,i3) + b  + c * t_out
      END DO
    END DO
  END DO
END IF ! check if allocated
IF (ALLOCATED(u_out%D_wake) .AND. ALLOCATED(u1%D_wake)) THEN
  DO i2 = LBOUND(u_out%D_wake,2),UBOUND(u_out%D_wake,2)
    DO i1 = LBOUND(u_out%D_wake,1),UBOUND(u_out%D_wake,1)
      b = (t(3)**2*(u1%D_wake(i1,i2) - u2%D_wake(i1,i2)) + t(2)**2*(-u1%D_wake(i1,i2) + u3%D_wake(i1,i2)))* scaleFactor
      c = ( (t(2)-t(3))*u1%D_wake(i1,i2) + t(3)*u2%D_wake(i1,i2) - t(2)*u3%D_wake(i1,i2) ) * scaleFactor
      u_out%D_wake(i1,i2) = u1%D_wake(i1,i2) + b  + c * t_out
    END DO
  END DO
END IF ! check if allocated
 END SUBROUTINE AWAE_Input_ExtrapInterp2


 SUBROUTINE AWAE_Output_ExtrapInterp(y, t, y_out, t_out, ErrStat, ErrMsg )
!
...
!..................................................................................................................................
 ...
 TYPE(AWAE_OutputType), INTENT(IN)  :: y(:) ! Output at t1 > t2 > t3
 REAL(DbKi),                 INTENT(IN   )  :: t(:)           ! Times associated with the Outputs
 TYPE(AWAE_OutputType), INTENT(INOUT)  :: y_out ! Output at tin_out
 REAL(DbKi),                 INTENT(IN   )  :: t_out           ! time to be extrap/interp'd to
 INTEGER(IntKi),             INTENT(  OUT)  :: ErrStat         ! Error status of the operation
 CHARACTER(*),               INTENT(  OUT)  :: ErrMsg          ! Error message if ErrStat /= ErrID_None
   ! local variables
 ...
 INTEGER(IntKi)                             :: ErrStat2        ! local errors
 CHARACTER(ErrMsgLen)                       :: ErrMsg2         ! local errors
 CHARACTER(*),    PARAMETER                 :: RoutineName = 'AWAE_Output_ExtrapInterp'
    ! Initialize ErrStat
 ErrStat = ErrID_None
 ErrMsg  = ""
 ...
 order = SIZE(y) - 1
 IF ( order .eq. 0 ) THEN
   CALL AWAE_CopyOutput(y(1), y_out, MESH_UPDATECOPY, ErrStat2, ErrMsg2 )
     CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
 ELSE IF ( order .eq. 1 ) THEN
   CALL AWAE_Output_ExtrapInterp1(y(1), y(2), t, y_out, t_out, ErrStat2, ErrMsg2 )
     CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
 ELSE IF ( order .eq. 2 ) THEN
   CALL AWAE_Output_ExtrapInterp2(y(1), y(2), y(3), t, y_out, t_out, ErrStat2, ErrMsg2 )
     CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
 ELSE 
   CALL SetErrStat(ErrID_Fatal,'size(y) must be less than 4 (order must be less than 3).',ErrStat,ErrMsg,RoutineName)
   RETURN
 ENDIF 
 END SUBROUTINE AWAE_Output_ExtrapInterp


 SUBROUTINE AWAE_Output_ExtrapInterp1(y1, y2, tin, y_out, tin_out, ErrStat, ErrMsg )
!
! This subroutine calculates a extrapolated (or interpolated) Output y_out at time t_out, from previous/future time
...
!..................................................................................................................................
 ...
 TYPE(AWAE_OutputType), INTENT(IN)  :: y1    ! Output at t1 > t2
 TYPE(AWAE_OutputType), INTENT(IN)  :: y2    ! Output at t2 
 ...
 REAL(DbKi)                                 :: t_out    ! Time to which to be extrap/interpd
 CHARACTER(*),                    PARAMETER :: RoutineName = 'AWAE_Output_ExtrapInterp1'
 REAL(DbKi)                                 :: b        ! temporary for extrapolation/interpolation
 REAL(DbKi)                                 :: ScaleFactor ! temporary for extrapolation/interpolation
 INTEGER(IntKi)                             :: ErrStat2 ! local errors
 CHARACTER(ErrMsgLen)                       :: ErrMsg2  ! local errors
 ...
 INTEGER                                    :: i5    ! dim5 counter variable for arrays
    ! Initialize ErrStat
 ErrStat = ErrID_None
 ErrMsg  = ""
    ! we'll subtract a constant from the times to resolve some 
 ...
 t_out = tin_out - tin(1)
   ...
   ScaleFactor = t_out / t(2)
IF (ALLOCATED(y_out%Vdist_High) .AND. ALLOCATED(y1%Vdist_High)) THEN
  DO i01 = LBOUND(y_out%Vdist_High,1),UBOUND(y_out%Vdist_High,1)
IF (ALLOCATED(y_out%Vdist_High(i01)%data) .AND. ALLOCATED(y1%Vdist_High(i01)%data)) THEN
  DO i5 = LBOUND(y_out%Vdist_High(i01)%data,5),UBOUND(y_out%Vdist_High(i01)%data,5)
    DO i4 = LBOUND(y_out%Vdist_High(i01)%data,4),UBOUND(y_out%Vdist_High(i01)%data,4)
      DO i3 = LBOUND(y_out%Vdist_High(i01)%data,3),UBOUND(y_out%Vdist_High(i01)%data,3)
        DO i2 = LBOUND(y_out%Vdist_High(i01)%data,2),UBOUND(y_out%Vdist_High(i01)%data,2)
          DO i1 = LBOUND(y_out%Vdist_High(i01)%data,1),UBOUND(y_out%Vdist_High(i01)%data,1)
            b = -(y1%Vdist_High(i01)%data(i1,i2,i3,i4,i5) - y2%Vdist_High(i01)%data(i1,i2,i3,i4,i5))
            y_out%Vdist_High(i01)%data(i1,i2,i3,i4,i5) = y1%Vdist_High(i01)%data(i1,i2,i3,i4,i5) + b * ScaleFactor
          END DO
        END DO
      END DO
    END DO
...
END IF ! check if allocated
  ENDDO
END IF ! check if allocated
IF (ALLOCATED(y_out%V_plane) .AND. ALLOCATED(y1%V_plane)) THEN
  DO i3 = LBOUND(y_out%V_plane,3),UBOUND(y_out%V_plane,3)
    DO i2 = LBOUND(y_out%V_plane,2),UBOUND(y_out%V_plane,2)
      DO i1 = LBOUND(y_out%V_plane,1),UBOUND(y_out%V_plane,1)
        b = -(y1%V_plane(i1,i2,i3) - y2%V_plane(i1,i2,i3))
        y_out%V_plane(i1,i2,i3) = y1%V_plane(i1,i2,i3) + b * ScaleFactor
      END DO
    END DO
  END DO
END IF ! check if allocated
IF (ALLOCATED(y_out%TI_amb) .AND. ALLOCATED(y1%TI_amb)) THEN
  DO i1 = LBOUND(y_out%TI_amb,1),UBOUND(y_out%TI_amb,1)
    b = -(y1%TI_amb(i1) - y2%TI_amb(i1))
    y_out%TI_amb(i1) = y1%TI_amb(i1) + b * ScaleFactor
  END DO
END IF ! check if allocated
IF (ALLOCATED(y_out%Vx_wind_disk) .AND. ALLOCATED(y1%Vx_wind_disk)) THEN
  DO i1 = LBOUND(y_out%Vx_wind_disk,1),UBOUND(y_out%Vx_wind_disk,1)
    b = -(y1%Vx_wind_disk(i1) - y2%Vx_wind_disk(i1))
    y_out%Vx_wind_disk(i1) = y1%Vx_wind_disk(i1) + b * ScaleFactor
  END DO
END IF ! check if allocated
 END SUBROUTINE AWAE_Output_ExtrapInterp1


 SUBROUTINE AWAE_Output_ExtrapInterp2(y1, y2, y3, tin, y_out, tin_out, ErrStat, ErrMsg )
!
! This subroutine calculates a extrapolated (or interpolated) Output y_out at time t_out, from previous/future time
...
!..................................................................................................................................
 ...
 TYPE(AWAE_OutputType), INTENT(IN)  :: y1      ! Output at t1 > t2 > t3
 TYPE(AWAE_OutputType), INTENT(IN)  :: y2      ! Output at t2 > t3
 TYPE(AWAE_OutputType), INTENT(IN)  :: y3      ! Output at t3
 ...
 INTEGER(IntKi)                             :: ErrStat2 ! local errors
 CHARACTER(ErrMsgLen)                       :: ErrMsg2  ! local errors
 CHARACTER(*),            PARAMETER         :: RoutineName = 'AWAE_Output_ExtrapInterp2'
 INTEGER                                    :: i01    ! dim1 level 0 counter variable for arrays of ddts
 INTEGER                                    :: i02    ! dim2 level 0 counter variable for arrays of ddts
 INTEGER                                    :: i03    ! dim3 level 0 counter variable for arrays of ddts
 INTEGER                                    :: i04    ! dim4 level 0 counter variable for arrays of ddts
  ...
  DO i5 = LBOUND(y_out%Vdist_High(i01)%data,5),UBOUND(y_out%Vdist_High(i01)%data,5)
    DO i4 = LBOUND(y_out%Vdist_High(i01)%data,4),UBOUND(y_out%Vdist_High(i01)%data,4)
      DO i3 = LBOUND(y_out%Vdist_High(i01)%data,3),UBOUND(y_out%Vdist_High(i01)%data,3)
        DO i2 = LBOUND(y_out%Vdist_High(i01)%data,2),UBOUND(y_out%Vdist_High(i01)%data,2)
          DO i1 = LBOUND(y_out%Vdist_High(i01)%data,1),UBOUND(y_out%Vdist_High(i01)%data,1)
            b = (t(3)**2*(y1%Vdist_High(i01)%data(i1,i2,i3,i4,i5) - y2%Vdist_High(i01)%data(i1,i2,i3,i4,i5)) + t(2)**2*(-y1%Vdist_High(i01)%data(i1,i2,i3,i4,i5) + y3%Vdist_High(i01)%data(i1,i2,i3,i4,i5)))* scaleFactor
            c = ( (t(2)-t(3))*y1%Vdist_High(i01)%data(i1,i2,i3,i4,i5) + t(3)*y2%Vdist_High(i01)%data(i1,i2,i3,i4,i5) - t(2)*y3%Vdist_High(i01)%data(i1,i2,i3,i4,i5) ) * scaleFactor
            y_out%Vdist_High(i01)%data(i1,i2,i3,i4,i5) = y1%Vdist_High(i01)%data(i1,i2,i3,i4,i5) + b  + c * t_out
          END DO
        END DO
      END DO
    END DO
...
IF (ALLOCATED(y_out%V_plane) .AND. ALLOCATED(y1%V_plane)) THEN
  DO i3 = LBOUND(y_out%V_plane,3),UBOUND(y_out%V_plane,3)
    DO i2 = LBOUND(y_out%V_plane,2),UBOUND(y_out%V_plane,2)
      DO i1 = LBOUND(y_out%V_plane,1),UBOUND(y_out%V_plane,1)
        b = (t(3)**2*(y1%V_plane(i1,i2,i3) - y2%V_plane(i1,i2,i3)) + t(2)**2*(-y1%V_plane(i1,i2,i3) + y3%V_plane(i1,i2,i3)))* scaleFactor
        c = ( (t(2)-t(3))*y1%V_plane(i1,i2,i3) + t(3)*y2%V_plane(i1,i2,i3) - t(2)*y3%V_plane(i1,i2,i3) ) * scaleFactor
        y_out%V_plane(i1,i2,i3) = y1%V_plane(i1,i2,i3) + b  + c * t_out
      END DO
    END DO
  END DO
END IF ! check if allocated
IF (ALLOCATED(y_out%TI_amb) .AND. ALLOCATED(y1%TI_amb)) THEN
  DO i1 = LBOUND(y_out%TI_amb,1),UBOUND(y_out%TI_amb,1)
    b = (t(3)**2*(y1%TI_amb(i1) - y2%TI_amb(i1)) + t(2)**2*(-y1%TI_amb(i1) + y3%TI_amb(i1)))* scaleFactor
    c = ( (t(2)-t(3))*y1%TI_amb(i1) + t(3)*y2%TI_amb(i1) - t(2)*y3%TI_amb(i1) ) * scaleFactor
    y_out%TI_amb(i1) = y1%TI_amb(i1) + b  + c * t_out
  END DO
END IF ! check if allocated
IF (ALLOCATED(y_out%Vx_wind_disk) .AND. ALLOCATED(y1%Vx_wind_disk)) THEN
  DO i1 = LBOUND(y_out%Vx_wind_disk,1),UBOUND(y_out%Vx_wind_disk,1)
    b = (t(3)**2*(y1%Vx_wind_disk(i1) - y2%Vx_wind_disk(i1)) + t(2)**2*(-y1%Vx_wind_disk(i1) + y3%Vx_wind_disk(i1)))* scaleFactor
    c = ( (t(2)-t(3))*y1%Vx_wind_disk(i1) + t(3)*y2%Vx_wind_disk(i1) - t(2)*y3%Vx_wind_disk(i1) ) * scaleFactor
    y_out%Vx_wind_disk(i1) = y1%Vx_wind_disk(i1) + b  + c * t_out
  END DO
END IF ! check if allocated
 END SUBROUTINE AWAE_Output_ExtrapInterp2
