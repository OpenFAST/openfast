...
contains
   ...
   subroutine Write_Planes_Data()
      ...
      pWidth = max(1, int(floor(log10(real(max(p%MaxPlanes, 1), ReKi))) + 1, IntKi))
      write(FmtStr, '(A,I0,A,I0,A)') '(I', pWidth, '.', pWidth, ')'
