...
! ===================================================================================================
! This code was generated by Write_ChckOutLst.m at 26-Jul-2021 14:11:49.
   ...
   INTEGER(IntKi), PARAMETER      :: MaxOutPts = 90

!End of code generated by Matlab script
! ===================================================================================================


   REAL(ReKi)               :: AllOuts(MaxSeaStOutputs)          ! Array of all possible outputs
  ...
  CHARACTER(OutStrLenM1), PARAMETER  :: ValidParamAry(90) =  (/  &   ! This lists the names of the allowed parameters, which must be sorted alphabetically
                               "FACC1XI  ","FACC1YI  ","FACC1ZI  ","FACC2XI  ","FACC2YI  ","FACC2ZI  ","FACC3XI  ","FACC3YI  ", &
                               "FACC3ZI  ","FACC4XI  ","FACC4YI  ","FACC4ZI  ","FACC5XI  ","FACC5YI  ","FACC5ZI  ","FACC6XI  ", &
                               "FACC6YI  ","FACC6ZI  ","FACC7XI  ","FACC7YI  ","FACC7ZI  ","FACC8XI  ","FACC8YI  ","FACC8ZI  ", &
                               "FACC9XI  ","FACC9YI  ","FACC9ZI  ","FDYNP1   ","FDYNP2   ","FDYNP3   ","FDYNP4   ","FDYNP5   ", &
                               "FDYNP6   ","FDYNP7   ","FDYNP8   ","FDYNP9   ","FVEL1XI  ","FVEL1YI  ","FVEL1ZI  ","FVEL2XI  ", &
                               "FVEL2YI  ","FVEL2ZI  ","FVEL3XI  ","FVEL3YI  ","FVEL3ZI  ","FVEL4XI  ","FVEL4YI  ","FVEL4ZI  ", &
                               "FVEL5XI  ","FVEL5YI  ","FVEL5ZI  ","FVEL6XI  ","FVEL6YI  ","FVEL6ZI  ","FVEL7XI  ","FVEL7YI  ", &
                               "FVEL7ZI  ","FVEL8XI  ","FVEL8YI  ","FVEL8ZI  ","FVEL9XI  ","FVEL9YI  ","FVEL9ZI  ","WAVE1ELEV", &
                               "WAVE1ELV1","WAVE1ELV2","WAVE2ELEV","WAVE2ELV1","WAVE2ELV2","WAVE3ELEV","WAVE3ELV1","WAVE3ELV2", &
                               "WAVE4ELEV","WAVE4ELV1","WAVE4ELV2","WAVE5ELEV","WAVE5ELV1","WAVE5ELV2","WAVE6ELEV","WAVE6ELV1", &
                               "WAVE6ELV2","WAVE7ELEV","WAVE7ELV1","WAVE7ELV2","WAVE8ELEV","WAVE8ELV1","WAVE8ELV2","WAVE9ELEV", &
                               "WAVE9ELV1","WAVE9ELV2"/)
   INTEGER(IntKi), PARAMETER :: ParamIndxAry(90) =  (/ &                            ! This lists the index into AllOuts(:) of the allowed parameters ValidParamAry(:)
                                  FAcc1xi ,   FAcc1yi ,   FAcc1zi ,   FAcc2xi ,   FAcc2yi ,   FAcc2zi ,   FAcc3xi ,   FAcc3yi , &
                                  FAcc3zi ,   FAcc4xi ,   FAcc4yi ,   FAcc4zi ,   FAcc5xi ,   FAcc5yi ,   FAcc5zi ,   FAcc6xi , &
                                  FAcc6yi ,   FAcc6zi ,   FAcc7xi ,   FAcc7yi ,   FAcc7zi ,   FAcc8xi ,   FAcc8yi ,   FAcc8zi , &
                                  FAcc9xi ,   FAcc9yi ,   FAcc9zi ,    FDynP1 ,    FDynP2 ,    FDynP3 ,    FDynP4 ,    FDynP5 , &
                                ...
                                Wave6Elv2 , Wave7Elev , Wave7Elv1 , Wave7Elv2 , Wave8Elev , Wave8Elv1 , Wave8Elv2 , Wave9Elev , &
                                Wave9Elv1 , Wave9Elv2 /)
   CHARACTER(ChanLen), PARAMETER :: ParamUnitsAry(90) =  (/  &  ! This lists the units corresponding to the allowed parameters
                               "(m/s^2)","(m/s^2)","(m/s^2)","(m/s^2)","(m/s^2)","(m/s^2)","(m/s^2)","(m/s^2)", &
                               "(m/s^2)","(m/s^2)","(m/s^2)","(m/s^2)","(m/s^2)","(m/s^2)","(m/s^2)","(m/s^2)", &
                               "(m/s^2)","(m/s^2)","(m/s^2)","(m/s^2)","(m/s^2)","(m/s^2)","(m/s^2)","(m/s^2)", &
                               "(m/s^2)","(m/s^2)","(m/s^2)","(Pa)   ","(Pa)   ","(Pa)   ","(Pa)   ","(Pa)   ", &
...
!====================================================================================================
SUBROUTINE SeaStOut_CloseSum( UnSum, ErrStat, ErrMsg )


      ! Passed variables
      
   INTEGER,                 INTENT( IN    )   :: UnSum                ! the unit number for the SeaState summary file          
...
END SUBROUTINE SeaStOut_CloseSum            

!====================================================================================================
SUBROUTINE SeaStOut_OpenSum( UnSum, SummaryName, SeaSt_Prog, ErrStat, ErrMsg )


      ! Passed variables
      
   INTEGER,                 INTENT(   OUT )   :: UnSum                ! the unit number for the SeaState summary file          
   CHARACTER(*),            INTENT( IN    )   :: SummaryName          ! the name of the SeaState summary file
   ...
   WRITE (UnSum,'(/,A/)', IOSTAT=ErrStat)  'This summary file was generated by '//TRIM( SeaSt_Prog%Name )//&
...
subroutine SeaStOut_WriteWaveElev0( Rootname, SeaSt_Prog, NStepWave, WaveDT, NGrid, WaveElev1, WaveElev2, WaveTime, ErrStat, ErrMsg )
...
!====================================================================================================
subroutine SeaStOut_MapOutputs(  p, NWaveElev, WaveElev, WaveElev1, WaveElev2, NWaveKin, WaveVel, WaveAcc, WaveDynP, AllOuts, ErrStat, ErrMsg )
...
!----------------------------------------------------------------------------------------------------
   ...
   if ( MaxOutPts /= MaxSeaStOutputs ) then
      call SetErrStat(ErrID_Fatal, ' SeaState outputs: the number of outputs given by the Write_ChckOutList.m '// &
         'script using the xlsx file does not match the number of outputs given by the SeaState.txt registry '// &
         'file.', ErrStat, ErrMsg, 'SeaStOUT_Init')
      return
   endif
...
!====================================================================================================
FUNCTION   SeaStOut_GetChannels    ( NUserOutputs, UserOutputs, OutList, foundMask, ErrStat, ErrMsg )
...
!----------------------------------------------------------------------------------------------------    
   ...
   INTEGER                                           SeaStOut_GetChannels     ! The number of channels found in this module
   ...
   newFoundMask    = .FALSE.
    ...
    DO I = 1,NUserOutputs
      ...
      IF ( Indx > 0 ) THEN     
            newFoundMask(I)    = .TRUE.
            foundMask(I)       = .TRUE.
            SeaStOut_GetChannels = SeaStOut_GetChannels + 1
...
IF ( SeaStOut_GetChannels > 0 ) THEN
   
   count = 1
   
   IF ( ErrStat /= 0 )  THEN
      ErrMsg  = ' Error allocating memory for the OutList array in the GetSeaStateChannels function.'
      ErrStat = ErrID_Fatal
      RETURN
   END IF
...
END FUNCTION SeaStOut_GetChannels

!====================================================================================================
SUBROUTINE SeaStOut_ChkOutLst( OutList, y, p, ErrStat, ErrMsg )
...
! Note that the SeaState module must be initialized prior to calling this function (if it
...
!   INTEGER                                :: J                                         ! Generic loop-counting index.
   ...
   CHARACTER(ChanLen)                     :: OutListTmp                                ! A string to temporarily hold OutList(I).
   CHARACTER(28), PARAMETER               :: OutPFmt = "( I4, 3X,A 10,1 X, A10 )"      ! Output format parameter output list.
   LOGICAL                                :: InvalidOutput(MaxSeaStOutputs)               ! This array determines if the output channel is valid for this configuration
   LOGICAL                                :: CheckOutListAgain
...
END SUBROUTINE SeaStOut_ChkOutLst
