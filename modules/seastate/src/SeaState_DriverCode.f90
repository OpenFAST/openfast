...
!         ' on '//CurDate()//' at '//CurTime()//'.'
   ...
   write (WaveElevFileUn,'(A)', IOSTAT=ErrStatTmp  )  '# MaxWaveElev =  '//TRIM(Num2LStr(MAXVAL(SeaState_p%WaveElev)))
   write (WaveElevFileUn,'(A)', IOSTAT=ErrStatTmp  )  '# MinWaveElev =  '//TRIM(Num2LStr(MINVAL(SeaState_p%WaveElev)))
   write (WaveElevFileUn,'(A)', IOSTAT=ErrStatTmp  )  '# '
