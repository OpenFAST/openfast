...
subroutine test_BD_diffmtc_suite(testsuite)
    type(unittest_type), allocatable, intent(out) :: testsuite(:)
    testsuite = [ &
                new_unittest("test_BD_diffmtc_2node", test_BD_diffmtc_2node), &
                new_unittest("test_BD_diffmtc_5node", test_BD_diffmtc_5node) &
                ]
 end subroutine

subroutine test_BD_diffmtc_2node(error)
...
subroutine test_BD_diffmtc_5node(error)
    type(error_type), allocatable, intent(out) :: error
