...
contains
    ...
    subroutine test_BD_MemberEta_5node()
        ...
        ! total length of beam calculated in mathematica
        ...
        baseline_total_length = 5.626918236484061    ! this is approximation with 5-point gauss quadrature; 0.005% error
        baseline_member_eta(1) = 1.                  ! just one element
