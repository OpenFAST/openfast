...
private
public :: test_BD_MemberEta_suite

contains

!> Collect all exported unit tests
subroutine test_BD_MemberEta_suite(testsuite)
    type(unittest_type), allocatable, intent(out) :: testsuite(:)
    testsuite = [ &
                new_unittest("test_BD_MemberEta_5node", test_BD_MemberEta_5node) &
                ]
 end subroutine

subroutine test_BD_MemberEta_5node(error)
