...
contains
    ...
    @test
    subroutine test_BD_InitShpDerJaco_3node()
        ! branches to test
        ...
        ! Allocate memory for baseline results FIXME -- seems like arguments reversed
        ...
        ! Allocate memory for relevant variables belonging to module p FIXME -- seems like arguments reversed; work becuase nodes_per_elem = nqp = 1
        ...
        call AllocAry(p%Jacobian , p%elem_total    , p%nqp, 'Jacobian' , ErrStat, ErrMsg)  ! reversed arguments? 
    ...
    subroutine test_BD_InitShpDerJaco_5node()
        ...
        ! baseline quadrature points and weights
        ...
        ! assign baseline jacobian based on example as described above
        baseline_jacobian(1:p%nqp,p%elem_total) = (/ 0.6715870058501458, 1.509599209717604, 2.861380785564901, 4.097191592895223, 4.880926263217582 /)
