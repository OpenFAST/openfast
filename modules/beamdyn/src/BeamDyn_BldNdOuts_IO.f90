...
MODULE BeamDyn_BldNdOuts_IO
   ...
   INTEGER(IntKi), PARAMETER      :: OutStrLenM1 = ChanLen-5    ! We are making these of the form B1_Z######y_quantity, but note that the glue code adds the "B1_" (turbine component) part
...
SUBROUTINE BldNdOuts_InitOut( InitOut, p, ErrStat, ErrMsg )
   ...
   CHARACTER(3), ALLOCATABLE                    :: DistStr(:)                       ! Array of prefix (Z######y)
   ...
   CHARACTER(*), PARAMETER                      :: RoutineName = ('BldNdOuts_InitOut')
      ...
      ALLOCATE( DistStr(size(p%BldNd_BlOutNd)), STAT=ErrStat2)
         ...
         ! Warn if we will run into issues with more than 999999 nodes.
      IF (p%node_total > 99 ) CALL SetErrStat(ErrID_Severe,'More than 99 blade nodes in use.  Output channel headers will not '// &
