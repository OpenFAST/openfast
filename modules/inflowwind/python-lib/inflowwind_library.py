...
class DebugOut():
    ...
    def __init__(self, filename, numWindPts):
        ...
        self.debug_file.write(f"## This file was generated by InflowWind_Driver on {dt_string.strftime('%b-%d-%Y')} at {t_string.strftime('%H:%M:%S')}\n")
        self.debug_file.write(f"## This file contains the wind velocity at the {numWindPts} points specified in the file ")
        self.debug_file.write(f"{filename}\n")
        self.debug_file.write("#\n")
        self.debug_file.write("#        T                X                Y                Z                U                V                W\n")
        self.debug_file.write("#       (s)              (m)              (m)              (m)             (m/s)            (m/s)            (m/s)\n")
        self.opened = True
...
class WriteOutChans():
    ...
    def __init__(self,filename,chan_names,chan_units):
        ...
        t_string=datetime.datetime.now()
        dt_string=datetime.date.today()
        self.out_file.write(f"## This file was generated by InflowWind_Driver on {dt_string.strftime('%b-%d-%Y')} at {t_string.strftime('%H:%M:%S')}\n")
    ...
    def write(self,chan_data):
        ...
        for i in range(chan_data.shape[0]):
            self.out_file.write(f_string.format(*chan_data[i,:]) + '\n')
