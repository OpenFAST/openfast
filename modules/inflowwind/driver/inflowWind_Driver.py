...
# Inputs
library_path = "./IFW_C_INTERFACE.so"
time = 10
input_file_string = np.char.array((55,128))
input_file_string = ([
...
ifwlib.ifw_init(input_file_string)
...
# ifwlib = inflowwind_library.InflowWindLibAPI(library_path, create_string_buffer(input_file_name.encode('utf-8')))
