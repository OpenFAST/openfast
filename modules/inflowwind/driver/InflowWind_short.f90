...
!----------------------------------------------------------------------------------------------------
SUBROUTINE InflowWind_Init(InitInp, ErrStat, ErrMsg)
...
PRINT*, "MADE IT THROUGH INITIALIZATION"
...
PRINT*, "BEGINNING TO READ THE INPUT FILE" 
...
!      SumFileName   = TRIM(p%RootFileName)//".sum"
      ...
      EchoFileName  = "TEST.ech"
      SumFileName   = "TEST.sum"
...
PRINT*, "STOPPED HERE, SHOULD RETURN"
