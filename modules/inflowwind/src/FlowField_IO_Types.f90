...
! =======================
! =========  Grid3DInitInputType  =======
  TYPE, PUBLIC :: Grid3DInitInputType
...
! =========  HAWCInitInputType  =======
  TYPE, PUBLIC :: HAWCInitInputType
    ...
    TYPE(Grid3DInitInputType)  :: G3D      !< Grid3D initialization input [-]
...
! 
 ...
 SUBROUTINE FlowField_IO_CopyGrid3DInitInputType( SrcGrid3DInitInputTypeData, DstGrid3DInitInputTypeData, CtrlCode, ErrStat, ErrMsg )
   TYPE(Grid3DInitInputType), INTENT(IN) :: SrcGrid3DInitInputTypeData
   TYPE(Grid3DInitInputType), INTENT(INOUT) :: DstGrid3DInitInputTypeData
   INTEGER(IntKi),  INTENT(IN   ) :: CtrlCode
   INTEGER(IntKi),  INTENT(  OUT) :: ErrStat
   CHARACTER(*),    INTENT(  OUT) :: ErrMsg
! Local 
   ...
   INTEGER(IntKi)                 :: ErrStat2
   CHARACTER(ErrMsgLen)           :: ErrMsg2
   CHARACTER(*), PARAMETER        :: RoutineName = 'FlowField_IO_CopyGrid3DInitInputType'
! 
   ErrStat = ErrID_None
   ErrMsg  = ""
    DstGrid3DInitInputTypeData%ScaleMethod = SrcGrid3DInitInputTypeData%ScaleMethod
    DstGrid3DInitInputTypeData%SF = SrcGrid3DInitInputTypeData%SF
    DstGrid3DInitInputTypeData%SigmaF = SrcGrid3DInitInputTypeData%SigmaF
    DstGrid3DInitInputTypeData%WindProfileType = SrcGrid3DInitInputTypeData%WindProfileType
    DstGrid3DInitInputTypeData%RefHt = SrcGrid3DInitInputTypeData%RefHt
    DstGrid3DInitInputTypeData%URef = SrcGrid3DInitInputTypeData%URef
    DstGrid3DInitInputTypeData%PLExp = SrcGrid3DInitInputTypeData%PLExp
    DstGrid3DInitInputTypeData%VLinShr = SrcGrid3DInitInputTypeData%VLinShr
    DstGrid3DInitInputTypeData%HLinShr = SrcGrid3DInitInputTypeData%HLinShr
    DstGrid3DInitInputTypeData%RefLength = SrcGrid3DInitInputTypeData%RefLength
    DstGrid3DInitInputTypeData%Z0 = SrcGrid3DInitInputTypeData%Z0
    DstGrid3DInitInputTypeData%XOffset = SrcGrid3DInitInputTypeData%XOffset
 END SUBROUTINE FlowField_IO_CopyGrid3DInitInputType

 SUBROUTINE FlowField_IO_DestroyGrid3DInitInputType( Grid3DInitInputTypeData, ErrStat, ErrMsg, DEALLOCATEpointers )
  TYPE(Grid3DInitInputType), INTENT(INOUT) :: Grid3DInitInputTypeData
  INTEGER(IntKi),  INTENT(  OUT) :: ErrStat
  CHARACTER(*),    INTENT(  OUT) :: ErrMsg
  LOGICAL,OPTIONAL,INTENT(IN   ) :: DEALLOCATEpointers
  ...
  INTEGER(IntKi)                 :: ErrStat2
  CHARACTER(ErrMsgLen)           :: ErrMsg2
  CHARACTER(*),    PARAMETER :: RoutineName = 'FlowField_IO_DestroyGrid3DInitInputType'
 ...
 END SUBROUTINE FlowField_IO_DestroyGrid3DInitInputType

 SUBROUTINE FlowField_IO_PackGrid3DInitInputType( ReKiBuf, DbKiBuf, IntKiBuf, Indata, ErrStat, ErrMsg, SizeOnly )
  REAL(ReKi),       ALLOCATABLE, INTENT(  OUT) :: ReKiBuf(:)
  REAL(DbKi),       ALLOCATABLE, INTENT(  OUT) :: DbKiBuf(:)
  INTEGER(IntKi),   ALLOCATABLE, INTENT(  OUT) :: IntKiBuf(:)
  TYPE(Grid3DInitInputType),  INTENT(IN) :: InData
  INTEGER(IntKi),   INTENT(  OUT) :: ErrStat
  CHARACTER(*),     INTENT(  OUT) :: ErrMsg
  LOGICAL,OPTIONAL, INTENT(IN   ) :: SizeOnly
    ! Local variables
  ...
  INTEGER(IntKi)                 :: ErrStat2
  CHARACTER(ErrMsgLen)           :: ErrMsg2
  CHARACTER(*), PARAMETER        :: RoutineName = 'FlowField_IO_PackGrid3DInitInputType'
 ! buffers to store subtypes, if any
  REAL(ReKi),      ALLOCATABLE   :: Re_Buf(:)
  REAL(DbKi),      ALLOCATABLE   :: Db_Buf(:)
  INTEGER(IntKi),  ALLOCATABLE   :: Int_Buf(:)
  ...
  Int_Xferred = 1
    ...
    Re_Xferred = Re_Xferred + 1
 END SUBROUTINE FlowField_IO_PackGrid3DInitInputType

 SUBROUTINE FlowField_IO_UnPackGrid3DInitInputType( ReKiBuf, DbKiBuf, IntKiBuf, Outdata, ErrStat, ErrMsg )
  REAL(ReKi),      ALLOCATABLE, INTENT(IN   ) :: ReKiBuf(:)
  REAL(DbKi),      ALLOCATABLE, INTENT(IN   ) :: DbKiBuf(:)
  INTEGER(IntKi),  ALLOCATABLE, INTENT(IN   ) :: IntKiBuf(:)
  TYPE(Grid3DInitInputType), INTENT(INOUT) :: OutData
  INTEGER(IntKi),  INTENT(  OUT) :: ErrStat
  CHARACTER(*),    INTENT(  OUT) :: ErrMsg
    ! Local variables
  INTEGER(IntKi)                 :: Buf_size
  ...
  INTEGER(IntKi)                 :: ErrStat2
  CHARACTER(ErrMsgLen)           :: ErrMsg2
  CHARACTER(*), PARAMETER        :: RoutineName = 'FlowField_IO_UnPackGrid3DInitInputType'
 ! buffers to store meshes, if any
  REAL(ReKi),      ALLOCATABLE   :: Re_Buf(:)
  REAL(DbKi),      ALLOCATABLE   :: Db_Buf(:)
  INTEGER(IntKi),  ALLOCATABLE   :: Int_Buf(:)
  ...
  Int_Xferred  = 1
    ...
    Re_Xferred = Re_Xferred + 1
 END SUBROUTINE FlowField_IO_UnPackGrid3DInitInputType
...
! 
   ...
   ErrMsg  = ""
    ...
    DstBladedInitInputTypeData%FixedWindFileRootName = SrcBladedInitInputTypeData%FixedWindFileRootName
...
! 
   ...
   ErrMsg  = ""
    ...
    DstHAWCInitInputTypeData%dz = SrcHAWCInitInputTypeData%dz
      CALL FlowField_IO_Copygrid3dinitinputtype( SrcHAWCInitInputTypeData%G3D, DstHAWCInitInputTypeData%G3D, CtrlCode, ErrStat2, ErrMsg2 )
         CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg,RoutineName)
         IF (ErrStat>=AbortErrLev) RETURN
 ...
 SUBROUTINE FlowField_IO_DestroyHAWCInitInputType( HAWCInitInputTypeData, ErrStat, ErrMsg, DEALLOCATEpointers )
  ...
  CALL FlowField_IO_Destroygrid3dinitinputtype( HAWCInitInputTypeData%G3D, ErrStat2, ErrMsg2, DEALLOCATEpointers_local )
     CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
 ...
 ! buffers to store subtypes, if any
  ...
  Int_BufSz  = 0
   ...
   ! Allocate buffers for subtypes, if any (we'll get sizes from these) 
      ...
      CALL FlowField_IO_Packgrid3dinitinputtype( Re_Buf, Db_Buf, Int_Buf, InData%G3D, ErrStat2, ErrMsg2, .TRUE. ) ! G3D 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN
  ...
  Int_Xferred = 1
    ...
    Re_Xferred = Re_Xferred + 1
      CALL FlowField_IO_Packgrid3dinitinputtype( Re_Buf, Db_Buf, Int_Buf, InData%G3D, ErrStat2, ErrMsg2, OnlySize ) ! G3D 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN
  ...
  Int_Xferred  = 1
    ...
    Re_Xferred = Re_Xferred + 1
      ...
      IF(Buf_size > 0) THEN
        ...
        Int_Xferred = Int_Xferred + Buf_size
      END IF
      CALL FlowField_IO_Unpackgrid3dinitinputtype( Re_Buf, Db_Buf, Int_Buf, OutData%G3D, ErrStat2, ErrMsg2 ) ! G3D 
        CALL SetErrStat(ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName)
        IF (ErrStat >= AbortErrLev) RETURN
