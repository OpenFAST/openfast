...
MODULE InflowWind_Subs
   ...
   PUBLIC :: CalculateOutput, InflowWind_GetRotorSpatialAverage, InflowWind_GetHubValues, &
             InflowWind_CloseSumFile, InflowWind_ParseInputFileInfo, SetAllOuts, &
             InflowWind_OpenSumFile, InflowWind_SetParameters, InflowWind_ValidateInput, MaxOutPts
