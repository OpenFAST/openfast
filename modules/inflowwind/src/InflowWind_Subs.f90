...
SUBROUTINE InflowWind_ParseInputFileInfo( EchoFileName, FixedWindFileRootName, TurbineID, InputFileData, InFileInfo, PriPath, ErrStat, ErrMsg )
!----------------------------------------------------------------------------------------------------
   ...
   CHARACTER(*),              PARAMETER               :: RoutineName="InflowWind_ParseInputFileInfo"
      ...
      ! Passed variables
   CHARACTER(*),                       INTENT(IN   )  :: EchoFileName         !< Path to InflowWind input files
