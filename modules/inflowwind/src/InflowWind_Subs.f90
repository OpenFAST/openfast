...
! ===================================================================================================
! This code was generated by "Write_ChckOutLst.m" at 29-Jul-2022 19:48:38.
   ...
   INTEGER(IntKi), PARAMETER      :: Wind1VelXY     = 34
   INTEGER(IntKi), PARAMETER      :: Wind2VelXY     = 35
   INTEGER(IntKi), PARAMETER      :: Wind3VelXY     = 36
   INTEGER(IntKi), PARAMETER      :: Wind4VelXY     = 37
   INTEGER(IntKi), PARAMETER      :: Wind5VelXY     = 38
   INTEGER(IntKi), PARAMETER      :: Wind6VelXY     = 39
   INTEGER(IntKi), PARAMETER      :: Wind7VelXY     = 40
   INTEGER(IntKi), PARAMETER      :: Wind8VelXY     = 41
   INTEGER(IntKi), PARAMETER      :: Wind9VelXY     = 42
   INTEGER(IntKi), PARAMETER      :: WindHubVelXY   = 43
   INTEGER(IntKi), PARAMETER      :: WindDiskVelXY  = 44
   INTEGER(IntKi), PARAMETER      :: Wind1VelMag    = 45
   INTEGER(IntKi), PARAMETER      :: Wind2VelMag    = 46
   INTEGER(IntKi), PARAMETER      :: Wind3VelMag    = 47
   INTEGER(IntKi), PARAMETER      :: Wind4VelMag    = 48
   INTEGER(IntKi), PARAMETER      :: Wind5VelMag    = 49
   INTEGER(IntKi), PARAMETER      :: Wind6VelMag    = 50
   INTEGER(IntKi), PARAMETER      :: Wind7VelMag    = 51
   INTEGER(IntKi), PARAMETER      :: Wind8VelMag    = 52
   INTEGER(IntKi), PARAMETER      :: Wind9VelMag    = 53
   INTEGER(IntKi), PARAMETER      :: WindHubVelMag  = 54
   INTEGER(IntKi), PARAMETER      :: WindDiskVelMag = 55
   INTEGER(IntKi), PARAMETER      :: Wind1AngXY     = 56
   INTEGER(IntKi), PARAMETER      :: Wind2AngXY     = 57
   INTEGER(IntKi), PARAMETER      :: Wind3AngXY     = 58
   INTEGER(IntKi), PARAMETER      :: Wind4AngXY     = 59
   INTEGER(IntKi), PARAMETER      :: Wind5AngXY     = 60
   INTEGER(IntKi), PARAMETER      :: Wind6AngXY     = 61
   INTEGER(IntKi), PARAMETER      :: Wind7AngXY     = 62
   INTEGER(IntKi), PARAMETER      :: Wind8AngXY     = 63
   INTEGER(IntKi), PARAMETER      :: Wind9AngXY     = 64
   INTEGER(IntKi), PARAMETER      :: WindHubAngXY   = 65
   INTEGER(IntKi), PARAMETER      :: WindDiskAngXY  = 66


     ! Wind Sensor Measurements:

   INTEGER(IntKi), PARAMETER      :: WindMeas1      = 67
   INTEGER(IntKi), PARAMETER      :: WindMeas2      = 68
   INTEGER(IntKi), PARAMETER      :: WindMeas3      = 69
   INTEGER(IntKi), PARAMETER      :: WindMeas4      = 70
   INTEGER(IntKi), PARAMETER      :: WindMeas5      = 71


     ! The maximum number of output channels which can be output by the code.
   INTEGER(IntKi), PARAMETER      :: MaxOutPts      = 71
...
!  INTEGER                      :: J                                               ! Generic loop-counting index
   ...
   CHARACTER(OutStrLenM1), PARAMETER  :: ValidParamAry(71) =  (/  &   ! This lists the names of the allowed parameters, which must be sorted alphabetically
                               "WIND1ANGXY    ","WIND1VELMAG   ","WIND1VELX     ","WIND1VELXY    ","WIND1VELY     ", &
                               "WIND1VELZ     ","WIND2ANGXY    ","WIND2VELMAG   ","WIND2VELX     ","WIND2VELXY    ", &
                               "WIND2VELY     ","WIND2VELZ     ","WIND3ANGXY    ","WIND3VELMAG   ","WIND3VELX     ", &
                               "WIND3VELXY    ","WIND3VELY     ","WIND3VELZ     ","WIND4ANGXY    ","WIND4VELMAG   ", &
                               "WIND4VELX     ","WIND4VELXY    ","WIND4VELY     ","WIND4VELZ     ","WIND5ANGXY    ", &
                               "WIND5VELMAG   ","WIND5VELX     ","WIND5VELXY    ","WIND5VELY     ","WIND5VELZ     ", &
                               "WIND6ANGXY    ","WIND6VELMAG   ","WIND6VELX     ","WIND6VELXY    ","WIND6VELY     ", &
                               "WIND6VELZ     ","WIND7ANGXY    ","WIND7VELMAG   ","WIND7VELX     ","WIND7VELXY    ", &
                               "WIND7VELY     ","WIND7VELZ     ","WIND8ANGXY    ","WIND8VELMAG   ","WIND8VELX     ", &
                               "WIND8VELXY    ","WIND8VELY     ","WIND8VELZ     ","WIND9ANGXY    ","WIND9VELMAG   ", &
                               "WIND9VELX     ","WIND9VELXY    ","WIND9VELY     ","WIND9VELZ     ","WINDDISKANGXY ", &
                               "WINDDISKVELMAG","WINDDISKVELX  ","WINDDISKVELXY ","WINDDISKVELY  ","WINDDISKVELZ  ", &
                               "WINDHUBANGXY  ","WINDHUBVELMAG ","WINDHUBVELX   ","WINDHUBVELXY  ","WINDHUBVELY   ", &
                               "WINDHUBVELZ   ","WINDMEAS1     ","WINDMEAS2     ","WINDMEAS3     ","WINDMEAS4     ", &
                               "WINDMEAS5     "/)
   INTEGER(IntKi), PARAMETER :: ParamIndxAry(71) =  (/ &                            ! This lists the index into AllOuts(:) of the allowed parameters ValidParamAry(:)
                                    Wind1AngXY ,    Wind1VelMag ,      Wind1VelX ,     Wind1VelXY ,      Wind1VelY , &
                                     Wind1VelZ ,     Wind2AngXY ,    Wind2VelMag ,      Wind2VelX ,     Wind2VelXY , &
                                     Wind2VelY ,      Wind2VelZ ,     Wind3AngXY ,    Wind3VelMag ,      Wind3VelX , &
                                    Wind3VelXY ,      Wind3VelY ,      Wind3VelZ ,     Wind4AngXY ,    Wind4VelMag , &
                                ...
                                WindDiskVelMag ,   WindDiskVelX ,  WindDiskVelXY ,   WindDiskVelY ,   WindDiskVelZ , &
                                  WindHubAngXY ,  WindHubVelMag ,    WindHubVelX ,   WindHubVelXY ,    WindHubVelY , &
                                   WindHubVelZ ,      WindMeas1 ,      WindMeas2 ,      WindMeas3 ,      WindMeas4 , &
                                     WindMeas5 /)
   CHARACTER(ChanLen), PARAMETER :: ParamUnitsAry(71) =  (/ character(ChanLen) :: &  ! This lists the units corresponding to the allowed parameters
                               "(deg)","(m/s)","(m/s)","(m/s)","(m/s)", &
                               "(m/s)","(deg)","(m/s)","(m/s)","(m/s)", &
                               "(m/s)","(m/s)","(deg)","(m/s)","(m/s)", &
                               "(m/s)","(m/s)","(m/s)","(deg)","(m/s)", &
