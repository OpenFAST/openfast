...
SUBROUTINE CallBladedDLL ( u, filt_fromSCglob, filt_fromSC, p, dll_data, ErrStat, ErrMsg, ChannelNameUnit )
   ...
   if (p%UseLegacyInterface) then
      if (present(ChannelNameUnit)) then
         call CallBladedLegacyDLL ( u, filt_fromSCglob, filt_fromSC, p, dll_data, ErrStat, ErrMsg, ChannelNameUnit )
      else
         call CallBladedLegacyDLL ( u, filt_fromSCglob, filt_fromSC, p, dll_data, ErrStat, ErrMsg )
      end if
   else
...
SUBROUTINE GetBladedLoggingChannels(u,p, xd, m, ErrStat, ErrMsg)
   ...
   if (p%UseLegacyInterface) then
      ...
      CALL CallBladedDLL(u, xd%filt_fromSCglob, xd%filt_fromSC, p, m%dll_data, ErrStat, ErrMsg, LoggingChannelStr)
         IF ( ErrStat >= AbortErrLev ) RETURN
      ...
      CALL CallBladedDLL(u, xd%filt_fromSCglob, xd%filt_fromSC, p, m%dll_data, ErrStat, ErrMsg)
         IF ( ErrStat >= AbortErrLev ) RETURN
