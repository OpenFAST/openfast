...
subroutine Set_PtfmStC_Outs( p_SrvD, x, m, y, AllOuts )     ! Platform 
   ...
   j=1
   if (allocated(x) .and. allocated(m) .and. allocated(y)) then
      do i=1,min(p_SrvD%NumPtfmStC,MaxStC)                       ! in case we have more Nacelle StCs than the outputs are set for
...
subroutine ParseInputFileInfo( PriPath, InputFile, OutFileRoot, FileInfo_In, InputFileData, Default_DT, ErrStat, ErrMsg )
   ...
   call ParseVar( FileInfo_In, CurLine, 'NumPtfmStC', InputFileData%NumPtfmStC, ErrStat2, ErrMsg2, UnEcho )
      if (Failed())  return;
      !  PtfmStCfiles - Name of the files for blade structural controllers (quoted strings) [unused when NumPtfmStC==0]
   call AllocAry( InputFileData%PtfmStCfiles, InputFileData%NumPtfmStC, 'PtfmStCfile', ErrStat2, ErrMsg2 )
      if (Failed())  return;
...
!..................................................................................................................................
   ...
   InvalidOutput( PtfmStC1_XQ) = ( p%NumPtfmStC<1 )
   InvalidOutput(PtfmStC1_XQD) = ( p%NumPtfmStC<1 )
   InvalidOutput( PtfmStC1_YQ) = ( p%NumPtfmStC<1 )
   InvalidOutput(PtfmStC1_YQD) = ( p%NumPtfmStC<1 )
   InvalidOutput( PtfmStC1_ZQ) = ( p%NumPtfmStC<1 )
   InvalidOutput(PtfmStC1_ZQD) = ( p%NumPtfmStC<1 )
   InvalidOutput(PtfmStC1_Fxi) = ( p%NumPtfmStC<1 )
   InvalidOutput(PtfmStC1_Fyi) = ( p%NumPtfmStC<1 )
   InvalidOutput(PtfmStC1_Fzi) = ( p%NumPtfmStC<1 )
   InvalidOutput(PtfmStC1_Mxi) = ( p%NumPtfmStC<1 )
   InvalidOutput(PtfmStC1_Myi) = ( p%NumPtfmStC<1 )
   InvalidOutput(PtfmStC1_Mzi) = ( p%NumPtfmStC<1 )
   InvalidOutput(PtfmStC1_Fxl) = ( p%NumPtfmStC<1 )
   InvalidOutput(PtfmStC1_Fyl) = ( p%NumPtfmStC<1 )
   InvalidOutput(PtfmStC1_Fzl) = ( p%NumPtfmStC<1 )
   InvalidOutput(PtfmStC1_Mxl) = ( p%NumPtfmStC<1 )
   InvalidOutput(PtfmStC1_Myl) = ( p%NumPtfmStC<1 )
   InvalidOutput(PtfmStC1_Mzl) = ( p%NumPtfmStC<1 )
   InvalidOutput( PtfmStC2_XQ) = ( p%NumPtfmStC<2 )
   InvalidOutput(PtfmStC2_XQD) = ( p%NumPtfmStC<2 )
   InvalidOutput( PtfmStC2_YQ) = ( p%NumPtfmStC<2 )
   InvalidOutput(PtfmStC2_YQD) = ( p%NumPtfmStC<2 )
   InvalidOutput( PtfmStC2_ZQ) = ( p%NumPtfmStC<2 )
   InvalidOutput(PtfmStC2_ZQD) = ( p%NumPtfmStC<2 )
   InvalidOutput(PtfmStC2_Fxi) = ( p%NumPtfmStC<2 )
   InvalidOutput(PtfmStC2_Fyi) = ( p%NumPtfmStC<2 )
   InvalidOutput(PtfmStC2_Fzi) = ( p%NumPtfmStC<2 )
   InvalidOutput(PtfmStC2_Mxi) = ( p%NumPtfmStC<2 )
   InvalidOutput(PtfmStC2_Myi) = ( p%NumPtfmStC<2 )
   InvalidOutput(PtfmStC2_Mzi) = ( p%NumPtfmStC<2 )
   InvalidOutput(PtfmStC2_Fxl) = ( p%NumPtfmStC<2 )
   InvalidOutput(PtfmStC2_Fyl) = ( p%NumPtfmStC<2 )
   InvalidOutput(PtfmStC2_Fzl) = ( p%NumPtfmStC<2 )
   InvalidOutput(PtfmStC2_Mxl) = ( p%NumPtfmStC<2 )
   InvalidOutput(PtfmStC2_Myl) = ( p%NumPtfmStC<2 )
   InvalidOutput(PtfmStC2_Mzl) = ( p%NumPtfmStC<2 )
   InvalidOutput( PtfmStC3_XQ) = ( p%NumPtfmStC<3 )
   InvalidOutput(PtfmStC3_XQD) = ( p%NumPtfmStC<3 )
   InvalidOutput( PtfmStC3_YQ) = ( p%NumPtfmStC<3 )
   InvalidOutput(PtfmStC3_YQD) = ( p%NumPtfmStC<3 )
   InvalidOutput( PtfmStC3_ZQ) = ( p%NumPtfmStC<3 )
   InvalidOutput(PtfmStC3_ZQD) = ( p%NumPtfmStC<3 )
   InvalidOutput(PtfmStC3_Fxi) = ( p%NumPtfmStC<3 )
   InvalidOutput(PtfmStC3_Fyi) = ( p%NumPtfmStC<3 )
   InvalidOutput(PtfmStC3_Fzi) = ( p%NumPtfmStC<3 )
   InvalidOutput(PtfmStC3_Mxi) = ( p%NumPtfmStC<3 )
   InvalidOutput(PtfmStC3_Myi) = ( p%NumPtfmStC<3 )
   InvalidOutput(PtfmStC3_Mzi) = ( p%NumPtfmStC<3 )
   InvalidOutput(PtfmStC3_Fxl) = ( p%NumPtfmStC<3 )
   InvalidOutput(PtfmStC3_Fyl) = ( p%NumPtfmStC<3 )
   InvalidOutput(PtfmStC3_Fzl) = ( p%NumPtfmStC<3 )
   InvalidOutput(PtfmStC3_Mxl) = ( p%NumPtfmStC<3 )
   InvalidOutput(PtfmStC3_Myl) = ( p%NumPtfmStC<3 )
   InvalidOutput(PtfmStC3_Mzl) = ( p%NumPtfmStC<3 )
   InvalidOutput( PtfmStC4_XQ) = ( p%NumPtfmStC<4 )
   InvalidOutput(PtfmStC4_XQD) = ( p%NumPtfmStC<4 )
   InvalidOutput( PtfmStC4_YQ) = ( p%NumPtfmStC<4 )
   InvalidOutput(PtfmStC4_YQD) = ( p%NumPtfmStC<4 )
   InvalidOutput( PtfmStC4_ZQ) = ( p%NumPtfmStC<4 )
   InvalidOutput(PtfmStC4_ZQD) = ( p%NumPtfmStC<4 )
   InvalidOutput(PtfmStC4_Fxi) = ( p%NumPtfmStC<4 )
   InvalidOutput(PtfmStC4_Fyi) = ( p%NumPtfmStC<4 )
   InvalidOutput(PtfmStC4_Fzi) = ( p%NumPtfmStC<4 )
   InvalidOutput(PtfmStC4_Mxi) = ( p%NumPtfmStC<4 )
   InvalidOutput(PtfmStC4_Myi) = ( p%NumPtfmStC<4 )
   InvalidOutput(PtfmStC4_Mzi) = ( p%NumPtfmStC<4 )
   InvalidOutput(PtfmStC4_Fxl) = ( p%NumPtfmStC<4 )
   InvalidOutput(PtfmStC4_Fyl) = ( p%NumPtfmStC<4 )
   InvalidOutput(PtfmStC4_Fzl) = ( p%NumPtfmStC<4 )
   InvalidOutput(PtfmStC4_Mxl) = ( p%NumPtfmStC<4 )
   InvalidOutput(PtfmStC4_Myl) = ( p%NumPtfmStC<4 )
   InvalidOutput(PtfmStC4_Mzl) = ( p%NumPtfmStC<4 )
