 ...
 ! buffers to store subtypes, if any
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      DO i1 = LBOUND(InData%InitScOutputsGlob,1), UBOUND(InData%InitScOutputsGlob,1)
        ReKiBuf(Re_Xferred) = InData%InitScOutputsGlob(i1)
        Re_Xferred = Re_Xferred + 1
      END DO
  END IF
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      DO i1 = LBOUND(InData%InitScOutputsTurbine,1), UBOUND(InData%InitScOutputsTurbine,1)
        ReKiBuf(Re_Xferred) = InData%InitScOutputsTurbine(i1)
        Re_Xferred = Re_Xferred + 1
      END DO
  END IF
 ...
 ! buffers to store meshes, if any
  ...
  ELSE
    ...
    IF (ErrStat2 /= 0) THEN 
       ...
       RETURN
    END IF
      DO i1 = LBOUND(OutData%InitScOutputsGlob,1), UBOUND(OutData%InitScOutputsGlob,1)
        OutData%InitScOutputsGlob(i1) = ReKiBuf(Re_Xferred)
        Re_Xferred = Re_Xferred + 1
      END DO
  END IF
  ...
  ELSE
    ...
    IF (ErrStat2 /= 0) THEN 
       ...
       RETURN
    END IF
      DO i1 = LBOUND(OutData%InitScOutputsTurbine,1), UBOUND(OutData%InitScOutputsTurbine,1)
        OutData%InitScOutputsTurbine(i1) = ReKiBuf(Re_Xferred)
        Re_Xferred = Re_Xferred + 1
      END DO
  END IF
 ...
 ! buffers to store subtypes, if any
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      DO i1 = LBOUND(InData%ScInFilter,1), UBOUND(InData%ScInFilter,1)
        ReKiBuf(Re_Xferred) = InData%ScInFilter(i1)
        Re_Xferred = Re_Xferred + 1
      END DO
  END IF
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      DO i1 = LBOUND(InData%ScInGlobFilter,1), UBOUND(InData%ScInGlobFilter,1)
        ReKiBuf(Re_Xferred) = InData%ScInGlobFilter(i1)
        Re_Xferred = Re_Xferred + 1
      END DO
  END IF
 ...
 ! buffers to store meshes, if any
  ...
  ELSE
    ...
    IF (ErrStat2 /= 0) THEN 
       ...
       RETURN
    END IF
      DO i1 = LBOUND(OutData%ScInFilter,1), UBOUND(OutData%ScInFilter,1)
        OutData%ScInFilter(i1) = REAL(ReKiBuf(Re_Xferred), SiKi)
        Re_Xferred = Re_Xferred + 1
      END DO
  END IF
  ...
  ELSE
    ...
    IF (ErrStat2 /= 0) THEN 
       ...
       RETURN
    END IF
      DO i1 = LBOUND(OutData%ScInGlobFilter,1), UBOUND(OutData%ScInGlobFilter,1)
        OutData%ScInGlobFilter(i1) = REAL(ReKiBuf(Re_Xferred), SiKi)
        Re_Xferred = Re_Xferred + 1
      END DO
  END IF
  ...
  END IF
    ...
    Re_Xferred = Re_Xferred + 1
      ...
      ELSE
        IntKiBuf( Int_Xferred ) = 0; Int_Xferred = Int_Xferred + 1
      ENDIF
    IntKiBuf(Int_Xferred) = TRANSFER(InData%ScOn, IntKiBuf(1))
    Int_Xferred = Int_Xferred + 1
    ReKiBuf(Re_Xferred) = InData%ScInAlpha
    Re_Xferred = Re_Xferred + 1
 ...
 ! buffers to store meshes, if any
  ...
  END IF
    ...
    Re_Xferred = Re_Xferred + 1
      ...
      IF(ALLOCATED(Db_Buf )) DEALLOCATE(Db_Buf )
      IF(ALLOCATED(Int_Buf)) DEALLOCATE(Int_Buf)
    OutData%ScOn = TRANSFER(IntKiBuf(Int_Xferred), OutData%ScOn)
    Int_Xferred = Int_Xferred + 1
 ...
 ! buffers to store subtypes, if any
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      DO i1 = LBOUND(InData%SuperControllerTurbine,1), UBOUND(InData%SuperControllerTurbine,1)
        ReKiBuf(Re_Xferred) = InData%SuperControllerTurbine(i1)
        Re_Xferred = Re_Xferred + 1
      END DO
  END IF
  ...
  ELSE
    ...
    Int_Xferred = Int_Xferred + 2
      ...
      DO i1 = LBOUND(InData%SuperControllerGlob,1), UBOUND(InData%SuperControllerGlob,1)
        ReKiBuf(Re_Xferred) = InData%SuperControllerGlob(i1)
        Re_Xferred = Re_Xferred + 1
      END DO
  END IF
 ...
 ! buffers to store meshes, if any
  ...
  ELSE
    ...
    IF (ErrStat2 /= 0) THEN 
       ...
       RETURN
    END IF
      DO i1 = LBOUND(OutData%SuperControllerTurbine,1), UBOUND(OutData%SuperControllerTurbine,1)
        OutData%SuperControllerTurbine(i1) = REAL(ReKiBuf(Re_Xferred), SiKi)
        Re_Xferred = Re_Xferred + 1
      END DO
  END IF
  ...
  ELSE
    ...
    IF (ErrStat2 /= 0) THEN 
       ...
       RETURN
    END IF
      DO i1 = LBOUND(OutData%SuperControllerGlob,1), UBOUND(OutData%SuperControllerGlob,1)
        OutData%SuperControllerGlob(i1) = REAL(ReKiBuf(Re_Xferred), SiKi)
        Re_Xferred = Re_Xferred + 1
      END DO
  END IF
...
IF (ALLOCATED(u_out%SuperControllerTurbine) .AND. ALLOCATED(u1%SuperControllerTurbine)) THEN
  DO i1 = LBOUND(u_out%SuperControllerTurbine,1),UBOUND(u_out%SuperControllerTurbine,1)
    b = -(u1%SuperControllerTurbine(i1) - u2%SuperControllerTurbine(i1))
    u_out%SuperControllerTurbine(i1) = u1%SuperControllerTurbine(i1) + b * ScaleFactor
  END DO
END IF ! check if allocated
IF (ALLOCATED(u_out%SuperControllerGlob) .AND. ALLOCATED(u1%SuperControllerGlob)) THEN
  DO i1 = LBOUND(u_out%SuperControllerGlob,1),UBOUND(u_out%SuperControllerGlob,1)
    b = -(u1%SuperControllerGlob(i1) - u2%SuperControllerGlob(i1))
    u_out%SuperControllerGlob(i1) = u1%SuperControllerGlob(i1) + b * ScaleFactor
  END DO
END IF ! check if allocated
...
IF (ALLOCATED(u_out%SuperControllerTurbine) .AND. ALLOCATED(u1%SuperControllerTurbine)) THEN
  DO i1 = LBOUND(u_out%SuperControllerTurbine,1),UBOUND(u_out%SuperControllerTurbine,1)
    b = (t(3)**2*(u1%SuperControllerTurbine(i1) - u2%SuperControllerTurbine(i1)) + t(2)**2*(-u1%SuperControllerTurbine(i1) + u3%SuperControllerTurbine(i1)))* scaleFactor
    c = ( (t(2)-t(3))*u1%SuperControllerTurbine(i1) + t(3)*u2%SuperControllerTurbine(i1) - t(2)*u3%SuperControllerTurbine(i1) ) * scaleFactor
    u_out%SuperControllerTurbine(i1) = u1%SuperControllerTurbine(i1) + b  + c * t_out
  END DO
END IF ! check if allocated
IF (ALLOCATED(u_out%SuperControllerGlob) .AND. ALLOCATED(u1%SuperControllerGlob)) THEN
  DO i1 = LBOUND(u_out%SuperControllerGlob,1),UBOUND(u_out%SuperControllerGlob,1)
    b = (t(3)**2*(u1%SuperControllerGlob(i1) - u2%SuperControllerGlob(i1)) + t(2)**2*(-u1%SuperControllerGlob(i1) + u3%SuperControllerGlob(i1)))* scaleFactor
    c = ( (t(2)-t(3))*u1%SuperControllerGlob(i1) + t(3)*u2%SuperControllerGlob(i1) - t(2)*u3%SuperControllerGlob(i1) ) * scaleFactor
    u_out%SuperControllerGlob(i1) = u1%SuperControllerGlob(i1) + b  + c * t_out
  END DO
END IF ! check if allocated
