...
subroutine ExtLd_CopyInput(SrcInputData, DstInputData, CtrlCode, ErrStat, ErrMsg)
   ...
   if (allocated(SrcInputData%BladeLoadAD)) then
      LB(1:1) = lbound(SrcInputData%BladeLoadAD)
      UB(1:1) = ubound(SrcInputData%BladeLoadAD)
...
subroutine ExtLd_DestroyInput(InputData, ErrStat, ErrMsg)
   ...
   if (allocated(InputData%BladeLoadAD)) then
      LB(1:1) = lbound(InputData%BladeLoadAD)
      UB(1:1) = ubound(InputData%BladeLoadAD)
      do i1 = LB(1), UB(1)
...
!..................................................................................................................................
   ...
   IF (ALLOCATED(u_out%BladeLoadAD) .AND. ALLOCATED(u1%BladeLoadAD)) THEN
      do i1 = lbound(u_out%BladeLoadAD,1),ubound(u_out%BladeLoadAD,1)
