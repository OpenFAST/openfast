...
! ===================================================================================================
! This code was generated by "Write_ChckOutLst.m" at 29-Oct-2025 14:47:34.
   ...
   INTEGER(IntKi), PARAMETER      :: BldPRate1  =  373
   INTEGER(IntKi), PARAMETER      :: BldPRate2  =  374
   INTEGER(IntKi), PARAMETER      :: BldPRate3  =  375
   INTEGER(IntKi), PARAMETER      :: BldPAcc1   =  376
   INTEGER(IntKi), PARAMETER      :: BldPAcc2   =  377
   INTEGER(IntKi), PARAMETER      :: BldPAcc3   =  378


     ! Teeter Motions:

   INTEGER(IntKi), PARAMETER      :: TeetPya    =  379
   INTEGER(IntKi), PARAMETER      :: TeetVya    =  380
   INTEGER(IntKi), PARAMETER      :: TeetAya    =  381


     ! Shaft Motions:

   INTEGER(IntKi), PARAMETER      :: LSSTipPxa  =  382
   INTEGER(IntKi), PARAMETER      :: LSSTipVxa  =  383
   INTEGER(IntKi), PARAMETER      :: LSSTipAxa  =  384
   INTEGER(IntKi), PARAMETER      :: LSSGagPxa  =  385
   INTEGER(IntKi), PARAMETER      :: LSSGagVxa  =  386
   INTEGER(IntKi), PARAMETER      :: LSSGagAxa  =  387
   INTEGER(IntKi), PARAMETER      :: HSShftV    =  388
   INTEGER(IntKi), PARAMETER      :: HSShftA    =  389


     ! Nacelle IMU Motions:

   INTEGER(IntKi), PARAMETER      :: NcIMUTVxs  =  390
   INTEGER(IntKi), PARAMETER      :: NcIMUTVys  =  391
   INTEGER(IntKi), PARAMETER      :: NcIMUTVzs  =  392
   INTEGER(IntKi), PARAMETER      :: NcIMUTAxs  =  393
   INTEGER(IntKi), PARAMETER      :: NcIMUTAys  =  394
   INTEGER(IntKi), PARAMETER      :: NcIMUTAzs  =  395
   INTEGER(IntKi), PARAMETER      :: NcIMUTAgxs =  396
   INTEGER(IntKi), PARAMETER      :: NcIMUTAgys =  397
   INTEGER(IntKi), PARAMETER      :: NcIMUTAgzs =  398
   INTEGER(IntKi), PARAMETER      :: NcIMURVxs  =  399
   INTEGER(IntKi), PARAMETER      :: NcIMURVys  =  400
   INTEGER(IntKi), PARAMETER      :: NcIMURVzs  =  401
   INTEGER(IntKi), PARAMETER      :: NcIMURAxs  =  402
   INTEGER(IntKi), PARAMETER      :: NcIMURAys  =  403
   INTEGER(IntKi), PARAMETER      :: NcIMURAzs  =  404


     ! Rotor-Furl Motions:

   INTEGER(IntKi), PARAMETER      :: RotFurlP   =  405
   INTEGER(IntKi), PARAMETER      :: RotFurlV   =  406
   INTEGER(IntKi), PARAMETER      :: RotFurlA   =  407


     ! Tail-Furl Motions:

   INTEGER(IntKi), PARAMETER      :: TailFurlP  =  408
   INTEGER(IntKi), PARAMETER      :: TailFurlV  =  409
   INTEGER(IntKi), PARAMETER      :: TailFurlA  =  410


     ! Nacelle Yaw Motions:

   INTEGER(IntKi), PARAMETER      :: YawPzn     =  411
   INTEGER(IntKi), PARAMETER      :: YawVzn     =  412
   INTEGER(IntKi), PARAMETER      :: YawAzn     =  413


     ! Tower-Top / Yaw Bearing Motions:

   INTEGER(IntKi), PARAMETER      :: TwrTpTDxi  =  414
   INTEGER(IntKi), PARAMETER      :: TwrTpTDyi  =  415
   INTEGER(IntKi), PARAMETER      :: TwrTpTDzi  =  416
   INTEGER(IntKi), PARAMETER      :: YawBrTDxp  =  417
   INTEGER(IntKi), PARAMETER      :: YawBrTDyp  =  418
   INTEGER(IntKi), PARAMETER      :: YawBrTDzp  =  419
   INTEGER(IntKi), PARAMETER      :: YawBrTDxt  =  420
   INTEGER(IntKi), PARAMETER      :: YawBrTDyt  =  421
   INTEGER(IntKi), PARAMETER      :: YawBrTDzt  =  422
   INTEGER(IntKi), PARAMETER      :: YawBrTVxp  =  423
   INTEGER(IntKi), PARAMETER      :: YawBrTVyp  =  424
   INTEGER(IntKi), PARAMETER      :: YawBrTVzp  =  425
   INTEGER(IntKi), PARAMETER      :: YawBrTAxp  =  426
   INTEGER(IntKi), PARAMETER      :: YawBrTAyp  =  427
   INTEGER(IntKi), PARAMETER      :: YawBrTAzp  =  428
   INTEGER(IntKi), PARAMETER      :: YawBrTAgxp =  429
   INTEGER(IntKi), PARAMETER      :: YawBrTAgyp =  430
   INTEGER(IntKi), PARAMETER      :: YawBrTAgzp =  431
   INTEGER(IntKi), PARAMETER      :: YawBrRDxt  =  432
   INTEGER(IntKi), PARAMETER      :: YawBrRDyt  =  433
   INTEGER(IntKi), PARAMETER      :: YawBrRDzt  =  434
   INTEGER(IntKi), PARAMETER      :: YawBrRVxp  =  435
   INTEGER(IntKi), PARAMETER      :: YawBrRVyp  =  436
   INTEGER(IntKi), PARAMETER      :: YawBrRVzp  =  437
   INTEGER(IntKi), PARAMETER      :: YawBrRAxp  =  438
   INTEGER(IntKi), PARAMETER      :: YawBrRAyp  =  439
   INTEGER(IntKi), PARAMETER      :: YawBrRAzp  =  440


     ! Local Tower Motions:

   INTEGER(IntKi), PARAMETER      :: TwHt1ALxt  =  441
   INTEGER(IntKi), PARAMETER      :: TwHt1ALyt  =  442
   INTEGER(IntKi), PARAMETER      :: TwHt1ALzt  =  443
   INTEGER(IntKi), PARAMETER      :: TwHt2ALxt  =  444
   INTEGER(IntKi), PARAMETER      :: TwHt2ALyt  =  445
   INTEGER(IntKi), PARAMETER      :: TwHt2ALzt  =  446
   INTEGER(IntKi), PARAMETER      :: TwHt3ALxt  =  447
   INTEGER(IntKi), PARAMETER      :: TwHt3ALyt  =  448
   INTEGER(IntKi), PARAMETER      :: TwHt3ALzt  =  449
   INTEGER(IntKi), PARAMETER      :: TwHt4ALxt  =  450
   INTEGER(IntKi), PARAMETER      :: TwHt4ALyt  =  451
   INTEGER(IntKi), PARAMETER      :: TwHt4ALzt  =  452
   INTEGER(IntKi), PARAMETER      :: TwHt5ALxt  =  453
   INTEGER(IntKi), PARAMETER      :: TwHt5ALyt  =  454
   INTEGER(IntKi), PARAMETER      :: TwHt5ALzt  =  455
   INTEGER(IntKi), PARAMETER      :: TwHt6ALxt  =  456
   INTEGER(IntKi), PARAMETER      :: TwHt6ALyt  =  457
   INTEGER(IntKi), PARAMETER      :: TwHt6ALzt  =  458
   INTEGER(IntKi), PARAMETER      :: TwHt7ALxt  =  459
   INTEGER(IntKi), PARAMETER      :: TwHt7ALyt  =  460
   INTEGER(IntKi), PARAMETER      :: TwHt7ALzt  =  461
   INTEGER(IntKi), PARAMETER      :: TwHt8ALxt  =  462
   INTEGER(IntKi), PARAMETER      :: TwHt8ALyt  =  463
   INTEGER(IntKi), PARAMETER      :: TwHt8ALzt  =  464
   INTEGER(IntKi), PARAMETER      :: TwHt9ALxt  =  465
   INTEGER(IntKi), PARAMETER      :: TwHt9ALyt  =  466
   INTEGER(IntKi), PARAMETER      :: TwHt9ALzt  =  467
   INTEGER(IntKi), PARAMETER      :: TwHt1ALgxt =  468
   INTEGER(IntKi), PARAMETER      :: TwHt1ALgyt =  469
   INTEGER(IntKi), PARAMETER      :: TwHt1ALgzt =  470
   INTEGER(IntKi), PARAMETER      :: TwHt2ALgxt =  471
   INTEGER(IntKi), PARAMETER      :: TwHt2ALgyt =  472
   INTEGER(IntKi), PARAMETER      :: TwHt2ALgzt =  473
   INTEGER(IntKi), PARAMETER      :: TwHt3ALgxt =  474
   INTEGER(IntKi), PARAMETER      :: TwHt3ALgyt =  475
   INTEGER(IntKi), PARAMETER      :: TwHt3ALgzt =  476
   INTEGER(IntKi), PARAMETER      :: TwHt4ALgxt =  477
   INTEGER(IntKi), PARAMETER      :: TwHt4ALgyt =  478
   INTEGER(IntKi), PARAMETER      :: TwHt4ALgzt =  479
   INTEGER(IntKi), PARAMETER      :: TwHt5ALgxt =  480
   INTEGER(IntKi), PARAMETER      :: TwHt5ALgyt =  481
   INTEGER(IntKi), PARAMETER      :: TwHt5ALgzt =  482
   INTEGER(IntKi), PARAMETER      :: TwHt6ALgxt =  483
   INTEGER(IntKi), PARAMETER      :: TwHt6ALgyt =  484
   INTEGER(IntKi), PARAMETER      :: TwHt6ALgzt =  485
   INTEGER(IntKi), PARAMETER      :: TwHt7ALgxt =  486
   INTEGER(IntKi), PARAMETER      :: TwHt7ALgyt =  487
   INTEGER(IntKi), PARAMETER      :: TwHt7ALgzt =  488
   INTEGER(IntKi), PARAMETER      :: TwHt8ALgxt =  489
   INTEGER(IntKi), PARAMETER      :: TwHt8ALgyt =  490
   INTEGER(IntKi), PARAMETER      :: TwHt8ALgzt =  491
   INTEGER(IntKi), PARAMETER      :: TwHt9ALgxt =  492
   INTEGER(IntKi), PARAMETER      :: TwHt9ALgyt =  493
   INTEGER(IntKi), PARAMETER      :: TwHt9ALgzt =  494
   INTEGER(IntKi), PARAMETER      :: TwHt1TDxt  =  495
   INTEGER(IntKi), PARAMETER      :: TwHt1TDyt  =  496
   INTEGER(IntKi), PARAMETER      :: TwHt1TDzt  =  497
   INTEGER(IntKi), PARAMETER      :: TwHt2TDxt  =  498
   INTEGER(IntKi), PARAMETER      :: TwHt2TDyt  =  499
   INTEGER(IntKi), PARAMETER      :: TwHt2TDzt  =  500
   INTEGER(IntKi), PARAMETER      :: TwHt3TDxt  =  501
   INTEGER(IntKi), PARAMETER      :: TwHt3TDyt  =  502
   INTEGER(IntKi), PARAMETER      :: TwHt3TDzt  =  503
   INTEGER(IntKi), PARAMETER      :: TwHt4TDxt  =  504
   INTEGER(IntKi), PARAMETER      :: TwHt4TDyt  =  505
   INTEGER(IntKi), PARAMETER      :: TwHt4TDzt  =  506
   INTEGER(IntKi), PARAMETER      :: TwHt5TDxt  =  507
   INTEGER(IntKi), PARAMETER      :: TwHt5TDyt  =  508
   INTEGER(IntKi), PARAMETER      :: TwHt5TDzt  =  509
   INTEGER(IntKi), PARAMETER      :: TwHt6TDxt  =  510
   INTEGER(IntKi), PARAMETER      :: TwHt6TDyt  =  511
   INTEGER(IntKi), PARAMETER      :: TwHt6TDzt  =  512
   INTEGER(IntKi), PARAMETER      :: TwHt7TDxt  =  513
   INTEGER(IntKi), PARAMETER      :: TwHt7TDyt  =  514
   INTEGER(IntKi), PARAMETER      :: TwHt7TDzt  =  515
   INTEGER(IntKi), PARAMETER      :: TwHt8TDxt  =  516
   INTEGER(IntKi), PARAMETER      :: TwHt8TDyt  =  517
   INTEGER(IntKi), PARAMETER      :: TwHt8TDzt  =  518
   INTEGER(IntKi), PARAMETER      :: TwHt9TDxt  =  519
   INTEGER(IntKi), PARAMETER      :: TwHt9TDyt  =  520
   INTEGER(IntKi), PARAMETER      :: TwHt9TDzt  =  521
   INTEGER(IntKi), PARAMETER      :: TwHt1RDxt  =  522
   INTEGER(IntKi), PARAMETER      :: TwHt1RDyt  =  523
   INTEGER(IntKi), PARAMETER      :: TwHt1RDzt  =  524
   INTEGER(IntKi), PARAMETER      :: TwHt2RDxt  =  525
   INTEGER(IntKi), PARAMETER      :: TwHt2RDyt  =  526
   INTEGER(IntKi), PARAMETER      :: TwHt2RDzt  =  527
   INTEGER(IntKi), PARAMETER      :: TwHt3RDxt  =  528
   INTEGER(IntKi), PARAMETER      :: TwHt3RDyt  =  529
   INTEGER(IntKi), PARAMETER      :: TwHt3RDzt  =  530
   INTEGER(IntKi), PARAMETER      :: TwHt4RDxt  =  531
   INTEGER(IntKi), PARAMETER      :: TwHt4RDyt  =  532
   INTEGER(IntKi), PARAMETER      :: TwHt4RDzt  =  533
   INTEGER(IntKi), PARAMETER      :: TwHt5RDxt  =  534
   INTEGER(IntKi), PARAMETER      :: TwHt5RDyt  =  535
   INTEGER(IntKi), PARAMETER      :: TwHt5RDzt  =  536
   INTEGER(IntKi), PARAMETER      :: TwHt6RDxt  =  537
   INTEGER(IntKi), PARAMETER      :: TwHt6RDyt  =  538
   INTEGER(IntKi), PARAMETER      :: TwHt6RDzt  =  539
   INTEGER(IntKi), PARAMETER      :: TwHt7RDxt  =  540
   INTEGER(IntKi), PARAMETER      :: TwHt7RDyt  =  541
   INTEGER(IntKi), PARAMETER      :: TwHt7RDzt  =  542
   INTEGER(IntKi), PARAMETER      :: TwHt8RDxt  =  543
   INTEGER(IntKi), PARAMETER      :: TwHt8RDyt  =  544
   INTEGER(IntKi), PARAMETER      :: TwHt8RDzt  =  545
   INTEGER(IntKi), PARAMETER      :: TwHt9RDxt  =  546
   INTEGER(IntKi), PARAMETER      :: TwHt9RDyt  =  547
   INTEGER(IntKi), PARAMETER      :: TwHt9RDzt  =  548
   INTEGER(IntKi), PARAMETER      :: TwHt1TPxi  =  549
   INTEGER(IntKi), PARAMETER      :: TwHt1TPyi  =  550
   INTEGER(IntKi), PARAMETER      :: TwHt1TPzi  =  551
   INTEGER(IntKi), PARAMETER      :: TwHt2TPxi  =  552
   INTEGER(IntKi), PARAMETER      :: TwHt2TPyi  =  553
   INTEGER(IntKi), PARAMETER      :: TwHt2TPzi  =  554
   INTEGER(IntKi), PARAMETER      :: TwHt3TPxi  =  555
   INTEGER(IntKi), PARAMETER      :: TwHt3TPyi  =  556
   INTEGER(IntKi), PARAMETER      :: TwHt3TPzi  =  557
   INTEGER(IntKi), PARAMETER      :: TwHt4TPxi  =  558
   INTEGER(IntKi), PARAMETER      :: TwHt4TPyi  =  559
   INTEGER(IntKi), PARAMETER      :: TwHt4TPzi  =  560
   INTEGER(IntKi), PARAMETER      :: TwHt5TPxi  =  561
   INTEGER(IntKi), PARAMETER      :: TwHt5TPyi  =  562
   INTEGER(IntKi), PARAMETER      :: TwHt5TPzi  =  563
   INTEGER(IntKi), PARAMETER      :: TwHt6TPxi  =  564
   INTEGER(IntKi), PARAMETER      :: TwHt6TPyi  =  565
   INTEGER(IntKi), PARAMETER      :: TwHt6TPzi  =  566
   INTEGER(IntKi), PARAMETER      :: TwHt7TPxi  =  567
   INTEGER(IntKi), PARAMETER      :: TwHt7TPyi  =  568
   INTEGER(IntKi), PARAMETER      :: TwHt7TPzi  =  569
   INTEGER(IntKi), PARAMETER      :: TwHt8TPxi  =  570
   INTEGER(IntKi), PARAMETER      :: TwHt8TPyi  =  571
   INTEGER(IntKi), PARAMETER      :: TwHt8TPzi  =  572
   INTEGER(IntKi), PARAMETER      :: TwHt9TPxi  =  573
   INTEGER(IntKi), PARAMETER      :: TwHt9TPyi  =  574
   INTEGER(IntKi), PARAMETER      :: TwHt9TPzi  =  575
   INTEGER(IntKi), PARAMETER      :: TwHt1RPxi  =  576
   INTEGER(IntKi), PARAMETER      :: TwHt1RPyi  =  577
   INTEGER(IntKi), PARAMETER      :: TwHt1RPzi  =  578
   INTEGER(IntKi), PARAMETER      :: TwHt2RPxi  =  579
   INTEGER(IntKi), PARAMETER      :: TwHt2RPyi  =  580
   INTEGER(IntKi), PARAMETER      :: TwHt2RPzi  =  581
   INTEGER(IntKi), PARAMETER      :: TwHt3RPxi  =  582
   INTEGER(IntKi), PARAMETER      :: TwHt3RPyi  =  583
   INTEGER(IntKi), PARAMETER      :: TwHt3RPzi  =  584
   INTEGER(IntKi), PARAMETER      :: TwHt4RPxi  =  585
   INTEGER(IntKi), PARAMETER      :: TwHt4RPyi  =  586
   INTEGER(IntKi), PARAMETER      :: TwHt4RPzi  =  587
   INTEGER(IntKi), PARAMETER      :: TwHt5RPxi  =  588
   INTEGER(IntKi), PARAMETER      :: TwHt5RPyi  =  589
   INTEGER(IntKi), PARAMETER      :: TwHt5RPzi  =  590
   INTEGER(IntKi), PARAMETER      :: TwHt6RPxi  =  591
   INTEGER(IntKi), PARAMETER      :: TwHt6RPyi  =  592
   INTEGER(IntKi), PARAMETER      :: TwHt6RPzi  =  593
   INTEGER(IntKi), PARAMETER      :: TwHt7RPxi  =  594
   INTEGER(IntKi), PARAMETER      :: TwHt7RPyi  =  595
   INTEGER(IntKi), PARAMETER      :: TwHt7RPzi  =  596
   INTEGER(IntKi), PARAMETER      :: TwHt8RPxi  =  597
   INTEGER(IntKi), PARAMETER      :: TwHt8RPyi  =  598
   INTEGER(IntKi), PARAMETER      :: TwHt8RPzi  =  599
   INTEGER(IntKi), PARAMETER      :: TwHt9RPxi  =  600
   INTEGER(IntKi), PARAMETER      :: TwHt9RPyi  =  601
   INTEGER(IntKi), PARAMETER      :: TwHt9RPzi  =  602


     ! Platform Motions:

   INTEGER(IntKi), PARAMETER      :: PtfmTDxt   =  603
   INTEGER(IntKi), PARAMETER      :: PtfmTDyt   =  604
   INTEGER(IntKi), PARAMETER      :: PtfmTDzt   =  605
   INTEGER(IntKi), PARAMETER      :: PtfmTDxi   =  606
   INTEGER(IntKi), PARAMETER      :: PtfmTDyi   =  607
   INTEGER(IntKi), PARAMETER      :: PtfmTDzi   =  608
   INTEGER(IntKi), PARAMETER      :: PtfmTVxt   =  609
   INTEGER(IntKi), PARAMETER      :: PtfmTVyt   =  610
   INTEGER(IntKi), PARAMETER      :: PtfmTVzt   =  611
   INTEGER(IntKi), PARAMETER      :: PtfmTVxi   =  612
   INTEGER(IntKi), PARAMETER      :: PtfmTVyi   =  613
   INTEGER(IntKi), PARAMETER      :: PtfmTVzi   =  614
   INTEGER(IntKi), PARAMETER      :: PtfmTAxt   =  615
   INTEGER(IntKi), PARAMETER      :: PtfmTAyt   =  616
   INTEGER(IntKi), PARAMETER      :: PtfmTAzt   =  617
   INTEGER(IntKi), PARAMETER      :: PtfmTAgxt  =  618
   INTEGER(IntKi), PARAMETER      :: PtfmTAgyt  =  619
   INTEGER(IntKi), PARAMETER      :: PtfmTAgzt  =  620
   INTEGER(IntKi), PARAMETER      :: PtfmTAxi   =  621
   INTEGER(IntKi), PARAMETER      :: PtfmTAyi   =  622
   INTEGER(IntKi), PARAMETER      :: PtfmTAzi   =  623
   INTEGER(IntKi), PARAMETER      :: PtfmTAgxi  =  624
   INTEGER(IntKi), PARAMETER      :: PtfmTAgyi  =  625
   INTEGER(IntKi), PARAMETER      :: PtfmTAgzi  =  626
   INTEGER(IntKi), PARAMETER      :: PtfmRDxi   =  627
   INTEGER(IntKi), PARAMETER      :: PtfmRDyi   =  628
   INTEGER(IntKi), PARAMETER      :: PtfmRDzi   =  629
   INTEGER(IntKi), PARAMETER      :: PtfmRVxt   =  630
   INTEGER(IntKi), PARAMETER      :: PtfmRVyt   =  631
   INTEGER(IntKi), PARAMETER      :: PtfmRVzt   =  632
   INTEGER(IntKi), PARAMETER      :: PtfmRVxi   =  633
   INTEGER(IntKi), PARAMETER      :: PtfmRVyi   =  634
   INTEGER(IntKi), PARAMETER      :: PtfmRVzi   =  635
   INTEGER(IntKi), PARAMETER      :: PtfmRAxt   =  636
   INTEGER(IntKi), PARAMETER      :: PtfmRAyt   =  637
   INTEGER(IntKi), PARAMETER      :: PtfmRAzt   =  638
   INTEGER(IntKi), PARAMETER      :: PtfmRAxi   =  639
   INTEGER(IntKi), PARAMETER      :: PtfmRAyi   =  640
   INTEGER(IntKi), PARAMETER      :: PtfmRAzi   =  641


     ! Blade 1 Root Loads:

   INTEGER(IntKi), PARAMETER      :: RootFxc1   =  642
   INTEGER(IntKi), PARAMETER      :: RootFyc1   =  643
   INTEGER(IntKi), PARAMETER      :: RootFzc1   =  644
   INTEGER(IntKi), PARAMETER      :: RootFxb1   =  645
   INTEGER(IntKi), PARAMETER      :: RootFyb1   =  646
   INTEGER(IntKi), PARAMETER      :: RootMxc1   =  647
   INTEGER(IntKi), PARAMETER      :: RootMyc1   =  648
   INTEGER(IntKi), PARAMETER      :: RootMzc1   =  649
   INTEGER(IntKi), PARAMETER      :: RootMxb1   =  650
   INTEGER(IntKi), PARAMETER      :: RootMyb1   =  651


     ! Blade 2 Root Loads:

   INTEGER(IntKi), PARAMETER      :: RootFxc2   =  652
   INTEGER(IntKi), PARAMETER      :: RootFyc2   =  653
   INTEGER(IntKi), PARAMETER      :: RootFzc2   =  654
   INTEGER(IntKi), PARAMETER      :: RootFxb2   =  655
   INTEGER(IntKi), PARAMETER      :: RootFyb2   =  656
   INTEGER(IntKi), PARAMETER      :: RootMxc2   =  657
   INTEGER(IntKi), PARAMETER      :: RootMyc2   =  658
   INTEGER(IntKi), PARAMETER      :: RootMzc2   =  659
   INTEGER(IntKi), PARAMETER      :: RootMxb2   =  660
   INTEGER(IntKi), PARAMETER      :: RootMyb2   =  661


     ! Blade 3 Root Loads:

   INTEGER(IntKi), PARAMETER      :: RootFxc3   =  662
   INTEGER(IntKi), PARAMETER      :: RootFyc3   =  663
   INTEGER(IntKi), PARAMETER      :: RootFzc3   =  664
   INTEGER(IntKi), PARAMETER      :: RootFxb3   =  665
   INTEGER(IntKi), PARAMETER      :: RootFyb3   =  666
   INTEGER(IntKi), PARAMETER      :: RootMxc3   =  667
   INTEGER(IntKi), PARAMETER      :: RootMyc3   =  668
   INTEGER(IntKi), PARAMETER      :: RootMzc3   =  669
   INTEGER(IntKi), PARAMETER      :: RootMxb3   =  670
   INTEGER(IntKi), PARAMETER      :: RootMyb3   =  671


     ! Blade 1 Local Span Loads:

   INTEGER(IntKi), PARAMETER      :: Spn1MLxb1  =  672
   INTEGER(IntKi), PARAMETER      :: Spn1MLyb1  =  673
   INTEGER(IntKi), PARAMETER      :: Spn1MLzb1  =  674
   INTEGER(IntKi), PARAMETER      :: Spn2MLxb1  =  675
   INTEGER(IntKi), PARAMETER      :: Spn2MLyb1  =  676
   INTEGER(IntKi), PARAMETER      :: Spn2MLzb1  =  677
   INTEGER(IntKi), PARAMETER      :: Spn3MLxb1  =  678
   INTEGER(IntKi), PARAMETER      :: Spn3MLyb1  =  679
   INTEGER(IntKi), PARAMETER      :: Spn3MLzb1  =  680
   INTEGER(IntKi), PARAMETER      :: Spn4MLxb1  =  681
   INTEGER(IntKi), PARAMETER      :: Spn4MLyb1  =  682
   INTEGER(IntKi), PARAMETER      :: Spn4MLzb1  =  683
   INTEGER(IntKi), PARAMETER      :: Spn5MLxb1  =  684
   INTEGER(IntKi), PARAMETER      :: Spn5MLyb1  =  685
   INTEGER(IntKi), PARAMETER      :: Spn5MLzb1  =  686
   INTEGER(IntKi), PARAMETER      :: Spn6MLxb1  =  687
   INTEGER(IntKi), PARAMETER      :: Spn6MLyb1  =  688
   INTEGER(IntKi), PARAMETER      :: Spn6MLzb1  =  689
   INTEGER(IntKi), PARAMETER      :: Spn7MLxb1  =  690
   INTEGER(IntKi), PARAMETER      :: Spn7MLyb1  =  691
   INTEGER(IntKi), PARAMETER      :: Spn7MLzb1  =  692
   INTEGER(IntKi), PARAMETER      :: Spn8MLxb1  =  693
   INTEGER(IntKi), PARAMETER      :: Spn8MLyb1  =  694
   INTEGER(IntKi), PARAMETER      :: Spn8MLzb1  =  695
   INTEGER(IntKi), PARAMETER      :: Spn9MLxb1  =  696
   INTEGER(IntKi), PARAMETER      :: Spn9MLyb1  =  697
   INTEGER(IntKi), PARAMETER      :: Spn9MLzb1  =  698
   INTEGER(IntKi), PARAMETER      :: Spn1FLxb1  =  699
   INTEGER(IntKi), PARAMETER      :: Spn1FLyb1  =  700
   INTEGER(IntKi), PARAMETER      :: Spn1FLzb1  =  701
   INTEGER(IntKi), PARAMETER      :: Spn2FLxb1  =  702
   INTEGER(IntKi), PARAMETER      :: Spn2FLyb1  =  703
   INTEGER(IntKi), PARAMETER      :: Spn2FLzb1  =  704
   INTEGER(IntKi), PARAMETER      :: Spn3FLxb1  =  705
   INTEGER(IntKi), PARAMETER      :: Spn3FLyb1  =  706
   INTEGER(IntKi), PARAMETER      :: Spn3FLzb1  =  707
   INTEGER(IntKi), PARAMETER      :: Spn4FLxb1  =  708
   INTEGER(IntKi), PARAMETER      :: Spn4FLyb1  =  709
   INTEGER(IntKi), PARAMETER      :: Spn4FLzb1  =  710
   INTEGER(IntKi), PARAMETER      :: Spn5FLxb1  =  711
   INTEGER(IntKi), PARAMETER      :: Spn5FLyb1  =  712
   INTEGER(IntKi), PARAMETER      :: Spn5FLzb1  =  713
   INTEGER(IntKi), PARAMETER      :: Spn6FLxb1  =  714
   INTEGER(IntKi), PARAMETER      :: Spn6FLyb1  =  715
   INTEGER(IntKi), PARAMETER      :: Spn6FLzb1  =  716
   INTEGER(IntKi), PARAMETER      :: Spn7FLxb1  =  717
   INTEGER(IntKi), PARAMETER      :: Spn7FLyb1  =  718
   INTEGER(IntKi), PARAMETER      :: Spn7FLzb1  =  719
   INTEGER(IntKi), PARAMETER      :: Spn8FLxb1  =  720
   INTEGER(IntKi), PARAMETER      :: Spn8FLyb1  =  721
   INTEGER(IntKi), PARAMETER      :: Spn8FLzb1  =  722
   INTEGER(IntKi), PARAMETER      :: Spn9FLxb1  =  723
   INTEGER(IntKi), PARAMETER      :: Spn9FLyb1  =  724
   INTEGER(IntKi), PARAMETER      :: Spn9FLzb1  =  725


     ! Blade 2 Local Span Loads:

   INTEGER(IntKi), PARAMETER      :: Spn1MLxb2  =  726
   INTEGER(IntKi), PARAMETER      :: Spn1MLyb2  =  727
   INTEGER(IntKi), PARAMETER      :: Spn1MLzb2  =  728
   INTEGER(IntKi), PARAMETER      :: Spn2MLxb2  =  729
   INTEGER(IntKi), PARAMETER      :: Spn2MLyb2  =  730
   INTEGER(IntKi), PARAMETER      :: Spn2MLzb2  =  731
   INTEGER(IntKi), PARAMETER      :: Spn3MLxb2  =  732
   INTEGER(IntKi), PARAMETER      :: Spn3MLyb2  =  733
   INTEGER(IntKi), PARAMETER      :: Spn3MLzb2  =  734
   INTEGER(IntKi), PARAMETER      :: Spn4MLxb2  =  735
   INTEGER(IntKi), PARAMETER      :: Spn4MLyb2  =  736
   INTEGER(IntKi), PARAMETER      :: Spn4MLzb2  =  737
   INTEGER(IntKi), PARAMETER      :: Spn5MLxb2  =  738
   INTEGER(IntKi), PARAMETER      :: Spn5MLyb2  =  739
   INTEGER(IntKi), PARAMETER      :: Spn5MLzb2  =  740
   INTEGER(IntKi), PARAMETER      :: Spn6MLxb2  =  741
   INTEGER(IntKi), PARAMETER      :: Spn6MLyb2  =  742
   INTEGER(IntKi), PARAMETER      :: Spn6MLzb2  =  743
   INTEGER(IntKi), PARAMETER      :: Spn7MLxb2  =  744
   INTEGER(IntKi), PARAMETER      :: Spn7MLyb2  =  745
   INTEGER(IntKi), PARAMETER      :: Spn7MLzb2  =  746
   INTEGER(IntKi), PARAMETER      :: Spn8MLxb2  =  747
   INTEGER(IntKi), PARAMETER      :: Spn8MLyb2  =  748
   INTEGER(IntKi), PARAMETER      :: Spn8MLzb2  =  749
   INTEGER(IntKi), PARAMETER      :: Spn9MLxb2  =  750
   INTEGER(IntKi), PARAMETER      :: Spn9MLyb2  =  751
   INTEGER(IntKi), PARAMETER      :: Spn9MLzb2  =  752
   INTEGER(IntKi), PARAMETER      :: Spn1FLxb2  =  753
   INTEGER(IntKi), PARAMETER      :: Spn1FLyb2  =  754
   INTEGER(IntKi), PARAMETER      :: Spn1FLzb2  =  755
   INTEGER(IntKi), PARAMETER      :: Spn2FLxb2  =  756
   INTEGER(IntKi), PARAMETER      :: Spn2FLyb2  =  757
   INTEGER(IntKi), PARAMETER      :: Spn2FLzb2  =  758
   INTEGER(IntKi), PARAMETER      :: Spn3FLxb2  =  759
   INTEGER(IntKi), PARAMETER      :: Spn3FLyb2  =  760
   INTEGER(IntKi), PARAMETER      :: Spn3FLzb2  =  761
   INTEGER(IntKi), PARAMETER      :: Spn4FLxb2  =  762
   INTEGER(IntKi), PARAMETER      :: Spn4FLyb2  =  763
   INTEGER(IntKi), PARAMETER      :: Spn4FLzb2  =  764
   INTEGER(IntKi), PARAMETER      :: Spn5FLxb2  =  765
   INTEGER(IntKi), PARAMETER      :: Spn5FLyb2  =  766
   INTEGER(IntKi), PARAMETER      :: Spn5FLzb2  =  767
   INTEGER(IntKi), PARAMETER      :: Spn6FLxb2  =  768
   INTEGER(IntKi), PARAMETER      :: Spn6FLyb2  =  769
   INTEGER(IntKi), PARAMETER      :: Spn6FLzb2  =  770
   INTEGER(IntKi), PARAMETER      :: Spn7FLxb2  =  771
   INTEGER(IntKi), PARAMETER      :: Spn7FLyb2  =  772
   INTEGER(IntKi), PARAMETER      :: Spn7FLzb2  =  773
   INTEGER(IntKi), PARAMETER      :: Spn8FLxb2  =  774
   INTEGER(IntKi), PARAMETER      :: Spn8FLyb2  =  775
   INTEGER(IntKi), PARAMETER      :: Spn8FLzb2  =  776
   INTEGER(IntKi), PARAMETER      :: Spn9FLxb2  =  777
   INTEGER(IntKi), PARAMETER      :: Spn9FLyb2  =  778
   INTEGER(IntKi), PARAMETER      :: Spn9FLzb2  =  779


     ! Blade 3 Local Span Loads:

   INTEGER(IntKi), PARAMETER      :: Spn1MLxb3  =  780
   INTEGER(IntKi), PARAMETER      :: Spn1MLyb3  =  781
   INTEGER(IntKi), PARAMETER      :: Spn1MLzb3  =  782
   INTEGER(IntKi), PARAMETER      :: Spn2MLxb3  =  783
   INTEGER(IntKi), PARAMETER      :: Spn2MLyb3  =  784
   INTEGER(IntKi), PARAMETER      :: Spn2MLzb3  =  785
   INTEGER(IntKi), PARAMETER      :: Spn3MLxb3  =  786
   INTEGER(IntKi), PARAMETER      :: Spn3MLyb3  =  787
   INTEGER(IntKi), PARAMETER      :: Spn3MLzb3  =  788
   INTEGER(IntKi), PARAMETER      :: Spn4MLxb3  =  789
   INTEGER(IntKi), PARAMETER      :: Spn4MLyb3  =  790
   INTEGER(IntKi), PARAMETER      :: Spn4MLzb3  =  791
   INTEGER(IntKi), PARAMETER      :: Spn5MLxb3  =  792
   INTEGER(IntKi), PARAMETER      :: Spn5MLyb3  =  793
   INTEGER(IntKi), PARAMETER      :: Spn5MLzb3  =  794
   INTEGER(IntKi), PARAMETER      :: Spn6MLxb3  =  795
   INTEGER(IntKi), PARAMETER      :: Spn6MLyb3  =  796
   INTEGER(IntKi), PARAMETER      :: Spn6MLzb3  =  797
   INTEGER(IntKi), PARAMETER      :: Spn7MLxb3  =  798
   INTEGER(IntKi), PARAMETER      :: Spn7MLyb3  =  799
   INTEGER(IntKi), PARAMETER      :: Spn7MLzb3  =  800
   INTEGER(IntKi), PARAMETER      :: Spn8MLxb3  =  801
   INTEGER(IntKi), PARAMETER      :: Spn8MLyb3  =  802
   INTEGER(IntKi), PARAMETER      :: Spn8MLzb3  =  803
   INTEGER(IntKi), PARAMETER      :: Spn9MLxb3  =  804
   INTEGER(IntKi), PARAMETER      :: Spn9MLyb3  =  805
   INTEGER(IntKi), PARAMETER      :: Spn9MLzb3  =  806
   INTEGER(IntKi), PARAMETER      :: Spn1FLxb3  =  807
   INTEGER(IntKi), PARAMETER      :: Spn1FLyb3  =  808
   INTEGER(IntKi), PARAMETER      :: Spn1FLzb3  =  809
   INTEGER(IntKi), PARAMETER      :: Spn2FLxb3  =  810
   INTEGER(IntKi), PARAMETER      :: Spn2FLyb3  =  811
   INTEGER(IntKi), PARAMETER      :: Spn2FLzb3  =  812
   INTEGER(IntKi), PARAMETER      :: Spn3FLxb3  =  813
   INTEGER(IntKi), PARAMETER      :: Spn3FLyb3  =  814
   INTEGER(IntKi), PARAMETER      :: Spn3FLzb3  =  815
   INTEGER(IntKi), PARAMETER      :: Spn4FLxb3  =  816
   INTEGER(IntKi), PARAMETER      :: Spn4FLyb3  =  817
   INTEGER(IntKi), PARAMETER      :: Spn4FLzb3  =  818
   INTEGER(IntKi), PARAMETER      :: Spn5FLxb3  =  819
   INTEGER(IntKi), PARAMETER      :: Spn5FLyb3  =  820
   INTEGER(IntKi), PARAMETER      :: Spn5FLzb3  =  821
   INTEGER(IntKi), PARAMETER      :: Spn6FLxb3  =  822
   INTEGER(IntKi), PARAMETER      :: Spn6FLyb3  =  823
   INTEGER(IntKi), PARAMETER      :: Spn6FLzb3  =  824
   INTEGER(IntKi), PARAMETER      :: Spn7FLxb3  =  825
   INTEGER(IntKi), PARAMETER      :: Spn7FLyb3  =  826
   INTEGER(IntKi), PARAMETER      :: Spn7FLzb3  =  827
   INTEGER(IntKi), PARAMETER      :: Spn8FLxb3  =  828
   INTEGER(IntKi), PARAMETER      :: Spn8FLyb3  =  829
   INTEGER(IntKi), PARAMETER      :: Spn8FLzb3  =  830
   INTEGER(IntKi), PARAMETER      :: Spn9FLxb3  =  831
   INTEGER(IntKi), PARAMETER      :: Spn9FLyb3  =  832
   INTEGER(IntKi), PARAMETER      :: Spn9FLzb3  =  833


     ! Hub and Rotor Loads:

   INTEGER(IntKi), PARAMETER      :: LSShftFxa  =  834
   INTEGER(IntKi), PARAMETER      :: LSShftFya  =  835
   INTEGER(IntKi), PARAMETER      :: LSShftFza  =  836
   INTEGER(IntKi), PARAMETER      :: LSShftFys  =  837
   INTEGER(IntKi), PARAMETER      :: LSShftFzs  =  838
   INTEGER(IntKi), PARAMETER      :: LSShftMxa  =  839
   INTEGER(IntKi), PARAMETER      :: LSSTipMya  =  840
   INTEGER(IntKi), PARAMETER      :: LSSTipMza  =  841
   INTEGER(IntKi), PARAMETER      :: LSSTipMys  =  842
   INTEGER(IntKi), PARAMETER      :: LSSTipMzs  =  843
   INTEGER(IntKi), PARAMETER      :: RotPwr     =  844


     ! Shaft Strain Gage Loads:

   INTEGER(IntKi), PARAMETER      :: LSSGagMya  =  845
   INTEGER(IntKi), PARAMETER      :: LSSGagMza  =  846
   INTEGER(IntKi), PARAMETER      :: LSSGagMys  =  847
   INTEGER(IntKi), PARAMETER      :: LSSGagMzs  =  848


     ! High-Speed Shaft Loads:

   INTEGER(IntKi), PARAMETER      :: HSShftTq   =  849
   INTEGER(IntKi), PARAMETER      :: HSSBrTq    =  850
   INTEGER(IntKi), PARAMETER      :: HSShftPwr  =  851


     ! Rotor-Furl Bearing Loads:

   INTEGER(IntKi), PARAMETER      :: RFrlBrM    =  852


     ! Tail-Furl Bearing Loads:

   INTEGER(IntKi), PARAMETER      :: TFrlBrM    =  853


     ! Tower-Top / Yaw Bearing Loads:

   INTEGER(IntKi), PARAMETER      :: YawBrFxn   =  854
   INTEGER(IntKi), PARAMETER      :: YawBrFyn   =  855
   INTEGER(IntKi), PARAMETER      :: YawBrFzn   =  856
   INTEGER(IntKi), PARAMETER      :: YawBrFxp   =  857
   INTEGER(IntKi), PARAMETER      :: YawBrFyp   =  858
   INTEGER(IntKi), PARAMETER      :: YawBrMxn   =  859
   INTEGER(IntKi), PARAMETER      :: YawBrMyn   =  860
   INTEGER(IntKi), PARAMETER      :: YawBrMzn   =  861
   INTEGER(IntKi), PARAMETER      :: YawBrMxp   =  862
   INTEGER(IntKi), PARAMETER      :: YawBrMyp   =  863


     ! Yaw Friction:

   INTEGER(IntKi), PARAMETER      :: YawFriMom  =  864
   INTEGER(IntKi), PARAMETER      :: YawFriMfp  =  865
   INTEGER(IntKi), PARAMETER      :: YawFriMz   =  866
   INTEGER(IntKi), PARAMETER      :: OmegaYF    =  867
   INTEGER(IntKi), PARAMETER      :: dOmegaYF   =  868


     ! Tower Base Loads:

   INTEGER(IntKi), PARAMETER      :: TwrBsFxt   =  869
   INTEGER(IntKi), PARAMETER      :: TwrBsFyt   =  870
   INTEGER(IntKi), PARAMETER      :: TwrBsFzt   =  871
   INTEGER(IntKi), PARAMETER      :: TwrBsMxt   =  872
   INTEGER(IntKi), PARAMETER      :: TwrBsMyt   =  873
   INTEGER(IntKi), PARAMETER      :: TwrBsMzt   =  874


     ! Local Tower Loads:

   INTEGER(IntKi), PARAMETER      :: TwHt1MLxt  =  875
   INTEGER(IntKi), PARAMETER      :: TwHt1MLyt  =  876
   INTEGER(IntKi), PARAMETER      :: TwHt1MLzt  =  877
   INTEGER(IntKi), PARAMETER      :: TwHt2MLxt  =  878
   INTEGER(IntKi), PARAMETER      :: TwHt2MLyt  =  879
   INTEGER(IntKi), PARAMETER      :: TwHt2MLzt  =  880
   INTEGER(IntKi), PARAMETER      :: TwHt3MLxt  =  881
   INTEGER(IntKi), PARAMETER      :: TwHt3MLyt  =  882
   INTEGER(IntKi), PARAMETER      :: TwHt3MLzt  =  883
   INTEGER(IntKi), PARAMETER      :: TwHt4MLxt  =  884
   INTEGER(IntKi), PARAMETER      :: TwHt4MLyt  =  885
   INTEGER(IntKi), PARAMETER      :: TwHt4MLzt  =  886
   INTEGER(IntKi), PARAMETER      :: TwHt5MLxt  =  887
   INTEGER(IntKi), PARAMETER      :: TwHt5MLyt  =  888
   INTEGER(IntKi), PARAMETER      :: TwHt5MLzt  =  889
   INTEGER(IntKi), PARAMETER      :: TwHt6MLxt  =  890
   INTEGER(IntKi), PARAMETER      :: TwHt6MLyt  =  891
   INTEGER(IntKi), PARAMETER      :: TwHt6MLzt  =  892
   INTEGER(IntKi), PARAMETER      :: TwHt7MLxt  =  893
   INTEGER(IntKi), PARAMETER      :: TwHt7MLyt  =  894
   INTEGER(IntKi), PARAMETER      :: TwHt7MLzt  =  895
   INTEGER(IntKi), PARAMETER      :: TwHt8MLxt  =  896
   INTEGER(IntKi), PARAMETER      :: TwHt8MLyt  =  897
   INTEGER(IntKi), PARAMETER      :: TwHt8MLzt  =  898
   INTEGER(IntKi), PARAMETER      :: TwHt9MLxt  =  899
   INTEGER(IntKi), PARAMETER      :: TwHt9MLyt  =  900
   INTEGER(IntKi), PARAMETER      :: TwHt9MLzt  =  901
   INTEGER(IntKi), PARAMETER      :: TwHt1FLxt  =  902
   INTEGER(IntKi), PARAMETER      :: TwHt1FLyt  =  903
   INTEGER(IntKi), PARAMETER      :: TwHt1FLzt  =  904
   INTEGER(IntKi), PARAMETER      :: TwHt2FLxt  =  905
   INTEGER(IntKi), PARAMETER      :: TwHt2FLyt  =  906
   INTEGER(IntKi), PARAMETER      :: TwHt2FLzt  =  907
   INTEGER(IntKi), PARAMETER      :: TwHt3FLxt  =  908
   INTEGER(IntKi), PARAMETER      :: TwHt3FLyt  =  909
   INTEGER(IntKi), PARAMETER      :: TwHt3FLzt  =  910
   INTEGER(IntKi), PARAMETER      :: TwHt4FLxt  =  911
   INTEGER(IntKi), PARAMETER      :: TwHt4FLyt  =  912
   INTEGER(IntKi), PARAMETER      :: TwHt4FLzt  =  913
   INTEGER(IntKi), PARAMETER      :: TwHt5FLxt  =  914
   INTEGER(IntKi), PARAMETER      :: TwHt5FLyt  =  915
   INTEGER(IntKi), PARAMETER      :: TwHt5FLzt  =  916
   INTEGER(IntKi), PARAMETER      :: TwHt6FLxt  =  917
   INTEGER(IntKi), PARAMETER      :: TwHt6FLyt  =  918
   INTEGER(IntKi), PARAMETER      :: TwHt6FLzt  =  919
   INTEGER(IntKi), PARAMETER      :: TwHt7FLxt  =  920
   INTEGER(IntKi), PARAMETER      :: TwHt7FLyt  =  921
   INTEGER(IntKi), PARAMETER      :: TwHt7FLzt  =  922
   INTEGER(IntKi), PARAMETER      :: TwHt8FLxt  =  923
   INTEGER(IntKi), PARAMETER      :: TwHt8FLyt  =  924
   INTEGER(IntKi), PARAMETER      :: TwHt8FLzt  =  925
   INTEGER(IntKi), PARAMETER      :: TwHt9FLxt  =  926
   INTEGER(IntKi), PARAMETER      :: TwHt9FLyt  =  927
   INTEGER(IntKi), PARAMETER      :: TwHt9FLzt  =  928


     ! Internal Degrees of Freedom:

   INTEGER(IntKi), PARAMETER      :: Q_B1E1     =  929
   INTEGER(IntKi), PARAMETER      :: Q_B2E1     =  930
   INTEGER(IntKi), PARAMETER      :: Q_B3E1     =  931
   INTEGER(IntKi), PARAMETER      :: Q_B1F1     =  932
   INTEGER(IntKi), PARAMETER      :: Q_B2F1     =  933
   INTEGER(IntKi), PARAMETER      :: Q_B3F1     =  934
   INTEGER(IntKi), PARAMETER      :: Q_B1F2     =  935
   INTEGER(IntKi), PARAMETER      :: Q_B2F2     =  936
   INTEGER(IntKi), PARAMETER      :: Q_B3F2     =  937
   INTEGER(IntKi), PARAMETER      :: Q_Teet     =  938
   INTEGER(IntKi), PARAMETER      :: Q_DrTr     =  939
   INTEGER(IntKi), PARAMETER      :: Q_GeAz     =  940
   INTEGER(IntKi), PARAMETER      :: Q_RFrl     =  941
   INTEGER(IntKi), PARAMETER      :: Q_TFrl     =  942
   INTEGER(IntKi), PARAMETER      :: Q_Yaw      =  943
   INTEGER(IntKi), PARAMETER      :: Q_TFA1     =  944
   INTEGER(IntKi), PARAMETER      :: Q_TSS1     =  945
   INTEGER(IntKi), PARAMETER      :: Q_TFA2     =  946
   INTEGER(IntKi), PARAMETER      :: Q_TSS2     =  947
   INTEGER(IntKi), PARAMETER      :: Q_Sg       =  948
   INTEGER(IntKi), PARAMETER      :: Q_Sw       =  949
   INTEGER(IntKi), PARAMETER      :: Q_Hv       =  950
   INTEGER(IntKi), PARAMETER      :: Q_R        =  951
   INTEGER(IntKi), PARAMETER      :: Q_P        =  952
   INTEGER(IntKi), PARAMETER      :: Q_Y        =  953
   INTEGER(IntKi), PARAMETER      :: QD_B1E1    =  954
   INTEGER(IntKi), PARAMETER      :: QD_B2E1    =  955
   INTEGER(IntKi), PARAMETER      :: QD_B3E1    =  956
   INTEGER(IntKi), PARAMETER      :: QD_B1F1    =  957
   INTEGER(IntKi), PARAMETER      :: QD_B2F1    =  958
   INTEGER(IntKi), PARAMETER      :: QD_B3F1    =  959
   INTEGER(IntKi), PARAMETER      :: QD_B1F2    =  960
   INTEGER(IntKi), PARAMETER      :: QD_B2F2    =  961
   INTEGER(IntKi), PARAMETER      :: QD_B3F2    =  962
   INTEGER(IntKi), PARAMETER      :: QD_Teet    =  963
   INTEGER(IntKi), PARAMETER      :: QD_DrTr    =  964
   INTEGER(IntKi), PARAMETER      :: QD_GeAz    =  965
   INTEGER(IntKi), PARAMETER      :: QD_RFrl    =  966
   INTEGER(IntKi), PARAMETER      :: QD_TFrl    =  967
   INTEGER(IntKi), PARAMETER      :: QD_Yaw     =  968
   INTEGER(IntKi), PARAMETER      :: QD_TFA1    =  969
   INTEGER(IntKi), PARAMETER      :: QD_TSS1    =  970
   INTEGER(IntKi), PARAMETER      :: QD_TFA2    =  971
   INTEGER(IntKi), PARAMETER      :: QD_TSS2    =  972
   INTEGER(IntKi), PARAMETER      :: QD_Sg      =  973
   INTEGER(IntKi), PARAMETER      :: QD_Sw      =  974
   INTEGER(IntKi), PARAMETER      :: QD_Hv      =  975
   INTEGER(IntKi), PARAMETER      :: QD_R       =  976
   INTEGER(IntKi), PARAMETER      :: QD_P       =  977
   INTEGER(IntKi), PARAMETER      :: QD_Y       =  978
   INTEGER(IntKi), PARAMETER      :: QD2_B1E1   =  979
   INTEGER(IntKi), PARAMETER      :: QD2_B2E1   =  980
   INTEGER(IntKi), PARAMETER      :: QD2_B3E1   =  981
   INTEGER(IntKi), PARAMETER      :: QD2_B1F1   =  982
   INTEGER(IntKi), PARAMETER      :: QD2_B2F1   =  983
   INTEGER(IntKi), PARAMETER      :: QD2_B3F1   =  984
   INTEGER(IntKi), PARAMETER      :: QD2_B1F2   =  985
   INTEGER(IntKi), PARAMETER      :: QD2_B2F2   =  986
   INTEGER(IntKi), PARAMETER      :: QD2_B3F2   =  987
   INTEGER(IntKi), PARAMETER      :: QD2_Teet   =  988
   INTEGER(IntKi), PARAMETER      :: QD2_DrTr   =  989
   INTEGER(IntKi), PARAMETER      :: QD2_GeAz   =  990
   INTEGER(IntKi), PARAMETER      :: QD2_RFrl   =  991
   INTEGER(IntKi), PARAMETER      :: QD2_TFrl   =  992
   INTEGER(IntKi), PARAMETER      :: QD2_Yaw    =  993
   INTEGER(IntKi), PARAMETER      :: QD2_TFA1   =  994
   INTEGER(IntKi), PARAMETER      :: QD2_TSS1   =  995
   INTEGER(IntKi), PARAMETER      :: QD2_TFA2   =  996
   INTEGER(IntKi), PARAMETER      :: QD2_TSS2   =  997
   INTEGER(IntKi), PARAMETER      :: QD2_Sg     =  998
   INTEGER(IntKi), PARAMETER      :: QD2_Sw     =  999
   INTEGER(IntKi), PARAMETER      :: QD2_Hv     = 1000
   INTEGER(IntKi), PARAMETER      :: QD2_R      = 1001
   INTEGER(IntKi), PARAMETER      :: QD2_P      = 1002
   INTEGER(IntKi), PARAMETER      :: QD2_Y      = 1003

     ! Rotor-convention counterparts of the shaft-axis channels. These report the
     ! quantity as the rotor experiences it, so a mirrored rotor turning its design
     ! direction still reads positive. Identical to the shaft-axis slots when RotDir=+1.
   INTEGER(IntKi), PARAMETER      :: AzimuthRC  = 1004
   INTEGER(IntKi), PARAMETER      :: RotSpeedRC = 1005
   INTEGER(IntKi), PARAMETER      :: RotAccelRC = 1006
   INTEGER(IntKi), PARAMETER      :: RotTorqRC  = 1007


     ! The maximum number of output channels which can be output by the code.
   INTEGER(IntKi), PARAMETER      :: MaxOutPts  = 1007
...
INTEGER,  PARAMETER          :: BldPRate(3) = (/BldPRate1,BldPRate2,BldPRate3/)
INTEGER,  PARAMETER          :: BldPAcc(3)  = (/BldPAcc1, BldPAcc2, BldPAcc3/)
...
!   INTEGER(IntKi)               :: NumOuts                                  ! Number of output channel names read from the file
   ...
   CALL AllocAry( InputFileData%PBrIner, MaxBl, 'PBrIner input array', ErrStat2, ErrMsg2 )
      CALL SetErrStat( ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName )
      IF ( ErrStat >= AbortErrLev ) THEN
         CALL Cleanup()
         RETURN
   ...
   CALL AllocAry( InputFileData%BlPIner, MaxBl, 'BlPIner input array', ErrStat2, ErrMsg2 )
      CALL SetErrStat( ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName )
      IF ( ErrStat >= AbortErrLev ) THEN
         CALL Cleanup()
         RETURN
   ...
   CALL ReadAryLines( UnIn, InputFile, InputFileData%TipMass, MaxBl, "TipMass", "Tip-brake masses (kg)", ErrStat2, ErrMsg2, UnEc)
      ...
      ! PBrIner - Pitch bearing inertia about the pitch axis (kg m^2):
   CALL ReadAryLines( UnIn, InputFile, InputFileData%PBrIner, MaxBl, "PBrIner", "Pitch bearing inertia about the pitch axis (kg m^2)", ErrStat2, ErrMsg2, UnEc)
      CALL SetErrStat( ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName )
      IF ( ErrStat >= AbortErrLev ) THEN
         CALL Cleanup()
         RETURN
      ...
      ! BlPIner - Blade inertia about the pitch axis (kg m^2):
   CALL ReadAryLines( UnIn, InputFile, InputFileData%BlPIner, MaxBl, "BlPIner", "Blade inertia about the pitch axis (kg m^2)", ErrStat2, ErrMsg2, UnEc)
      CALL SetErrStat( ErrStat2, ErrMsg2, ErrStat, ErrMsg, RoutineName )
      IF ( ErrStat >= AbortErrLev ) THEN
         CALL Cleanup()
         RETURN
...
!..................................................................................................................................
   ...
   DO K=1,InputFileData%NumBl
      IF ( InputFileData%PBrIner(K) < 0.0_ReKi) call SetErrStat(ErrID_Fatal,'PBrIner('//TRIM( Num2LStr( K ) )//') must not be negative.',ErrStat,ErrMsg,RoutineName)
   ENDDO ! K

   DO K=1,InputFileData%NumBl
      IF ( InputFileData%BlPIner(K) < 0.0_ReKi) call SetErrStat(ErrID_Fatal,'BlPIner('//TRIM( Num2LStr( K ) )//') must not be negative.',ErrStat,ErrMsg,RoutineName)
   ENDDO ! K
