   SUBROUTINE ElementMatrixDynGL(Nuu0,Nuuu,Nrr0,Nrrr,Next,Nvvv,Naaa,Stif0,m00,mEta0,rho0,ngp,node_elem,dof_node,elk,elf,elm,elg)
...
!       WRITE(*,*) "Jacobian = ", Jacobian
   ...
   END SUBROUTINE ElementMatrixDynGL
