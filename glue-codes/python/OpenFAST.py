...
# ## Serial
# input_file_name = "/Users/rmudafor/Development/weis/reg_tests/r-test/glue-codes/openfast/AOC_YFix_WSt/AOC_YFix_WSt.fst"
...
if rank == 0:
    ...
    openfastlib = openfast_library.FastLibAPI(library_path, create_string_buffer(input_file_name.encode('utf-8')))
    openfastlib.fast_run()
elif rank == 1:
