...
! =========  MD_Data  =======
  TYPE, PUBLIC :: MD_Data
    ...
    TYPE(MD_InputType) , DIMENSION(1:2)  :: u      !< System inputs [-]
    REAL(DbKi) , DIMENSION(1:2)  :: utimes      !< Current time [s]
...
DO i1 = LBOUND(MiscData%FWrap_2_MD,1), UBOUND(MiscData%FWrap_2_MD,1)
  CALL NWTC_Library_Destroymeshmaptype( MiscData%FWrap_2_MD(i1), ErrStat, ErrMsg )
ENDDO
...
DO i1 = LBOUND(MiscData%MD_2_FWrap,1), UBOUND(MiscData%MD_2_FWrap,1)
  CALL NWTC_Library_Destroymeshmaptype( MiscData%MD_2_FWrap(i1), ErrStat, ErrMsg )
ENDDO
   ...
   ErrMsg  = ""
    ...
    DO i1 = LBOUND(SrcMD_DataData%u,1), UBOUND(SrcMD_DataData%u,1)
      CALL MD_CopyInput( SrcMD_DataData%u(i1), DstMD_DataData%u(i1), CtrlCode, ErrStat2, ErrMsg2 )
         ...
         IF (ErrStat>=AbortErrLev) RETURN
    ENDDO
    DstMD_DataData%utimes = SrcMD_DataData%utimes
...
! 
  ErrStat = ErrID_None
  ErrMsg  = ""
  CALL MD_DestroyContState( MD_DataData%x, ErrStat, ErrMsg )
  CALL MD_DestroyDiscState( MD_DataData%xd, ErrStat, ErrMsg )
  CALL MD_DestroyConstrState( MD_DataData%z, ErrStat, ErrMsg )
  CALL MD_DestroyOtherState( MD_DataData%OtherSt, ErrStat, ErrMsg )
...
ENDIF
  ...
  CALL Farm_Destroymd_data( All_FastFarm_DataData%MD, ErrStat, ErrMsg )
