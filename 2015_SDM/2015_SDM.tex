...
\begin{enumerate}
    \item Key points that define the geometry of the beam; these key points are interpolated by cubic splines
...
\end{center}
\end{table} 
The displacements are plotted in Figure~\ref{CX100Disp_New} and are overall in good agreement. {\color {red} One reason to explain the discrepancies between BeamDyn results and experimental data is that the coupling effects between the degrees of freedom was difficult to measure in the experiments. The results obtained by NLBeam, a nonlinear beam solver developed by Los Alamos National Laboratory, also can be found in Figure~\ref{CX100Disp_New}.}
\begin{figure}
\centering
...
\subsection{Analysis of NREL 5MW Blade}
...
\begin{figure}
    \centering
    \begin{tabular}{c}
    \subfloat[Time history of applied force]{\label{E4Force:Force}\includegraphics[width=5.0 in]{\directory  E4Force.eps}} \\
\subfloat[PSD of applied force]{\label{E4Force:PSD}\includegraphics[width=5.0in]{\directory  E4ForcePSD.eps}} \\
\end{tabular}
...
\begin{figure}
    \centering
    \begin{tabular}{c}
    \subfloat[Time history of edge displacement]{\label{E4Displacement:Disp}\includegraphics[width=5.0 in]{\directory  E4Disp.eps}} \\
\subfloat[PSD of edge displacement]{\label{E4Displacement:PSD}\includegraphics[width=5.0in]{\directory  E4DispPSD.eps}} \\
\end{tabular}
