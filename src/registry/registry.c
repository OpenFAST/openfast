...
main( int argc, char *argv[], char *env[] )
{
  ...
  fprintf(stderr,"Revision $Rev: 433 $\n") ;
  fprintf(stderr,"Date $LastChangedDate: 2013-07-31 00:15:06 -0600 (Wed, 31 Jul 2013) $ \n" ) ;
  fprintf(stderr,"URL  $URL: https://windsvn.nrel.gov/FAST/branches/CSC/FAST/Registry/Source/registry.c $\n" ) ;
  fprintf(stderr,"-----------------------------------\n") ;
