 ...
 * @property  FX                       external applied force in X [N]
 * @property  FY                       external applied force in Y [N]
 * @property  FZ                       external applied force in Z [N]
 * @property  sum_FX;                  sum force in X [N[
 * @property  sum_FY;                  sum force in Y [N[
 * @property  sum_FZ;                  sum force in Z [N[
 */
struct 
Node 
{
