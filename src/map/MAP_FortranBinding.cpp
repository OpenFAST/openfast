...
//   
// FX, FY, FZ
// PLOT_FLAG, X_POS, Y_POS, Z_POS, X_FORCE, Y_FORCE, Z_FORCE, LINE_TENSION, 
// OMIT_CONTACT, LAY_LENGTH
void 
...
//  const unsigned int MAX_CHARACTERS = 255; // size of MAP_OutputHeader and MAP_OutputUnits char array
  ...
  for (int i=0 ; i< output->writeOutput_Len ; i++ ) o->MAPCALL_GetWriteOutput( output->writeOutput, output->writeOutput_Len) ;
}
