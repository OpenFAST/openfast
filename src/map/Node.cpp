...
/** 
 * Return the global force in the X direction [N]
 *
...
/** 
 * Return the global force in the Y direction [N]
 *
...
/** 
 * Return the global force in the Z direction [N]
 * 
 ...
 * @return  double    the value of the VarType. Units can be [m], [N], [kg], or [m^3].
 */
double Node::
 ...
 * @see     Node::AddToSumFX()
 * @return  double  the node sum forces in X [N]
 */
double Node::
GetSumFX( ) const 
{ 
 ...
 * @see     Node::AddToSumFY()
 * @return  double  the node sum forces in Y [N]
 */
double Node::
GetSumFY( ) const 
{
 ...
 * @see     Node::AddToSumFZ()
 * @return  double  the node sum forces in Z [N]
 */
double Node::
GetSumFZ( ) const 
{
